---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: הוועדה החשובה ביותר שנוסדה כדי להשיג את משימת הפיקוח היא ועדת החשבונות הציבוריים (PAC), שהוקמה לראשונה בפרלמנט הבריטי ב-1861. מאמר זה חוקר את פעילות הוועדה לחשבונאות בפרלמנט הישראלי במהלך שלוש קדנציות של הכנסת מנקודת מבט של פיקוח של 'משטרה-סיירת'. הממצאים מלמדים כי ה-PAC הישראלי, על אף שהוא בעל סמכויות מיוחדות שאין לוועדות אחרות של הכנסת, פועל תחת לחץ כבד הנובע ממכשולים מבניים, פרוצדורליים, אישיים, משפטיים ופיננסיים.",
