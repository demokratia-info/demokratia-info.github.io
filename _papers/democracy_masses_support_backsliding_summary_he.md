---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מחקר זה בוחן את היסודות של תמיכה ציבורית בנסיגה דמוקרטית, תוך שהוא משרטט חמישה הסברים תיאורטיים: מנהיגות פרסונליסטית, קיטוב רגשי, פופוליזם, עיקרון והסתבכות עם מערכת המשפט. אנו בודקים את כוח ההסבר של חשבונות אלה בהקשר הישראלי, תוך מינוף נתוני סקרי פאנל שנאספו לפני ואחרי שהממשלה הכריזה על תוכניתה לצמצם את בתי המשפט. התוצאות מצביעות על כך שהתמיכה בתוכנית מוסברת בצורה הטובה ביותר על ידי שני כוחות: התקשרות מוקדמת למנהיג העומד בראש המאמץ הנסגר ואיבה כלפי מתנגדים פרטיזנים.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: מחקר על התנאים שבהם אזרחים רגילים מוכנים לתמוך בפגיעה בכללי הדמוקרטיה."
      ]
    },
    {
