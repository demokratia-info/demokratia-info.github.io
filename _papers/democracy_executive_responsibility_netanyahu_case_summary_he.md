---
{
  ...
  "image": {
    "src": "assets/article-images/real_photo_235_court_democracy_executive_responsibility_netanyahu_case_summary_he.jpg",
    "version": "2026-07-05-real-photo-handoff",
    "altHe": "תצלום על אחריות ציבורית, רשות מבצעת ושלטון החוק",
    "fitness": "high",
    "license": "Public domain",
    "creator": "Boryak",
    "provider": "Wikimedia Commons",
    "sourcePage": "https://commons.wikimedia.org/wiki/File:Israel_mexico_navy_ceremony.jpg",
    "originalUrl": "https://upload.wikimedia.org/wikipedia/commons/c/c3/Israel_mexico_navy_ceremony.jpg",
    "fileTitle": "Israel mexico navy ceremony.jpg",
    "sourceDimensions": "900x675",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "בנימין נתניהו היה ראש הממשלה המכהן הראשון בישראל שהיה בו זמנית נאשם פלילי שהואשם בשוחד, מרמה והפרת אמונים. למרות שנתניהו לא הצליח להרכיב ממשלה לאחר הבחירות במרץ 2021 (כנסת 24), התקדים המסוכן הזה של השילוב של ראש ממשלה שהוא בו זמנית נאשם בפלילים מחייב דיון מקיף ביחס בין אחריות ציבורית לאחריות משפטית, כושר ושיקול דעת, לבין אתיקה ומשפט. לאחר מכן, הוא בוחן את החוקים ואת הדוקטרינות השיפוטיות בישראל ביחס למקרים שבהם איש ציבור מבצע מעשה הנחשב ל\"לא נעשה\". לאחר מכן הוא מתאר כיצד חוקות של מדינות אחרות מטפלות במקרים כאלה, וסוקר את תפקיד הפיקוח הפרלמנטרי בנסיבות כאלה.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        ...
        "הוא מסייע לנסח שאלות ציבוריות מעשיות על היחס בין אחריות ציבורית לאחריות משפטית, על כשירות ושיקול דעת, על אתיקה ומשפט ועל תפקידו של פיקוח פרלמנטרי בנסיבות כאלה."
      ]
    },
    {
