---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אנו חוקרים את הגורמים שתרמו לתהליך זה. לשם כך, אנו משתמשים בניתוח היסטוריית אירועים המבוסס על ציר זמן של פעולותיהם של חברי הממשלה ה-37. מהניתוח עולה כי ארבעת התמריצים שהתיישרו לפני הבחירות לכנסת ה-25 והקמת ממשלת ימין קיצוני האיצו את החזרה לאחור של הדמוקרטיה הישראלית.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: הבליץ החוקתי מוצג כמהלך שבו תמריצים פוליטיים, פופוליזם וחקיקה מהירה מחלישים בלמים דמוקרטיים בזמן קצר."
      ]
    },
    {
