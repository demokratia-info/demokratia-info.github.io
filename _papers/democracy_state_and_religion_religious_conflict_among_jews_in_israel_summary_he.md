---
{
  ...
  "titleHe": "מדינה ודת: סכסוך דתי בקרב יהודים בישראל",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_state_and_religion_religious_conflict_among_jews_in_israel_summary_he.jpg",
    "version": "2026-05-23-extra-100-economics-refill",
    "altHe": "תמונה עריכתית: מדינה ודת: סכסוך דתי בקרב יהודים בישראל",
    "fitness": "standard"
  },
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: כתבה בכתב העת מדינה ודת: סכסוך דתי בין יהודים בישראל קבל גישה אפרים תבורי אפרים תבורי מרצה לסוציולוגיה אוניברסיטת בר אילן, רמת גן, ישראל חפש יצירות אחרות של מחבר זה ב: Oxford Academic Google Scholar Journal of Church and State, גיליון 23, גיליון 2, אביב 1981–2825, עמודים 2825, https://doi.org/10.1093/jcs/23.2.275 פורסם: 01 במרץ 1981. State and Religion: Religious Conflict among Jews in Israel.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק ביחסי דת, מדינה ודמוקרטיה, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Journal of Church and State בשנת 1981. הזווית הדמוקרטית היא שהסדרים מוסדיים אינם רק רקע טכני, אלא תנאי לאמון, לשוויון בפני הכללים וליכולת להגביל כוח ציבורי."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "מדינה ודת: סכסוך דתי בקרב יהודים בישראל",
