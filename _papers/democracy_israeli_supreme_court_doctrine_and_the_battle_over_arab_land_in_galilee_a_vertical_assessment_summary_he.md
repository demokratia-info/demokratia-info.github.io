---
{
  ...
  "titleHe": "בית המשפט העליון והקרקע הערבית בגליל",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_israeli_supreme_court_doctrine_and_the_battle_over_arab_land_in_galilee_a_vertical_assessment_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר באמצע שנות ה-50, הפך הגליל המרכזי הערבי ברובו המכריע למוקד האזורי הראשון של תביעת קרקעות ישראלית בהקשר של מאמצי המדינה לייהד את האזור. מאמר זה בוחן את הדוקטרינות השיפוטיות הקשורות לקרקע שאומץ על ידי בית המשפט העליון הישראלי עד תחילת שנות ה-60, שהקלו על מאמץ זה. בעוד עבודה אקדמית קודמת על התפתחותן של דוקטרינות אלו מתארת ​​תהליך \"אופקי\" המתקדם מתקדים של SC אחד לאחר, מאמר זה נוקט בגישה \"אנכית\" המתמקדת בתפקיד של טיעון מתדיין ופסיקות בבתי משפט נמוכים יותר.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בבתי המשפט, חוקתיות ושלטון החוק, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Journal of Palestine Studies בשנת 2011. הזווית הדמוקרטית היא שהסדרים מוסדיים אינם רק רקע טכני, אלא תנאי לאמון, לשוויון בפני הכללים וליכולת להגביל כוח ציבורי."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "בית המשפט העליון והקרקע הערבית בגליל",
