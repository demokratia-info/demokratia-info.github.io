---
{
  ...
  "subtitleHe": "לימור יהודה מציעה בסיס תיאורטי למשפט של שלום: לא רק זכויות יחידים, אלא יחסים של שוויון ואי-שליטה בין קבוצות לאומיות.",
  ...
  "image": {
    "src": "assets/article-images/real_photo_116_court_democracy_collective_equality_law_of_peace_summary_he.jpg",
    "version": "2026-07-05-real-photo-handoff",
    "altHe": "תצלום על שוויון קולקטיבי, קבוצות לאומיות והסדר חוקתי של שלום",
    "fitness": "high",
    "license": "CC BY-SA 4.0",
    "creator": "יעקב",
    "provider": "Wikimedia Commons",
    "sourcePage": "https://commons.wikimedia.org/wiki/File:ElitzurandLawyer0884.JPG",
    "originalUrl": "https://upload.wikimedia.org/wikipedia/commons/7/73/ElitzurandLawyer0884.JPG",
    "fileTitle": "ElitzurandLawyer0884.JPG",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "קיימים מתחים משמעותיים בין האסטרטגיות החוקתיות המרכזיות ליצירת שלום עכשווית ב\"מקומות מפולגים עמוקים\" לבין חוק זכויות האדם (HRL). המתחים הללו ממוסגרים בדרך כלל כדילמה של שלום מול צדק. בתגובה, מאמר זה מציע את המושג שוויון קולקטיבי כבסיס תיאורטי חדש לחוק השלום.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לא. הוא מציע אמת מידה נורמטיבית לבחינת הסדרים שונים: האם הם יוצרים יחסים של שוויון ואי-שליטה בין קבוצות."
      ]
    },
    {
