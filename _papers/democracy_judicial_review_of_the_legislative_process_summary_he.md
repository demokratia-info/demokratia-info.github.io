---
{
  ...
  "image": {
    "src": "html_qa/democracy_judicial_review_of_the_legislative_process_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה מנסה לספק הצדקה לביקורת שיפוטית על הליך החקיקה ומציע שבית המשפט יעודד הליך חקיקתי הוגן. המאמר מסתיים בהצעה שהמאפיינים העיקריים של ביקורת שיפוטית: חוקתיות, מידתיות ואיפוק צריכים להכתיב את היחסים בין בית המשפט העליון לפרלמנט בכל היבטי הביקורת השיפוטית.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בבתי המשפט, חוקתיות ושלטון החוק, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Israel Law Review בשנת 2006.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית."
      ]
    },
    {
