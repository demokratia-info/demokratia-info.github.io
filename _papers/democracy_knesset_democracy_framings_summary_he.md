---
{
  ...
  "subtitleHe": "",
  "descriptionHe": "איך תפיסות שונות של דמוקרטיה בכנסת משפיעות על מאבקי זכויות ומוסדות. החשיבות הציבורית של המאמר היא בכך שהוא עוזר לזהות כיצד נסיגה דמוקרטית מתפתחת לא רק בצעד דרמטי אחד, אלא גם דרך רצף החלטות, שפה פוליטית ותמריצים מוסדיים שמחלישים בלמים, נורמות ואמון ציבורי.",
  ...
  "oneLinerHtml": "יואב ארד ומייקל פרידמן מראים שחברי הכנסת ה-24 דיברו על דמוקרטיה בשפות שונות מאוד. המאמר מדגיש שהמשבר הישראלי אינו רק ויכוח על מוסד אחד, אלא עימות בין תפיסה רובנית של שלטון הרוב לבין תפיסה ליברלית שמדגישה זכויות, מוסדות והגבלות על כוח.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המחקר בוחן כיצד חברי הכנסת ה-24 של ישראל תופסים ומגדירים את הדמוקרטיה, וכיצד זהותם הפוליטית-אידיאולוגית משפיעה על הבנות אלו. באמצעות ניתוח איכותני של הצהרות פומביות ופוסטים ברשתות החברתיות של 72 חברי כנסת, המחקר חושף מתאם חזק בין הזהות האידיאולוגית-פוליטית של חברי הכנסת לבין מסגור הדמוקרטיה שלהם. הוא מדגיש את המתח בין הזהות היהודית והדמוקרטית של ישראל ומצביע על כך שהנוף הפוליטי מאתגר יותר ויותר את החזון של מייסדי ישראל למדינה דמוקרטית.",
        "איך תפיסות שונות של דמוקרטיה בכנסת משפיעות על מאבקי זכויות ומוסדות."
      ]
    },
    {
