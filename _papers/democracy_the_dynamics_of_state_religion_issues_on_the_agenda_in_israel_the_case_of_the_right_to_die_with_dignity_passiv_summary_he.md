---
{
  ...
  "titleHe": "סוגיות דת ומדינה בישראל והזכות למות בכבוד",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_the_dynamics_of_state_religion_issues_on_the_agenda_in_israel_the_case_of_the_right_to_die_with_dignity_passiv_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: האיום המתמשך על קיומה של מדינת ישראל בא לידי ביטוי באג'נדה נוקשה, הגורמת לתחרות קשה ביותר על תשומת הלב. למרות זאת, שאלת היחס בין מדינה לדת מצליחה להיות מוצבת גבוה על סדר היום. בהתמקדות בתיאור המקרה של המתת חסד במהלך הכנסת ה-14 בראשות בנימין נתניהו והכנסת ה-15 בראשות אהוד ברק, מאמר זה מציע הסבר שישים להקשר החברתי-פוליטי של ישראל לגבי מיקום נושאים הנוגעים למדינה ודת על סדר היום של קובעי המדיניות.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק ביחסי דת, מדינה ודמוקרטיה, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Israel Affairs בשנת 2011. הזווית הדמוקרטית היא שהסדרים מוסדיים אינם רק רקע טכני, אלא תנאי לאמון, לשוויון בפני הכללים וליכולת להגביל כוח ציבורי."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "סוגיות דת ומדינה בישראל והזכות למות בכבוד",
