---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאגר חושף את מה שעשוי להיות מוגדר כפסיקה חוקתית פוחתת. לעומת זאת, בעשור האחרון נמנע בית המשפט כמעט לחלוטין מלבחון תיקים על הצדקה או לכתוב חוות דעת מנומקות, לאמץ גישות אד-הוק לפתרון בעיות או לנקוט בגישות ליישוב סכסוכים המניעות את הצדדים למצוא פשרה, מבלי להגדיר את המסגרת המשפטית שאמורה להנחות את המחלוקות."
      ]
    },
    {
