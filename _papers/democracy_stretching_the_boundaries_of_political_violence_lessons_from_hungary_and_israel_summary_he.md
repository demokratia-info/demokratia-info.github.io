---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: בהתבסס על מקרי המקרה של הונגריה וישראל, מאמר זה מציע להרחיב את המונח \"אלימות פוליטית\" כך שיכלול את התופעה של שימוש בשפה חריפה ואחריה אמצעי ענישה, שאינם בהכרח פיזיים. היא שואפת לצבור כוח נוסף, להפחיד יריבים ולצמצם את היכולות הציבוריות והפוליטיות של כוחות חברתיים ופוליטיים בעלי אידיאולוגיה שונה. המאמר מגיע למסקנה שאלימות פוליטית היא כיום בעיקר מילולית בישראל, אך בהונגריה יש לה גם מימד מעשי של פגיעה ביריבים הפוליטיים של הממשלה.",
