---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה טוען שהמשבר הזה היה תוצאה של הסטתו של ראש הממשלה בנימין נתניהו מהניאו-ליברליזם לעבר אג'נדה פופוליסטית \"אנטי-מערכתית\". התוצאה הסופית הייתה שנים של מבוי סתום פוליטי.",
