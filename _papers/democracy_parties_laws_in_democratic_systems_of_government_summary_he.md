---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "הניתוח מבוסס על בחינה של חוקי המפלגה באוסטריה, פינלנד, גרמניה, ישראל, פולין, ספרד וונצואלה. לאורך הניתוח, המחקר עוסק בשאלה עקרונית: האם בית מחוקקים המורכב מנציגי מפלגות פוליטיות צריך להתחייב לחוקק חוקים המסדירים את פעילותן של מפלגות פוליטיות במערכת פרלמנטרית דמוקרטית? מוצע כי תשובה חלקית לשאלה זו מצויה בעובדה שלמעט פינלנד וישראל, פוליטיקה דמוקרטית שבחרו לחוקק חוקי מפלגה חוו בעבר קריסה של המערכות הדמוקרטיות שלהן."
      ]
    },
    {
