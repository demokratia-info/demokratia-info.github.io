---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "יש לחץ גובר על הרשויות המקומיות לארגן את עצמן מחדש כדי לעמוד בציפיות הנוכחיות מהציבור. ממשל רב-שכבתי התגלה כשיטה אחת לארגון מחדש כזה. באמצעות תוצאות סקר שנערך בקרב 1733 תושבי רשויות מקומיות בישראל, המאמר בוחן את ההשפעות של שלוש רפורמות שלטון רב-שכבתי ספציפיות – מיזוג, פירוק וקיבוץ של רשויות שלטון מקומיות – על הערכות התושבים לגבי שלטון מקומי ודמוקרטיה."
      ]
    },
    {
