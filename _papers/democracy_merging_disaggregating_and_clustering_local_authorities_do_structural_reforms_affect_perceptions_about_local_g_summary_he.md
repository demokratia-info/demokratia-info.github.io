---
{
  ...
  "titleHe": "רפורמות ברשויות מקומיות ותפיסות של ממשל ודמוקרטיה",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_merging_disaggregating_and_clustering_local_authorities_do_structural_reforms_affect_perceptions_about_local_g_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק במוסדות ציבוריים, ממשל ואמון אזרחי, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Territory, Politics, Governance בשנת 2023. הזווית הדמוקרטית היא שהסדרים מוסדיים אינם רק רקע טכני, אלא תנאי לאמון, לשוויון בפני הכללים וליכולת להגביל כוח ציבורי.",
  ...
  "layout": "paper",
  "title": "רפורמות ברשויות מקומיות ותפיסות של ממשל ודמוקרטיה",
