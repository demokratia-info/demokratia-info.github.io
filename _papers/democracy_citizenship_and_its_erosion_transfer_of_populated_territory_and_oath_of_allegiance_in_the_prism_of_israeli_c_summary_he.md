---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה דן בשני נושאים של יחסי רוב-מיעוט בחברות מפולגות עמוקות. הראשון הוא הלגיטימציה של העברת מיעוט מולדת (או חלק ממנו) יחד עם השטח שבו הוא שוכן למדינה קרובה שכנה בניגוד לרצון המיעוט או רוב חבריה. המוקד העיקרי של מאמר זה הוא בחינת אמצעי ההגנה של המשפט החוקתי הישראלי שעשויים למנוע את יישום היוזמות הללו, שלדעתי מסוכנות מאוד.",
