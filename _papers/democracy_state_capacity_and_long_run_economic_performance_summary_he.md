---
{
  ...
  "image": {
    "src": "html_qa/democracy_state_capacity_and_long_run_economic_performance_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק במוסדות ציבוריים, ממשל ואמון אזרחי, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת The Economic Journal בשנת 2016. הזווית הדמוקרטית היא שהסדרים מוסדיים אינם רק רקע טכני, אלא תנאי לאמון, לשוויון בפני הכללים וליכולת להגביל כוח ציבורי.",
