---
{
  ...
  "oneLinerHtml": "המאמר בוחן את מחאה, קיטוב והגבולות של פעולה פוליטית דמוקרטית ומראה מדוע הדיון קשור לחוקתיות, בתי משפט, שלטון החוק, ביקורת שיפוטית והגבלת כוח ציבורי. הקריאה בו חשובה משום שהיא מחברת בין מקור אקדמי לבין השאלה כיצד דמוקרטיה מגבילה כוח, מגינה על זכויות ושומרת על כללי משחק הוגנים.",
  "sections": [
    {
      "headingHe": "מה המאמר בוחן?",
      "paragraphsHtml": [
        "המאמר בוחן את מחאה, קיטוב והגבולות של פעולה פוליטית דמוקרטית, וממקם את הסוגיה בתוך הדיון הרחב על חוקתיות, בתי משפט, שלטון החוק, ביקורת שיפוטית והגבלת כוח ציבורי.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: המחקר הנוכחי בוחן את ההצטלבות בין גיל ומגדר במחאות פוליטיות. ביצענו ניתוח נושאי איכותני תוך השוואה וניגוד בין קטגוריות בתוך ובין ראיונות, תוך התחשבות בפרספקטיבה המגדרית. תוצאות: המחקר מדגיש דפוסים של שיטות מחאה מגדריות אך גם בגיל מבוגר יותר.",
