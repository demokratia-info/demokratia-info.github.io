---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תוך שימוש בישראל כמקרה בוחן, אנו בוחנים מערכת יחסים זו באמצעות גישה דו-שלבית של שיטות מעורבות: קבוצות מיקוד עם בכירים לשעבר ולאחר מכן ראיונות עם מנהלים בדרג בינוני שיישמו בהצלחה יוזמות חדשניות. אנו מוצאים שפופוליזם עכשווי מתבטא בצורה שונה על פני רמות היררכיות - פקידים בכירים חווים התערבות ישירה באמצעות ריכוזיות, דה-לגיטימציה של מומחיות ופוליטיזציה; בעוד שמנהלים בדרג הביניים נתקלים באילוצים תפעוליים תחת לחצים פופוליסטיים עקיפים. הממצאים שלנו תורמים בכך שהם חושפים הן את ההשפעה הדיפרנציאלית של פופוליזם על חסמי חדשנות ברמות הבירוקרטיות והן בזיהוי עבודה ספציפית סביב אסטרטגיות המאפשרות לחדשנות לשגשג למרות אילוצים אלה, אם כי עם עלויות עסקה נסתרות.",
