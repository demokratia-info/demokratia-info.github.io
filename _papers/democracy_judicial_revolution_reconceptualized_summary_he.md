---
{
  ...
  "subtitleHe": "",
  "descriptionHe": "איך קריאה מחדש של מהפכת שנות התשעים משנה את ההבנה של המשבר החוקתי הנוכחי. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד כללים משפטיים, ביקורת שיפוטית ועיצוב מוסדי משפיעים בפועל על היכולת להגביל כוח שלטוני, לשמור על אחריות ציבורית ולהבטיח שכללי המשחק הדמוקרטיים לא יישחקו בהדרגה.",
  ...
  "oneLinerHtml": "אודי זומר, רייצ'ל קולסון ונתניאל שמידט טוענים שרפורמת 2023 אינה מובנת היטב אם מציגים אותה רק כתיקון טכני למהפכת השפיטה של שנות התשעים. המאמר מראה שהשאלה המרכזית היא מאבק עמוק יותר על זהותה הדמוקרטית והליברלית של ישראל ועל מעמדם של בתי המשפט כמנגנון של איזונים ובלמים.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אנו דוחים תיאור זה וטוענים כי המפתח להבנת ההתפתחויות הללו טמון במתח המתמשך בין המרכיבים היהודיים והדמוקרטיים של זהותה של ישראל, קונפליקט שניכר כבר בהכרזת העצמאות. במקום זאת, אנו מתווכחים ומדגים באופן אמפירי כיצד השינויים של שנות ה-90 היו פחות על שאפתנות שיפוטית ויותר על התגובה המקומית לשינוי עולמי שהופעל על ידי סוף המלחמה הקרה. בהסתמך על ראיות אמפיריות נרחבות, לרבות דיונים בוועדות חקיקה, נאומים פוליטיים ודפוסי אשרור של אמנות בינלאומיות על ידי הכנסת, אנו מוכיחים שהשינוי הזה לא היה תוצר של תחבולות שיפוטיות אלא שיקוף של הדינמיקה ההיסטורית והעולמית של העידן.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: איך קריאה מחדש של מהפכת שנות התשעים משנה את ההבנה של המשבר החוקתי הנוכחי."
      ]
    },
    {
