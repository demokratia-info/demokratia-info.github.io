---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר דוחה תיאור זה וטוען כי המפתח להבנת ההתפתחויות הללו טמון במתח המתמשך בין המרכיבים היהודיים והדמוקרטיים של זהותה של ישראל, קונפליקט שניכר כבר בהכרזת העצמאות. במקום זאת, המאמר טוען ומדגים באופן אמפירי כיצד השינויים של שנות ה-90 היו פחות על שאפתנות שיפוטית ויותר על התגובה המקומית לשינוי עולמי שהופעל על ידי סוף המלחמה הקרה. בהסתמך על ראיות אמפיריות נרחבות, לרבות דיונים בוועדות חקיקה, נאומים פוליטיים ודפוסי אשרור של אמנות בינלאומיות על ידי הכנסת, המחקר מראה שהשינוי הזה לא היה תוצר של תחבולות שיפוטיות אלא שיקוף של הדינמיקה ההיסטורית והעולמית של העידן.",
        "איך קריאה מחדש של מהפכת שנות התשעים משנה את ההבנה של המשבר החוקתי הנוכחי."
      ]
    },
    {
