---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: חוקרי הפוליטיקה הישראלית העריכו יתר על המידה את תפקידם של הגנרלים הצבאיים הישראלים בעיצוב מדיניות הביטחון של ישראל ובתהליך השלום עם הרשות הפלסטינית. מאמר זה טוען כי לא רק לכנסת יש את המילה האחרונה באשרור כל הסכם שלום עם הרשות אלא לכנסת הפכה למכשול לשלום. מבנה השיטה הדמוקרטית הישראלית, כלומר שיטת הייצוג היחסי (PR), הגביר את כוחן של מפלגות קטנות מעבר לגודלן היחסי, בעוד שהפריימריז במפלגה העניקו אוטונומיה למועמדי המפלגה מהנהגת המפלגה שלהם.",
