---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: בישראל, המצב מורכב עוד יותר בשל העובדה שישראל מגדירה את עצמה כמדינה יהודית. מוקפת בכוחות עוינים, על ישראל לנסות לא רק לשמור על שלום וביטחון אלא להציע זכויות דמוקרטיות לאזרחיה היהודים, המוסלמים והנוצרים. רעיונותיו של ג'ון דיואי על דמוקרטיה וחינוך משמשים כמסגרת לניתוח.",
