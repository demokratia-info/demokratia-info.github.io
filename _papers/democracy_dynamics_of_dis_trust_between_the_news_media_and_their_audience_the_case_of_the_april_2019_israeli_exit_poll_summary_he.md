---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר בוחן את הדינמיקה של (חוסר) אמון בקרב מומחים, עיתונאים וקהלים באמצעות מקרה בוחן של סקר יציאה לא מדויק ששודר בערוץ טלוויזיה ישראלי מוביל. הוא משלב נתונים אמפיריים מהבחירות בישראל באפריל 2019 עם ראייה רעיונית של סקרי יציאה כמקורות מידע וטקסים לאומיים כדי להתמודד עם השיח הציבורי על הסקרים והחשדות הבסיסיים שלו. באמצעות ניתוח אינדוקטיבי-איכותי, זיהינו שלושה סוגים של נרטיבים ציבוריים, שכל אחד מהם מטיל את האשמה בתחזית השגויה של סקר היציאה על סוג אחר של שחקנים."
      ]
    },
    {
