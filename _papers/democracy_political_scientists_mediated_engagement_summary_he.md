---
{
  ...
  "oneLinerHtml": "שורה תחתונה: המאמר מראה שבזמן נסיגה דמוקרטית, מדעני מדינה אינם רק פרשנים מן הצד. הם מתלבטים האם וכיצד להשתמש במומחיותם בתקשורת כדי להסביר לציבור מהי דמוקרטיה, בלי לאבד אמינות מקצועית ובלי להצטמצם לתפקיד מפלגתי.",
  "sections": [
    {
