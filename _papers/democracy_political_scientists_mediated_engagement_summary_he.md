---
{
  ...
  "oneLinerHtml": "המאמר מראה שבזמן נסיגה דמוקרטית, מדעני מדינה אינם רק פרשנים מן הצד. הם מתלבטים האם וכיצד להשתמש במומחיותם בתקשורת כדי להסביר לציבור מהי דמוקרטיה, בלי לאבד אמינות מקצועית ובלי להצטמצם לתפקיד מפלגתי. החשיבות הציבורית של המאמר היא בכך שהוא עוזר לזהות כיצד נסיגה דמוקרטית מתפתחת לא רק בצעד דרמטי אחד, אלא גם דרך רצף החלטות, שפה פוליטית ותמריצים מוסדיים שמחלישים בלמים, נורמות ואמון ציבורי.",
  "sections": [
    {
