---
{
  ...
  "descriptionHe": "מיכל נויבאואר-שני ואלי פרידמן בוחנים כיצד מדעני מדינה ישראלים תופסים את תפקידם הציבורי והתקשורתי בזמן נסיגה דמוקרטית.",
  "summaryHe": "המאמר מראה שמדעני מדינה בזמן משבר דמוקרטי נעים בין חובה מקצועית ואזרחית, מומחיות ציבורית, חשש מפוליטיזציה ותיווך תקשורתי.",
  ...
  "image": {
    "src": "assets/article-images/real_photo_568_protest_democracy_political_scientists_mediated_engagement_summary_he.jpg",
    "version": "2026-07-05-real-photo-handoff",
    "altHe": "תצלום על אנשי אקדמיה, תקשורת וחברה אזרחית בזמן נסיגה דמוקרטית",
    "fitness": "high",
    "license": "CC BY-SA 3.0",
    "creator": "בר",
    "provider": "Wikimedia Commons",
    "sourcePage": "https://commons.wikimedia.org/wiki/File:Demonstrators_wear_Rolex.jpg",
    "originalUrl": "https://upload.wikimedia.org/wikipedia/commons/b/b5/Demonstrators_wear_Rolex.jpg",
    "fileTitle": "Demonstrators wear Rolex.jpg",
  ...
  "oneLinerHtml": "המאמר מנתח ראיונות עם מדעני מדינה ישראלים ומראה כיצד הרפורמה המשפטית של 2023 חידדה את הדילמה בין הסברת דמוקרטיה לציבור לבין חשש מזיהוי פוליטי.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר נשען על ראיונות חצי-מובנים עם מדעני מדינה ישראלים, כדי להבין מדוע הם נכנסים לזירה הציבורית, איזה תפקיד הם מייחסים לעצמם, מהי דרך המעורבות המועדפת עליהם, וכיצד הם תופסים את התקשורת ואת הסיכונים המקצועיים הכרוכים בה.",
        "המחקר מזהה כמה תפקידי מעורבות אפשריים: צופה, שחקן מפלגתי, שחקן מפלגתי הנשען על מומחיות, ומתווך. ניתוח הראיונות העלה שלושה צירים מרכזיים: מטרות המעורבות הציבורית, מאפייני המעורבות התקשורתית, והשפעת תקופה חריפה של נסיגה דמוקרטית על ההחלטה לצאת אל הציבור.",
        "הממצאים מראים הסכמה רחבה בין המרואיינים שמעורבות ציבורית היא חובה בסיסית ולא רשמית, אך אין הסכמה על מקורה: חלק רואים בה חלק מהמקצוע, אחרים רואים בה אחריות אזרחית, ומיעוט חושש שהיא תצבע את האקדמיה כפוליטית. הרפורמה המשפטית של 2023, שנועדה להחליש באופן משמעותי את מערכת המשפט ואת מערך האיזונים והבלמים, הפכה את הדילמה הזאת לחריפה במיוחד."
      ]
    },
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        ...
        "המאמר אינו מציג את כל החוקרים כפעילים פוליטיים. הוא מציג אותם כאנשי מקצוע שנדרשים להחליט עד כמה האחריות הציבורית שלהם יוצאת אל מעבר לכיתה ולכתב העת.",
