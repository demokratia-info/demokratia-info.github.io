---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המחקר מנצל הבדלים בשיעורי התמותה באירופה כדי להעריך את השפעת המוסדות על הביצועים הכלכליים. תוך ניצול ההבדלים בשיעורי התמותה באירופה כמכשיר למוסדות קיימים, המחקר מעריך השפעות גדולות של מוסדות על ההכנסה לנפש. ברגע שהשפעת המוסדות נשלטת, למדינות באפריקה או לאלו הקרובות יותר לקו המשווה אין הכנסה נמוכה יותר."
      ]
    },
    {
