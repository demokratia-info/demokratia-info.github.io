---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אנו מנצלים הבדלים בשיעורי התמותה באירופה כדי להעריך את השפעת המוסדות על הביצועים הכלכליים. תוך ניצול ההבדלים בשיעורי התמותה באירופה כמכשיר למוסדות קיימים, אנו מעריכים השפעות גדולות של מוסדות על ההכנסה לנפש. ברגע שהשפעת המוסדות נשלטת, למדינות באפריקה או לאלו הקרובות יותר לקו המשווה אין הכנסה נמוכה יותר.",
