---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: יש להעריך כל שינוי בסמכות השיפוטית ובעצמאותו על-פי המדד של ליבת המינימום הדמוקרטית, ובהתייחס להשפעתו המעשית המצטברת על מערכת של בלמים ואיזונים מוסדיים. אנו טוענים כי השינויים האחרונים בישראל עלולים כבר לאיים על המחאות המוסדיות הללו, ויש להם פוטנציאל לגרום לנזק רב יותר בעתיד, אם יינתן השפעה רחבה ואם ישולבו עם שינויים נוספים בכוחו ובעצמאותו של בית המשפט העליון. על בסיס זה, אנו מציעים, יש לראות בשינויים הרלוונטיים כ\"פוגעניים\" או \"פרוטו-פוגעניים\" באופיים.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: מתי שינוי בבית המשפט פוגע בליבה הדמוקרטית של זכויות ואיזונים."
      ]
    },
    {
