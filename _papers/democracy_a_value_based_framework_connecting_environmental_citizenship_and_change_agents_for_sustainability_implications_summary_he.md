---
{
  ...
  "titleHe": "אזרחות סביבתית וחינוך לסוכני שינוי",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_a_value_based_framework_connecting_environmental_citizenship_and_change_agents_for_sustainability_implications_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: סוכנות אזרחית מוכרת כמניע/זרז מרכזי לשינוי חברתי לעבר קיימות. מודלים אחרונים של חינוך לאזרחות סביבתית (EEC) דוגלים בגישה טרנספורמטיבית לטיפול בחוסר קיימות סביבתי (טיפול בסיבות מבניות הבסיסיות) ובזיהוי של התפתחות סוכני שינוי, הן כאמצעי לשינוי חברתי עמוק לקראת קיימות והן כתוצאה של EEC. לאור מיעוט המחקרים הבודקים את התכונות הפסיכולוגיות של סוכני שינוי קיימות, עבודה זו נועדה להעמיק את ההבנה התיאורטית של המניעים המניעים אנשים לפעול כסוכני שינוי ואת סוג והיקף השינוי שהם שואפים לחולל, במטרה לפתח אזרחים סביבתיים מוכשרים.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בלאומיות, אזרחות ושוויון דמוקרטי, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Sustainability בשנת 2021.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "אזרחות סביבתית וחינוך לסוכני שינוי",
