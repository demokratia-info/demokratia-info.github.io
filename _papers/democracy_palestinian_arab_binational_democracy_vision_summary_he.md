---
{
  ...
  "oneLinerHtml": "חזון דמוקרטיה דו־לאומית מציב את שאלת השוויון הפלסטיני־ערבי בישראל במרכז הדיון החוקתי והסמלי.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        ...
        "במקום להסתפק בתיאור כללי של חזון דו־לאומי, המאמר ממקד את הדיון בהדיון החוקתי והסמלי על זהות המדינה ואזרחות המיעוט הפלסטיני־ערבי. לכן הוא מתאים לקריאה דמוקרטית שמחפשת את הקשר בין מדיניות יומיומית לבין שוויון אזרחי."
      ]
    },
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "הדגש המרכזי הוא שהמוקד הוא עצם הצגת חזון חלופי לסדר המדינתי והאזרחי בישראל. זהו ממצא חשוב משום שהוא מראה כיצד חוויה מוסדית או חברתית מסוימת יכולה לשנות אמון, השתתפות או תחושת שייכות.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "הקשר לשוויון אזרחי נמצא בהתביעה להכרה בזהות לאומית ובשותפות אזרחית. המאמר מזכיר ששוויון אינו רק איסור אפליה, אלא גם שאלה של נגישות, קול, ייצוג והגנה מפני הדרה.",
