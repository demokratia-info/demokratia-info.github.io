---
{
  ...
  "subtitleHe": "",
  "descriptionHe": "תמצית בעברית של מחקר על חוויות סגל פלסטיני במוסדות אקדמיים בישראל לאחר מתקפת חמאס ב-7 באוקטובר 2023 ובמהלך המלחמה בעזה, ועל מנגנוני פיקוח, נאמנות והשתקה במרחב האקדמי.",
  "summaryHe": "המאמר בוחן את חוויותיהם של חברי סגל פלסטינים במוסדות אקדמיים בישראל בתקופת מלחמה. מתוך ראיונות עם 27 חברי סגל הוא מתאר כיצד מנגנוני פיקוח גלויים וסמויים מגדירים אילו דברים ניתנים לאמירה, אילו זהויות נחשבות חשודות, וכיצד דרישות נאמנות ושתיקה פועלות לצד מרחבים של התנגדות.",
  ...
  "oneLinerHtml": "המאמר מנתח כיצד מלחמה מעצימה <strong>פיקוח, השתקה ודרישות נאמנות</strong> כלפי סגל פלסטיני באקדמיה הישראלית.",
  "sections": [
    {
    ...
    {
      "headingHe": "מהן דרישות נאמנות לפי התקציר?",
      "paragraphsHtml": [
