---
{
  ...
  "oneLinerHtml": "המאמר בוחן את סוגיית שפה ואזרחות בישראל דרך עדשה של זכויות, שוויון ומיעוטים.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: על ידי שימוש במונח \"אזרחות חלולה\" (CitationJamal, 2007), אנו מדגימים כי בישראל קיימות רמות וסוגים שונים של אזרחות. באופן ספציפי, אנו מראים כי עבור ערבים בישראל חלול מרמז על זכויות מוגבלות לכניסה והשתתפות בהשכלה גבוהה.",
