---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר בוחן את התיקון מזוויות שונות. שני הסעיפים הבאים מעריכים את הסיכונים הרבים שיוצר התיקון, כגון סוגי ההחלטות שניתן לקבל ללא עמידה בסטנדרט של סבירות, וצמצום כוחו של היועץ המשפטי לממשלה כ\"שומר סף\" משפטי. ניתוח רב-גוני זה מוביל למסקנה שביטול תקן הסבירות מערער מאפיינים בסיסיים של הדמוקרטיה ומפר את האמנה החברתית בין האזרחים לממשלה.",
        "ביטול עילת הסבירות מחליש את חובת הממשלה לפעול בהגינות, פוגע בשומרי הסף ומסכן מינויים, זכויות ושלטון חוק."
      ]
    },
    {
