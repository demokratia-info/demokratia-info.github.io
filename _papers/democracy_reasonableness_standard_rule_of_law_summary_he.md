---
{
  ...
  "summaryHe": "ביטול עילת הסבירות מחליש את חובת הממשלה לפעול בהגינות, פוגע בשומרי הסף ומסכן מינויים, זכויות ושלטון חוק. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד כללים משפטיים, ביקורת שיפוטית ועיצוב מוסדי משפיעים בפועל על היכולת להגביל כוח שלטוני, לשמור על אחריות ציבורית ולהבטיח שכללי המשחק הדמוקרטיים לא יישחקו בהדרגה.",
  ...
  "oneLinerHtml": "שורה תחתונה: מרדכי קרמניצר מסביר שביטול עילת הסבירות משחרר את הממשלה והשרים מאחד המנגנונים המרכזיים שמחייבים אותם לפעול לטובת הציבור. במערכת ישראלית שאין בה חוקה מלאה ומשוריינת, בית שני או פדרליזם, ביטול כזה מחליש את שומרי הסף ומרחיב את יכולת הרוב הקואליציוני לקבל החלטות שרירותיות. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד כללים משפטיים, ביקורת שיפוטית ועיצוב מוסדי משפיעים בפועל על היכולת להגביל כוח שלטוני, לשמור על אחריות ציבורית ולהבטיח שכללי המשחק הדמוקרטיים לא יישחקו בהדרגה.",
  "sections": [
    {
