---
{
  ...
  "oneLinerHtml": "מרדכי קרמניצר מסביר שביטול עילת הסבירות משחרר את הממשלה והשרים מאחד המנגנונים המרכזיים שמחייבים אותם לפעול לטובת הציבור. במערכת ישראלית שאין בה חוקה מלאה ומשוריינת, בית שני או פדרליזם, ביטול כזה מחליש את שומרי הסף ומרחיב את יכולת הרוב הקואליציוני לקבל החלטות שרירותיות.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה בוחן את התיקון מזוויות שונות. שני הסעיפים הבאים מעריכים את הסיכונים הרבים שיוצר התיקון, כגון סוגי ההחלטות שניתן לקבל ללא עמידה בסטנדרט של סבירות, וצמצום כוחו של היועץ המשפטי לממשלה כ\"שומר סף\" משפטי. ניתוח רב-גוני זה מוביל למסקנה שביטול תקן הסבירות מערער מאפיינים בסיסיים של הדמוקרטיה ומפר את האמנה החברתית בין האזרחים לממשלה.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: ביטול עילת הסבירות מחליש את חובת הממשלה לפעול בהגינות, פוגע בשומרי הסף ומסכן מינויים, זכויות ושלטון חוק."
      ]
    },
    {
