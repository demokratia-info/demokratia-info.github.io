---
{
  ...
  "titleHe": "חוקתיות סמלית וגבולות הקונצנזוס",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_symbolic_constitutionalism_on_sacred_cows_and_abominable_pigs_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: המאמר דן במשמעותם של סמלים בתוך המשפט החוקתי על ידי ניתוח תפקידם של חוקים המכניסים סמלים לאומיים מסורתיים לשתי מערכות משפטיות המאופיינות בתערובת של תכונות חילוניות ומסורתיות - הודו וישראל. באופן ספציפי, הוא מתמקד באיסורים החוקיים על שחיטת בקר בהודו ועל גידול חזירים ומסחר חזיר בישראל, בעלי חיים הנחשבים ל\"סמלים מרכזיים\" בתרבויותיהם. למרות הדמיון בנקודות המוצא שלהן, המערכות ההודיות והישראליות עברו בסופו של דבר קורסים שונים, המשקפים הבדלים בהקשרים ובמתחים הבסיסיים שלהם.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בבתי המשפט, חוקתיות ושלטון החוק, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Law, Culture and the Humanities בשנת 2010.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "חוקתיות סמלית וגבולות הקונצנזוס",
