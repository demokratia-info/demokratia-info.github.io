---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר דן במשמעותם של סמלים בתוך המשפט החוקתי על ידי ניתוח תפקידם של חוקים המכניסים סמלים לאומיים מסורתיים לשתי מערכות משפטיות המאופיינות בתערובת של תכונות חילוניות ומסורתיות - הודו וישראל. באופן ספציפי, הוא מתמקד באיסורים החוקיים על שחיטת בקר בהודו ועל גידול חזירים ומסחר חזיר בישראל, בעלי חיים הנחשבים ל\"סמלים מרכזיים\" בתרבויותיהם. למרות הדמיון בנקודות המוצא שלהן, המערכות ההודיות והישראליות עברו בסופו של דבר קורסים שונים, המשקפים הבדלים בהקשרים ובמתחים הבסיסיים שלהם."
      ]
    },
    {
