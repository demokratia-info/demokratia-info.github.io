---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר פרק זה דן במנגנון החריגה, המאפשר למחוקק - הכנסת, במקרה של ישראל - לחוקק חוקים \"על אף\" החוקה. מנגנון זה קיים בחוק יסוד: חופש העיסוק. בפסיקת שפיר משנת 2021, קבע בית המשפט העליון כי תיקונים לחוקה העולים על רמה מסוימת של ספציפיות אינם חוקתיים.",
