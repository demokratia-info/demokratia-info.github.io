---
{
  ...
  "titleHe": "האם סעיפי דת בחוקות מנבאים אפליה נגד מיעוטים?",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_do_religion_clauses_in_constitutions_predict_government_based_discrimination_against_religious_minorities_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מחקר זה בוחן האם סעיפי דת בחוקות המדינות מנבאות רמות של אפליה מבוססת ממשלה (GRD) נגד מיעוטים דתיים. באמצעות מערכי הנתונים של דת ומדינה (RAS) ו-Religion and State-Constitutions (RAS-Constitutions), אני מוצא שלסעיפים המכריזים על דת רשמית, הפרדת דת ומדינה (SRAS) וחופש דת אין השפעה משמעותית על GRD. למעשה, 152 מתוך 154 סוגי סעיפי דת שנמצאו בחוקות הנמדדות על ידי מערך הנתונים של RAS-Constitutions אינם מנבאים באופן משמעותי את GRD.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק ביחסי דת, מדינה ודמוקרטיה, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Religions בשנת 2023.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "האם סעיפי דת בחוקות מנבאים אפליה נגד מיעוטים?",
