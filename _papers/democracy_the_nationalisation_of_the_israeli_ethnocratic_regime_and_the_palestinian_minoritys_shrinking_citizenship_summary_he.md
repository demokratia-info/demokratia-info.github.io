---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "הנושא העיקרי שבו עוסק מאמר זה הוא מעמדו של המיעוט הפלסטיני בישראל (המכונה בספרות במונחים שונים: 'פלסטינים בישראל', 'ערבים בישראל', 'אזרחי ישראל הערבים', 'המיעוט הפלסטיני' ו'פלסטינים בתוך 1948'.) כחלק ממה שישראל רואה בביטחון הלאומי שלה. הוא יבחן את מרכזיותו של אופייה היהודי של ישראל, כמרכיב של הביטחון הלאומי הישראלי, המייצג מודל להרחבת מה שמקיף במושג הביטחון הלאומי."
      ]
    },
    {
