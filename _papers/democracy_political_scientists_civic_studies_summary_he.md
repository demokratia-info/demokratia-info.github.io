---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר מגמות אחרונות מצביעות על כך שהדמוקרטיה הליברלית בישראל חווה מתחים. ניתוח איכותני של מחקר המקרה של מחקרים אזרחיים בישראל מדגים את דרכי המעורבות השונות שבהן נוקטים מדענים פוליטיים בויכוח התפניות הבלתי-ליברליות.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: לימודי אזרחות הם זירת מאבק על משמעות הדמוקרטיה בישראל ועל תפקידם הציבורי של מדעני מדינה."
      ]
    },
    {
