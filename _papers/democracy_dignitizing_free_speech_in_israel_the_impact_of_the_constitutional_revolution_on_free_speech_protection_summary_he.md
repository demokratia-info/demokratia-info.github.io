---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה בוחן את השינויים בגישה לניתוח זכויות חופש הביטוי בישראל. הוא מדגים את המעבר ההולך וגובר מההשפעה האמריקנית המבוססת על החירות בשנות ה-80 למודל מבוסס יותר בכבוד, ובעיקר בהשראה קנדית וגרמנית, בעקבות אימוץ מגילת הזכויות החלקית בשנות ה-90. הדבר בא לידי ביטוי הן בניתוח סטטיסטי של פסיקת חופש הביטוי של בית המשפט העליון בישראל בשלושים השנים האחרונות והן בניתוח מהותי של פסיקות אחרונות בתחומי איפוק קודם, פורנוגרפיה והוצאת דיבה.",
