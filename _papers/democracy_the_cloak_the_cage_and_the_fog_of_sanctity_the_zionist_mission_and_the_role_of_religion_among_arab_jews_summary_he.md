---
{
  ...
  "image": {
    "src": "html_qa/democracy_the_cloak_the_cage_and_the_fog_of_sanctity_the_zionist_mission_and_the_role_of_religion_among_arab_jews_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה בוחן את המשימה הלאומית הציונית לגיוס קהילות אתניות יהודיות במדינות ערב, בתקופה שקדמה להקמת מדינת ישראל. המאמר מראה כיצד מנהג דתי קדם-לאומי זה (שיכונה 'הגלימה') אומץ ושולב בפרויקט הלאומי הציוני (\"הכלוב\"), ויצר תחילה מתח בין הממסד הדתי היהודי והתנועה ה'חילונית' הציונית, ולאחר מכן טשטש את ההבחנה בין יהדות כדת לבין יהדות זהות לאומית. המאמר מראה כיצד שליחים חילונים ממוצא אירופי הגיעו למדינות ערב כשליחים דתיים ('שדרים') ושאפו לגלות להט דתי עז בקרב בני הקהילות היהודיות שם.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק ביחסי דת, מדינה ודמוקרטיה, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Nations and Nationalism בשנת 2003.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית."
      ]
    },
    {
