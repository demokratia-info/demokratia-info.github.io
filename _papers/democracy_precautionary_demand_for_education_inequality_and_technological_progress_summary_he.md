---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: בהתאם לראיות אמפיריות, המודל מנבא שהגדלת האקראיות היא המקור העיקרי לצמיחת אי השוויון בקרב עובדים חסרי השכלה, בעוד שגידול אי השוויון בקרב עובדים משכילים נקבע יותר על ידי שינויים בהרכב והחזרה ליכולת. הגברת האקראיות יוצרת דרישה \"זהירותית\" לחינוך, שאנו מראים אמפירית שהיא משמעותית.",
