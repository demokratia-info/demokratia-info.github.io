---
{
  ...
  "authorsHtml": "<a href=\"https://www.oritkamir.org/about/\" target=\"_blank\" rel=\"noopener noreferrer\">Orit Kamir</a>",
  ...
  "sourceAuthors": [
    {
      "@type": "Person",
      "name": "Orit Kamir",
      "url": "https://www.oritkamir.org/about/"
    }
  ],
  "topics": [
  ...
  "image": {
    "src": "html_qa/democracy_basic_law_israel_as_nation_state_national_honor_defies_human_dignity_and_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: חוק יסוד: ישראל כמדינת לאום לא נועד להכריז על הסדר כלשהו או להקים נוהל כלשהו. המאמר טוען כי חוק היסוד נבנה כדי לרומם את שיח הכבוד היהודי הלאומי ואת הרשות המחוקקת והמבצעת הדוגלת בו, תוך הורדת כבוד האדם וזכויותיו, חוק היסוד המכונן והרשות השופטת האוכפת אותם. ישראל, והתנועה הציונית שיצרה אותה, התנדנדו מאז ומתמיד בין דבקות בכבוד האדם - הערך המוחלט שניתן לכל אדם באשר הוא - לבין מחויבות לרעיון הכבוד, כבוד האומה היהודית בפרט.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: המאמר ממקם את הדיון בתוך תחום חוקתיות, בתי משפט ושלטון החוק, ומראה כיצד סוגיה ממוקדת יכולה להשפיע על מוסדות, זכויות ואמון ציבורי בדמוקרטיה."
      ]
    },
    {
      "headingHe": "מה המאמר בוחן?",
      "paragraphsHtml": [
        "המאמר ״חוק יסוד: ישראל כמדינת לאום - כבוד לאומי מול כבוד האדם וזכויות אדם אוניברסליות״ מוצג כאן דרך השאלה הדמוקרטית המרכזית שעולה ממנו.",
