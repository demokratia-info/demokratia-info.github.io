---
{
  ...
  "subtitleHe": "",
  "descriptionHe": "המאמר מנתח את המעבר של ישראל בשנת 1953 מאסטרטגיה הגנתית־התקפית לאסטרטגיה התקפית־הגנתית. הוא טוען שהיוזמה הגיעה בעיקר מגופי התכנון של צה״ל, ושאישור הממשלה התקבל ללא התנגדות.",
  "summaryHe": "Oren, Barak ו־Shapira משתמשים במסמכים רשמיים ישראליים שלא נוצלו קודם, ראיונות, זיכרונות, ביוגרפיות ומקורות משניים כדי לבחון רגע מכריע ביחסי צבא וממשלה. המאמר מערער הסברים שממקדים את השינוי בבן־גוריון או בדיין ומדגיש את כוחם של מנגנוני תכנון צבאיים.",
  ...
  "image": {
    "src": "assets/article-images/real_photo_521_security_democracy_offensive_defensive_military_strategy_1953_summary_he.jpg",
    "version": "2026-07-05-real-photo-handoff",
    "altHe": "תצלום הקשור לשינוי האסטרטגיה הצבאית ב־1953 מחדד את שאלת הפיקוח האזרחי",
    "fitness": "high",
    "license": "CC BY-SA 2.0",
    "creator": "Israel Defense Forces",
    "provider": "Wikimedia Commons",
    "sourcePage": "https://commons.wikimedia.org/wiki/File:Flickr_-_Israel_Defense_Forces_-_Combat_Engineer_in_the_Field.jpg",
    "originalUrl": "https://upload.wikimedia.org/wikipedia/commons/8/8c/Flickr_-_Israel_Defense_Forces_-_Combat_Engineer_in_the_Field.jpg",
    "fileTitle": "Flickr - Israel Defense Forces - Combat Engineer in the Field.jpg",
  ...
  "oneLinerHtml": "המאמר מראה ששינוי אסטרטגי ביטחוני יכול להתחיל בתוך מנגנוני תכנון צבאיים ולקבל אישור אזרחי כמעט ללא התנגדות.",
  "sections": [
    {
