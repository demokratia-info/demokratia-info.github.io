---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר מחקר עבר, המתמקד בדרך כלל בנוצרים במדינות נוצריות, מצא שנשים נוטות להיות יותר דתיות מגברים. מחקר זה משתמש בנתונים מייצגים לאומיים מקוריים (N = 5,601) עם דגימות יתר אסטרטגיות של קבוצות מיעוט כדי לבחון שונות באופן שבו דת ומגדר מצטלבים בין זהויות אתניות-דתיות בישראל. אנו מדגימים שישראל חורגת מהדפוס הטיפוסי של נשים שנראות דתיות יותר מגברים.",
