---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: במחקר זה יישמנו ניתוח תוכן איכותי לראיונות חצי-מובנים עם מורים ישראלים במטרה לשפוך אור על כמה מהחסמים וההזדמנויות ל-GCE במצב רווי סכסוכים. בסך הכל, מחקר זה מצביע על כך שיהיה צורך לנסח את GCE בצורה שונה במדינות מוכות סכסוכים מאשר בהקשרים מערביים אחרים.",
