---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר בוחן את השאלה האם ישראל חווה 'רגע חוקתי' ומה כרוך ברגע כזה, תוך התחשבות במציאות החברתית, המשפטית והפוליטית המורכבת של המדינה. המאמר טוען שיש לבחון ולנתח את האירועים הנוכחיים בהקשר רחב יותר של תהליכים המתרחשים בחברה ובמערכת המשפט הישראלית בשני העשורים האחרונים.",
        "איך משבר חוקתי יכול להפוך לתהליך חוקתי מכליל ושוויוני."
      ]
    },
    {
