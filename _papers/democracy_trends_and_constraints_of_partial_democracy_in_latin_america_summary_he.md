---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה מנתח את הצורות והתוצאות המעורבות של מיסוד הדמוקרטיה החלקית בשילוב עם מדיניות השוק החופשי בשני העשורים האחרונים באמריקה הלטינית. הצגת שאלות אלו וחיפוש תשובות בתהליכים הממשיים של דמוקרטיזציה והכנסת מדיניות שוק חופשי, מעביר את הניתוח מתחום המודלים של הדמוקרטיה לתחום הפרקטיקה הדמוקרטית ומדגיש את המתחים הנובעים מכך עם מודלים של דמוקרטיה שאומצו וחולקו עם מדינות הליבה של המערב המפותח.",
