---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: במאמר שהתפרסם לאחרונה, אני טוען שניתן להבין בצורה הטובה ביותר את ה\"חוקתיות החדשה\" - השינוי ביחסים בין בתי המשפט והמוסדות הייצוגיים ששטף את העולם וששוטף כעת גם את ישראל - כאחד מאותם \"שינויים של הכל כדי שהכל יישאר אותו דבר\". בניגוד לאלו הרואים בכך התפתחות דמוקרטית במהותה, אני טוען שזהו, בפרפרזה של ראובן חסון, נשק בידי אויבי הדמוקרטיה. אני טוען שהחוקתיות החדשה נועדה לפעול ופועלת כתרופת נגד לדמוקרטיה, שהיא נועדה לשמור על האוליגרכיה של הרכוש הפרטי מפני סכנת התמותה הנשקפת ממוסדות ייצוגיים שנבחרו על ידי אנשים חסרי רכוש, ה\"דמוס\" היווני המקורי שממנו המונח.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: המאמר בוחן את החוקתיות החדשה בישראל וטוען שיש לבחון בזהירות האם היא מעמיקה דמוקרטיה או מעבירה הכרעות ציבוריות לזירה משפטית מצומצמת."
      ]
    },
    {
