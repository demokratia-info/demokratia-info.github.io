---
{
  ...
  "summaryHe": "המאמר מראה שבעלות תקשורתית אינה רק שאלה עסקית, אלא יכולה לשמש כלי בעל השפעה אלקטורלית ופוליטית עמוקה. החשיבות הציבורית של המאמר היא בכך שהוא מדגיש שהדמוקרטיה נשענת על מוסדות, שירות ציבורי וחברה אזרחית מתפקדים; כאשר המרחבים האלה נחלשים, גם ההכרעה האלקטורלית עצמה מאבדת חלק מכוחה המתקן.",
  ...
  "oneLinerHtml": "שורה תחתונה: המחקר מציג את בעלות התקשורת של עשירי-על כהשקעה פוליטית שעשויה לעצב התנהגות בוחרים ותחרות מפלגתית. במקרה הישראלי, ישראל היום שהושק בשנת 2007 ומחולק בחינם הפך למקרה מבחן מרכזי להשפעת בעלות תקשורתית על כוח פוליטי. החשיבות הציבורית של המאמר היא בכך שהוא מדגיש שהדמוקרטיה נשענת על מוסדות, שירות ציבורי וחברה אזרחית מתפקדים; כאשר המרחבים האלה נחלשים, גם ההכרעה האלקטורלית עצמה מאבדת חלק מכוחה המתקן.",
  "sections": [
    {
    ...
    {
      "headingHe": "מה הבעיה הדמוקרטית בכסף פרטי בתקשורת?",
      "paragraphsHtml": [
        "הבעיה היא חוסר סימטריה: בעל הון יחיד יכול לממן תפוצה רחבה לאורך זמן, גם כאשר המהלך אינו רווחי עסקית אך משתלם פוליטית.",
        "כדי לשמור על נאמנות למקור, יש לקרוא את התשובה לצד הטענה המרכזית של התמצית: המחקר מציג את בעלות התקשורת של עשירי-על כהשקעה פוליטית שעשויה לעצב התנהגות בוחרים ותחרות מפלגתית."
      ]
    },
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "חוקרי תקשורת, כלכלנים פוליטיים, עיתונאים, רגולטורים ואזרחים המתעניינים בהשפעת כסף גדול על דמוקרטיה.",
