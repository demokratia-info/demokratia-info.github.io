---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אנו מעריכים את התרומות המתאימות של מוסדות, גיאוגרפיה ומסחר בקביעת רמות הכנסה ברחבי העולם, תוך שימוש במשתנים אינסטרומנטליים שפותחו לאחרונה עבור מוסדות ומסחר. התוצאות שלנו מצביעות על כך שאיכות המוסדות \"גוברת\" על כל השאר. ברגע שמפקחים על המוסדות, למדדים קונבנציונליים של גיאוגרפיה יש במקרה הטוב השפעות ישירות חלשות על ההכנסות, אם כי יש להם השפעה עקיפה חזקה על ידי השפעה על איכות המוסדות.",
