---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "תקציר: חיבור זה בוחן שני מקרים נפרדים אך קשורים בהם, שבהם כתב נשיא בית המשפט העליון, אשר גרוניס, חוות דעת שביטלו שתי החלטות שקיבלו ועדת הבחירות המרכזית של הכנסת. ההחלטה הראשונה פסלה את ח\"כ חנין זועבי ממפלגת בל\"ד מלהתמודד על התפקיד, בעוד שהשנייה צנזרה פרסומות הן של מפלגת בל\"ד והן של מפלגת הימין היהודית עוצמה לישראל במהלך מערכת הבחירות ב-2012. המהות של החלטות אלה מדברת על המחויבות שהיו לגרוניס ולבית המשפט לעקרונות הדמוקרטיה הליברלית."
      ]
    },
    {
