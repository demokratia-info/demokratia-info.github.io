---
{
  ...
  "titleHe": "דתות הגמוניות, רובנות והטיה דתית ממשלתית",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_hegemonic_religions_majoritarianism_and_the_legitimate_limits_of_governmental_religious_bias_summary_he.jpg",
    "version": "2026-05-23-extra-100-economics-refill",
    "altHe": "תמונה עריכתית: דתות הגמוניות, רובנות והטיה דתית ממשלתית",
    "fitness": "standard"
  },
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: כמה מקרים בולטים כוללים את איסור הצריחים השוויצריים משנת 2009, החלטת ECtHR משנת 2011 בתיק Lautsi (Lautsi vs. Italy (2011) בקשה מס' 30814/06) וכן ההחלטה האחרונה של ארה\"ב. מקרה של האגודה ההומניסטית האמריקאית (מס' 17-1717, 588 U.S. שנית, בסעיף שני, ברגע שיש לנו הבנה מדויקת של ה-RMA, להציע דיון ביקורתי בגישה זו.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק ביחסי דת, מדינה ודמוקרטיה, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Religions בשנת 2020.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "דתות הגמוניות, רובנות והטיה דתית ממשלתית",
