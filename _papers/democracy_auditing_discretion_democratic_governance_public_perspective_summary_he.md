---
{
  ...
  "image": {
    "src": "assets/article-images/061_protest_democracy_auditing_discretion_democratic_governance_public_perspective_summary_he.png",
  ...
  "oneLinerHtml": "כאשר האזרחים חשים שערוצי ההשפעה הפוליטיים חלשים, הם נוטים לצפות ממבקר המדינה לביקורת רחבה יותר ולא רק לבדיקה טכנית.",
  "sections": [
    {
