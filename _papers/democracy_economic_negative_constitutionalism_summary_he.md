---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר מתמקד בפסיקה של ישראל כתיאור מקרה של יחסי הגומלין בין חוקתיות וזכויות חברתיות. המאמר מתמקד במקרים של חוקתיות בבית המשפט העליון בישראל הקשורים לזכות לחיות בכבוד ובוחן את אימוץ החוקתיות הצרה הזו. בהתבסס על הפתולוגיות של הפסיקה הנוכחית בישראל, המאמר מסתיים בקידום היישום של מודל החוקה החברתית החיובית.",
        "המאמר מציע לחשוב על חוקתיות כלכלית שלילית דרך פסיקת בית המשפט העליון בישראל, ועל ההשלכות שלה לריבונות דמוקרטית ולזכויות חברתיות."
      ]
    },
    {
