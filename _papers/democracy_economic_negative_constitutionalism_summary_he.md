---
{
  ...
  "oneLinerHtml": "המאמר מציע לחשוב על חוקתיות כלכלית שלילית דרך פסיקת בית המשפט העליון בישראל, ועל ההשלכות שלה לריבונות דמוקרטית ולזכויות חברתיות. השאלה הדמוקרטית היא כיצד לאזן בין הגנה חוקתית מפני כוח עודף לבין שמירת מרחב ממשי להכרעה ציבורית וכלכלית.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה מתמקד בפסיקה של ישראל כתיאור מקרה של יחסי הגומלין בין חוקתיות וזכויות חברתיות. המאמר מתמקד במקרים של חוקתיות בבית המשפט העליון בישראל הקשורים לזכות לחיות בכבוד ובוחן את אימוץ החוקתיות הצרה הזו. בהתבסס על הפתולוגיות של הפסיקה הנוכחית בישראל, המאמר מסתיים בקידום היישום של מודל החוקה החברתית החיובית.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: המאמר מציע לחשוב על חוקתיות כלכלית שלילית דרך פסיקת בית המשפט העליון בישראל, ועל ההשלכות שלה לריבונות דמוקרטית ולזכויות חברתיות."
      ]
    },
    {
