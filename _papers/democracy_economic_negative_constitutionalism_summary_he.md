---
{
  ...
  "oneLinerHtml": "המאמר מציע לחשוב על חוקתיות כלכלית שלילית דרך פסיקת בית המשפט העליון בישראל, ועל ההשלכות שלה לריבונות דמוקרטית ולזכויות חברתיות. השאלה הדמוקרטית היא כיצד לאזן בין הגנה חוקתית מפני כוח עודף לבין שמירת מרחב ממשי להכרעה ציבורית וכלכלית. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד כללים משפטיים, ביקורת שיפוטית ועיצוב מוסדי משפיעים בפועל על היכולת להגביל כוח שלטוני, לשמור על אחריות ציבורית ולהבטיח שכללי המשחק הדמוקרטיים לא יישחקו בהדרגה.",
  "sections": [
    {
