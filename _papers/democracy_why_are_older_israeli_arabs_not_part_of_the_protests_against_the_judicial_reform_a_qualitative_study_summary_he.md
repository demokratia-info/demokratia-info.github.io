---
{
  ...
  "sections": [
    {
      ...
      "paragraphsHtml": [
        "במרכז הדיון נמצאת השאלה כיצד סוגיית מבוגרים ערבים והמחאה נגד הרפורמה המשפטית משפיעה על היחסים בין אזרחים, מוסדות וקבוצות חברתיות.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: במחאות נגד הרפורמה המשפטית המוצעת שהחלה בתחילת 2023 בישראל, היעדר השתתפות• על קובעי המדיניות לעשות מאמצים לצמצם את הפערים הסוציו-אקונומיים בין קשישים מקבוצות מיעוט ורוב. בולט מיון ערביי ישראל, במיוחד היעדרם של ערביי ישראל מבוגרים. מטרת המחקר הנוכחי הייתה לחקור את עמדותיהם של ערביי ישראל מבוגרים ביחס לרפורמה השיפוטית המוצעת בישראל ולבחון את הסיבות להיעדרותם מהמחאות. נערכו ראיונות חצי מובנים עם 23 ערביי ישראל מבוגרים.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המשמעות הדמוקרטית נמצאת בכך שהדיון במבוגרים ערבים והמחאה נגד הרפורמה המשפטית אינו נושא טכני בלבד; הוא נוגע לשאלה מי יכול להשפיע, מי מוגן מפני שרירות, ואילו מוסדות מסוגלים להציב גבולות לכוח.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        ...
        "גם כאשר המאמר משווה בין מדינות או עוסק במקרה שאינו רק ישראלי, הדיון במבוגרים ערבים והמחאה נגד הרפורמה המשפטית מספק זווית לבחינת גבולות הכוח, ההשתתפות והאחריות הציבורית בישראל."
      ]
    },
    {
      "headingHe": "איזו בעיה דמוקרטית עולה מן המאמר?",
      "paragraphsHtml": [
        "הבעיה הדמוקרטית היא כיצד להתמודד עם מבוגרים ערבים והמחאה נגד הרפורמה המשפטית בלי לוותר על <strong>שוויון אזרחי</strong>, ביקורת ציבורית וכללים החלים גם על בעלי כוח.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "הקשר לזכויות ולשוויון נובע מכך שהדיון במבוגרים ערבים והמחאה נגד הרפורמה המשפטית עשוי להשפיע על גישה למשאבים, הכרה, הגנה משפטית או השתתפות פוליטית. לכן השאלה אינה רק מי צודק בוויכוח, אלא האם כל הקבוצות נהנות ממעמד אזרחי הוגן."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "מבוגרים ערבים והמחאה נגד הרפורמה המשפטית",
