---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אחת התוצאות היותר מפתיעות של הבחירות בישראל ב-1988 הייתה הצלחתן של המפלגות הדתיות כביכול, המורכבות מיהודים חרדים וחרדים. האורתודוקסיה הציונית המודרנית מצאה עצמה מחולקת בין הציונות הדתית המשיחית והלא-משיחית; האורתודוקסיה החרדית הקונטרה-קולטורטיבית המחמירה יותר מצאה עצמה מפוצלת בין תומכי ש\"ס ותומכי אגודת ישראל.",
