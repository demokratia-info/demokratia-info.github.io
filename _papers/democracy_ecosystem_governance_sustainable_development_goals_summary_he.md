---
{
  ...
  "summaryHe": "פיתוח בר קיימא שואף לתת מענה לדאגות כלכליות, חברתיות וסביבתיות, אך היעדר הנוכחי של ממשל סביבתי מגיב מעכב את ההתקדמות. פיתוח כלכלי לטווח קצר הוביל לפעולות מוגבלות, ניהול משאבים לא בר-קיימא ומערכות אקולוגיות מושפלות. המאמר מסביר את החשיבות של ממשל מערכת אקולוגית בהשגת יעדי SDG, ומציע כמה דרכים להבטיח ששירותי מערכת אקולוגית נשקלו בצורה משמעותית. בהקשר דמוקרטי, הממצא המרכזי הוא שהנושא אינו רק טכני או מקצועי: הוא משפיע על האופן שבו כוח מופעל, מוגבל ומוצדק כלפי אזרחים וקבוצות שונות.",
