---
{
  ...
  "oneLinerHtml": "המאמר בוחן את סוגיית מבנה החוקה הישראלית והמתחים שבתוכה דרך עדשה של חוקתיות, בתי משפט ושלטון החוק.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: ספר זה מציג את המאפיינים העיקריים של המערכת החוקתית הישראלית ודיון אקטואלי בחוקי היסוד של ישראל. בעקבות מורשתה הבריטית והיעדר חוקה רשמית, צמחה הדמוקרטיה של ישראל במשך יותר מארבעה עשורים על פי עקרון העליונות הפרלמנטרית. ה\"מהפכה החוקתית\" של שנות ה-90 החלה עידן חדש בהיסטוריה החוקתית של ישראל, תוך הצגת מודל חוקתי ותפיסת הביקורת השיפוטית על חוקים.",
