---
{
  ...
  "titleHe": "סמכויות חירום מיניסטריאליות בניהול בתי המשפט בישראל",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_ministerial_emergency_powers_over_court_administration_in_the_israeli_judiciary_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה מתמקד בניהול בתי המשפט בישראל בתקופת מגיפת הקורונה, ובמיוחד בסמכויות החירום שבהן משתמש שר המשפטים. בעוד שהספרות על סמכויות חירום דנה בהרחבה באתגרים הגלומים בשמירה על שלטון החוק בתנאים קיצוניים, הספרות על מינהל בתי המשפט לא הראתה מודעות ברורה לנושא, למרות שדנה בהרחבה במתיחות הטבועות בשליטה המבצעת על ניהול בתי המשפט. מאמר זה מציין, בהסתמך על שני הדיונים התיאורטיים הללו, שעלינו לבנות בקפידה את סמכויות החירום על ניהול בתי המשפט תוך הקפדה על מימוש עקרונות העצמאות השיפוטית והאחריות השיפוטית, המחייבת בחירום הפרדה ברורה בין הסמכות להכריז על מצב חירום מהסמכות לצמצם את פעולות בתי המשפט עקב מצב החירום.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בבתי המשפט, חוקתיות ושלטון החוק, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת International Journal for Court Administration בשנת 2021. הזווית הדמוקרטית היא שהסדרים מוסדיים אינם רק רקע טכני, אלא תנאי לאמון, לשוויון בפני הכללים וליכולת להגביל כוח ציבורי."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "סמכויות חירום מיניסטריאליות בניהול בתי המשפט בישראל",
