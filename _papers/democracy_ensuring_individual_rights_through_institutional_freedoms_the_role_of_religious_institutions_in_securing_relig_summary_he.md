---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המחקר משתמש במערך הנתונים של סיבוב 3 של דת ומדינה (RAS3) כדי לעקוב אחר הגבלות שעומדות בפני ארגונים דתיים ויחידים בין 1990 ל-2014, וחוקר כיצד חירויות מוסדיות מופחתות מביאות לפחות חירויות אינדיבידואלים. המחקר מוצא שההגבלות על חירויות הדת המוסדיות והפרטיות הן שכיחות ועולות."
      ]
    },
    {
