---
{
  ...
  "titleHe": "חירויות מוסדיות והגנה על זכויות דת",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_ensuring_individual_rights_through_institutional_freedoms_the_role_of_religious_institutions_in_securing_relig_summary_he.jpg",
    "version": "2026-05-23-extra-100-economics-refill",
    "altHe": "תמונה עריכתית: חירויות מוסדיות והגנה על זכויות דת",
    "fitness": "standard"
  },
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מחקר זה משתמש במערך הנתונים של סיבוב 3 של דת ומדינה (RAS3) כדי לעקוב אחר הגבלות שעומדות בפני ארגונים דתיים ויחידים בין 1990 ל-2014, וחוקר כיצד חירויות מוסדיות מופחתות מביאות לפחות חירויות אינדיבידואלים. אנו מוצאים שההגבלות על חירויות הדת המוסדיות והפרטיות הן שכיחות ועולות.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בזכויות, שוויון והגנות למיעוטים, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Religions בשנת 2021.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "חירויות מוסדיות והגנה על זכויות דת",
