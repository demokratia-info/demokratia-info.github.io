---
{
  ...
  "oneLinerHtml": "שורה תחתונה: המאמר עוסק בהקשר בין שלטון החוק, מוסדות כלכליים וצמיחה, ומראה מדוע הדיון במוסדות אינו טכני בלבד. הוא רלוונטי להבנת דמוקרטיה משום שכללים, אכיפה ואמון ציבורי משפיעים על זכויות, צמיחה, אחריותיות והגבלת כוח.",
  "sections": [
    {
