---
{
  ...
  "oneLinerHtml": "המאמר מסביר שמשבר דמוקרטי מתפתח כאשר פופוליזם וקיטוב מצדיקים פגיעה במוסדות בשם רצון העם או בשם מאבק במחנה היריב. הדגש הדמוקרטי הוא על המעבר ממחלוקת פוליטית רגילה לתפיסה שבה היריב נתפס כבלתי לגיטימי והמוסדות נתפסים כמכשול שיש לפרק.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מיד לאחר השבעת ממשלתו השישית של נתניהו בסוף 2022, הציג שר המשפטים יריב לוין תוכנית מקיפה לעיצוב מחדש של יסודות המשטר בישראל. כיצד ניתן להסביר את החשש מתוכניתו והתגובות החריפות שהיא עוררה בציבור הישראלי? המחברים בוחנים את התהליכים העמוקים ואת החולשה של המבנים המוסדיים שהביאו אותנו למשבר החוקתי של 2023-2026.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: המאמר מסביר שמשבר דמוקרטי מתפתח כאשר פופוליזם וקיטוב מצדיקים פגיעה במוסדות בשם רצון העם או בשם מאבק במחנה היריב."
      ]
    },
    {
