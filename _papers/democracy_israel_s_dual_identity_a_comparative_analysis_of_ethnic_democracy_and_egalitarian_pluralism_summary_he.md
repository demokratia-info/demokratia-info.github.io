---
{
  ...
  "image": {
    "src": "assets/article-images/real_photo_379_minorities_democracy_israel_s_dual_identity_a_comparative_analysis_of_ethnic_democracy_and_egalitaria.jpg",
    ...
    "sourcePage": "https://commons.wikimedia.org/wiki/File:Olive_Groves_in_Sakhnin.jpg",
    "originalUrl": "https://upload.wikimedia.org/wikipedia/commons/9/95/Olive_Groves_in_Sakhnin.jpg",
    "fileTitle": "Olive Groves in Sakhnin.jpg",
  ...
  "oneLinerHtml": "המאמר מציב זו מול זו שתי תשובות למתח היהודי־דמוקרטי בישראל: ניהול הסטטוס קוו דרך דמוקרטיה אתנית, או שינוי מבני לעבר פלורליזם שוויוני.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר בוחן את זהותה הכפולה של ישראל כמדינה יהודית ודמוקרטית באמצעות השוואה בין שני מודלים תאורטיים: הדמוקרטיה האתנית של סמי סמוחה והפלורליזם השוויוני של גילה סטופלר. הדמוקרטיה האתנית מוצגת כמודל שמבקש לשמר את אופייה היהודי של המדינה תוך קיום מוסדות דמוקרטיים, אך מעניק למיעוטים זכויות במסגרת מוגבלת וכפופה לדומיננטיות של הרוב היהודי.",
        "הניתוח טוען שהמודל האתני מספק פתרון פרגמטי לניהול הסטטוס קוו ומדגיש יציבות, לכידות לאומית והישרדות, אך הוא משמר אי־שוויון מבני, מרחיק קבוצות מיעוט ומעורר ביקורת פנימית ובינלאומית. בכך הוא מחזק מבני כוח קיימים ופוגע בשאיפות הדמוקרטיות לשוויון מלא.",
        "מנגד, פלורליזם שוויוני מוצג כחזון שמבקש להרחיב זכויות מיעוטים, לצמצם את השפעת הסמכות הדתית ולקדם רפורמות מבניות בשם שוויון, זכויות אדם והגינות. המאמר מסכם שהבחירה בין המודלים משקפת שאלות רחבות על ממשל, יחסים בין קבוצות, מעמדה הבינלאומי של ישראל והאפשרות לאזן בין זהות לאומית לבין עקרונות דמוקרטיים אוניברסליים."
      ]
    },
    {
