---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המחקר בוחן את המתח של הזהות הכפולה של ישראל כמדינה יהודית ודמוקרטית באמצעות מסגרות של דמוקרטיה אתנית שניסחה על ידי סמי סמוחה ופלורליזם שוויוני שהוצע על ידי גילה סטופלר. המחקר משתמש בניתוח השוואתי של מודלים אלה, המשלב חקירה נושאית, מקרי מקרים וחקירה פרשנית כדי להעריך את היסודות התיאורטיים, היישומים המעשיים וההשלכות החברתיות שלהם. הממצאים חושפים כי דמוקרטיה אתנית שמה דגש על יציבות ולכידות לאומית על חשבון ההכללה המוחלטת."
      ]
    },
    {
