---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "על רקע משפטי זה, המאמר בוחן את הזכות הבסיסית להינשא. עם זאת, לאור ההשפעה הפוטנציאלית המוגבלת של זכות בסיסית להינשא בישראל, המאמר שוקל את הרעיון של ביטול הנישואין החוקיים בישראל כליל. בתגובה לביקורת פוטנציאלית בהתייחסות להקשר הישראלי הייחודי, עולה כי ביטול כזה יכול לפתור את הקונפליקט המתמשך בין ההגדרה העצמית של ישראל כמדינה יהודית לבין הגדרתה העצמית כמדינה דמוקרטית בהקשר של הכרה ביחסים אינטימיים של מבוגרים."
      ]
    },
    {
