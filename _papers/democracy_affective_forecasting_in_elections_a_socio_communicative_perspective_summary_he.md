---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המחקר נועד להראות את החשיבות של פרספקטיבה חברתית-תקשורתית להבנת המנבאים, הביטויים וההשלכות של חיזוי רגשי, במיוחד כאשר עתידים קולקטיביים עומדים על כף המאזניים. באמצעות מקרה בוחן של הבחירות בישראל 2019–2021 ושילוב של סקר בן 12 גלים ו-25 קבוצות מיקוד, המאמר מראה כיצד תחזיות רגשיות פוליטיות קשורות לגורמים חברתיים-תקשורתיים, משמשות באינטראקציות חברתיות ויש להן השלכות על קיטוב והשתתפות פוליטיים. המאמר מסתיים בדיון על ההשלכות של הממצאים במחקר על מחקר עתידי על חיזוי רגשי במחקרי תקשורת."
      ]
    },
    {
