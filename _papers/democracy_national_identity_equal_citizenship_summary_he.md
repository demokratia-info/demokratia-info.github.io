---
{
  ...
  "subtitleHe": "",
  "descriptionHe": "איך מאבק על בית המשפט משקף שינוי עמוק בזהות החוקתית ובשאלת השוויון. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד כללים משפטיים, ביקורת שיפוטית ועיצוב מוסדי משפיעים בפועל על היכולת להגביל כוח שלטוני, לשמור על אחריות ציבורית ולהבטיח שכללי המשחק הדמוקרטיים לא יישחקו בהדרגה.",
  ...
  "oneLinerHtml": "הממצא הנורמטיבי של ברק מדינה מן האוניברסיטה העברית ועפרה בלוך מאוניברסיטת תל אביב הוא שהרפורמה המשפטית משקפת מאבק עמוק על הזהות החוקתית של ישראל. המהלך אינו רק ניסיון לבטל את מהפכת 1992, אלא שינוי לכיוון שמערער את עקרון השוויון האזרחי.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר התיקון השיפוטי, שנועד להחליש את הרשות השופטת ולשחרר את הכוח השלטוני מהבדיקות המבניות שלה, צריך להיות מובן, לטענתנו, כחלק משינוי עמוק יותר של הזהות החוקתית של ישראל. אנו מראים שבעוד שהמהפכה של 1992 נהנתה מלגיטימציה חברתית נורמטיבית ולפחות חלקית, הניסיונות הנוכחיים לא.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: איך מאבק על בית המשפט משקף שינוי עמוק בזהות החוקתית ובשאלת השוויון."
      ]
    },
    {
