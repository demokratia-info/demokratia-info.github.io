---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר מבקש לקבוע את דיוק התחזיות של חוקרי הפוליטיקה הישראלית לגבי היעלמות המודל הקונסוציאציוני ביחסי מדינה-דת, שיוחלף בהופעתו של מודל משבר, המאיים על יציבות הדמוקרטיה הישראלית. בעזרת כלי מתודולוגי ייחודי, המבוסס על החשיבות היחסית המיוחסת לנושא במצעים של המפלגות, המחקר עקב לאורך השנים אחר מיקום הנושא על סדר היום, ובדק האם הוא הולך וגובר מאז שנות ה-90 כאינדיקציה להתפוררות המודל הקונסוציאציוני. עם זאת, במהלך המאה העשרים ואחת, המתח לא עלה, בעוד שבחירות 2015 מציגות ירידה דרמטית במיקומו של הנושא על סדר היום, מה שמפריך את תחזית החוקרים."
      ]
    },
    {
