---
{
  ...
  "titleHe": "האם מודל ההסכמה ביחסי דת ומדינה בישראל עדיין חי?",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_the_state_religion_issue_in_israel_is_the_consociational_model_still_alive_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה מבקש לקבוע את דיוק התחזיות של חוקרי הפוליטיקה הישראלית לגבי היעלמות המודל הקונסוציאציוני ביחסי מדינה-דת, שיוחלף בהופעתו של מודל משבר, המאיים על יציבות הדמוקרטיה הישראלית. בעזרת כלי מתודולוגי ייחודי, המבוסס על החשיבות היחסית המיוחסת לנושא במצעים של המפלגות, עקבנו לאורך השנים אחר מיקום הנושא על סדר היום, ובדקנו האם הוא הולך וגובר מאז שנות ה-90 כאינדיקציה להתפוררות המודל הקונסוציאציוני. עם זאת, במהלך המאה העשרים ואחת, המתח לא עלה, בעוד שבחירות 2015 מציגות ירידה דרמטית במיקומו של הנושא על סדר היום, מה שמפריך את תחזית החוקרים.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק ביחסי דת, מדינה ודמוקרטיה, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Israel Affairs בשנת 2019. הזווית הדמוקרטית היא שהסדרים מוסדיים אינם רק רקע טכני, אלא תנאי לאמון, לשוויון בפני הכללים וליכולת להגביל כוח ציבורי."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "האם מודל ההסכמה ביחסי דת ומדינה בישראל עדיין חי?",
