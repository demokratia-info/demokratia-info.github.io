---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אנו מנתחים את ההשפעה של מוסדות פוליטיים מבוססי מיקרו על צמיחה כלכלית בכלכלה חופפת דורות, שבה אנשים שונים בהעדפות על טובת ציבורית (כמו גם בגיל). מיסי עבודה והון מממנים את טובת הציבור ותשומה ציבורית. מוסד הייחוס הוא פרלמנט, שבו מתקבלות כל ההחלטות.",
