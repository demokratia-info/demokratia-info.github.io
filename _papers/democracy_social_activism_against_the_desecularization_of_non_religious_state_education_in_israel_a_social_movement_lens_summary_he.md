---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר מחקר איכותני זה חוקר את הפעילות החברתית הגוברת נגד מגמת הדה-חילון בחינוך הממלכתי הלא-דתי בישראל, תוך שימוש במסגרת תנועתית חברתית. על ידי עריכת ראיונות עומק עם אנשים העוסקים באקטיביזם זה, המחקר בחן את המסגרות האידיאולוגיות של השחקנים, את המבנים הארגוניים הנתפסים שלהם להתגייסות ואת השקפתם על הזדמנויות פוליטיות המשמשות לשמירה על עקרונות חילוניים במערכת החינוך בישראל. הוא גם מדגיש את ההתקדמות הלא-לינארית של החילון והליברליזם בישראל, ומציין את התחושה שהנטייה לדה-חילון צוברת תאוצה בחלקים מסוימים בחברה.",
