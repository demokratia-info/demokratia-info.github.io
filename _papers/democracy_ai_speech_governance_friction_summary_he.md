---
{
  ...
  "summaryHe": "המאמר טוען שממשל דיבור באמצעות AI צריך לכלול חיכוך דמוקרטי: יכולת להבין, לערער ולהשתתף בעיצוב כללי ההסרה וההעדפה של תכנים. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד עמדות הציבור, רגשות פוליטיים וקיטוב משפיעים על נכונות לקבל כללי משחק משותפים, לכבד יריבים פוליטיים ולהגן על מוסדות גם כאשר הם פועלים נגד העדפה מחנאית רגעית.",
  ...
  "oneLinerHtml": "שורה תחתונה: המאמר טוען שממשל דיבור באמצעות AI צריך לכלול חיכוך דמוקרטי: יכולת להבין, לערער ולהשתתף בעיצוב כללי ההסרה וההעדפה של תכנים. המאמר מחבר בין רגולציה של פלטפורמות, חופש ביטוי ועיצוב מערכות AI, ומציע לראות בחיכוך מוסדי לא תקלה אלא תנאי להגנה על שיח דמוקרטי. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד עמדות הציבור, רגשות פוליטיים וקיטוב משפיעים על נכונות לקבל כללי משחק משותפים, לכבד יריבים פוליטיים ולהגן על מוסדות גם כאשר הם פועלים נגד העדפה מחנאית רגעית.",
  "sections": [
    {
      "headingHe": "מה המאמר בוחן?",
      "paragraphsHtml": [
        "המאמר ״חיכוך דמוקרטי בממשל ביטוי באמצעות בינה מלאכותית״ מוצג כאן דרך השאלה הדמוקרטית המרכזית שעולה ממנו.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק ב־<strong>איך מכניסים חיכוך דמוקרטי לניהול דיבור על ידי בינה מלאכותית?</strong>.",
