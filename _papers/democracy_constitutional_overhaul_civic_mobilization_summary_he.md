---
{
  ...
  "oneLinerHtml": "אדם שנער טוען שהמחאה נגד הרפורמה המשפטית הצליחה להגן זמנית על מוסדות דמוקרטיים, אך לא בהכרח יצרה מחויבות עמוקה ושוויונית לזכויות אדם ולליברליזם. הפער בין ההתגייסות נגד הרפורמה לבין מיעוט המחאה בזמן המלחמה חושף את הדרת האזרחים הערבים ואת גבולות הדמוקרטיה הליברלית בישראל.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אני טוען שסיבה מרכזית לפער אינה יכולה להיות מוסברת רק על ידי הדינמיקה של מלחמה אלא גם בשל המתחים והמורכבות הטמונים בזהותה החוקתית של ישראל כמדינה יהודית ודמוקרטית. בפרט, אני טוען שהמחאות נגד שיפוץ פנו לערכים אוניברסליים ליברליים כדי לגייס תמיכה דו-מפלגתית, עם השפעה של עקיפת סוגיות מהותיות כמו כיבוש השטחים הפלסטיניים ואפליה שעומדת בפני פלסטינים ישראלים.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: איך פערי המחאה סביב הרפורמה המשפטית והמלחמה חושפים גבולות של ליברליזם, זכויות ושוויון בישראל."
      ]
    },
    {
