---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה מנתח את שתי הגישות הללו, את נקודות החוזק והחולשה שלהן, אך בסופו של דבר הוא טוען שאופציה שלישית - סקירה סמי-פרוצדורלית - היא הדרך הטובה ביותר לצאת מהחידה השיפוטית הזו. בהסתמך על טיעונים השוואתיים כמו גם תיאורטיים, הוא טוען שסקירה סמי-פרוצדורלית היא הדרך הטובה ביותר להתמודד עם שאלה אמפירית מאתגרת - גם בתנאים של אי ודאות אפיסטמולוגית.",
