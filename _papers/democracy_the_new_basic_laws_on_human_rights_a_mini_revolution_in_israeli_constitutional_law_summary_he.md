---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: חוקי היסוד קובעים מבחן איזון להכרעה האם הגבלות על זכויות מוגנות הן לגיטימיות. כל ההגבלות חייבות להיות קבועות בחוק ההולם את ישראל כמדינה יהודית ודמוקרטית, שנחקק למטרה ראויה ועומד במבחן המידתיות.",
