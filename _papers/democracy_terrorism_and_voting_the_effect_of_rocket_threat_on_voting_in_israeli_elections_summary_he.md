---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "בהסתמך על שונות בזמן ובמרחב בטווח הרקטות, המחקר מזהה את ההשפעה של איום זה על ההצבעה בבחירות בישראל. תחילה המאמר מראה כי התפתחות טווח הרקטות מובילה לשונות אקסוגנית באיום הטרור. תוצאות המחקר מצביעות על כך ששיעור קולות הימין גבוה ב-2 עד 6 נקודות אחוז ביישובים שנמצאים בטווח - השפעה משמעותית מהותית."
      ]
    },
    {
