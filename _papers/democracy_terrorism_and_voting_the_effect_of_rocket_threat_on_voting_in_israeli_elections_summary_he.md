---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: בהסתמך על שונות בזמן ובמרחב בטווח הרקטות, אנו מזהים את ההשפעה של איום זה על ההצבעה בבחירות בישראל. תחילה אנו מראים כי התפתחות טווח הרקטות מובילה לשונות אקסוגנית באיום הטרור. התוצאות שלנו מצביעות על כך ששיעור קולות הימין גבוה ב-2 עד 6 נקודות אחוז ביישובים שנמצאים בטווח - השפעה משמעותית מהותית.",
