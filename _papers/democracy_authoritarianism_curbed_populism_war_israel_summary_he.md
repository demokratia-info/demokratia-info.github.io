---
{
  ...
  "oneLinerHtml": "המאמר שואל האם מלחמה מצמצמת פרויקט פופוליסטי-סמכותני או מאפשרת לו להתארגן מחדש סביב ביטחון, זהות ולגיטימציה ציבורית. התרומה היא התבוננות בזהירות כפולה: מצב חירום יכול לבלום חלק מן המאבק הפוליטי, אך גם לפתוח דרכים חדשות לריכוז כוח. החשיבות הציבורית של המאמר היא בכך שהוא עוזר לזהות כיצד נסיגה דמוקרטית מתפתחת לא רק בצעד דרמטי אחד, אלא גם דרך רצף החלטות, שפה פוליטית ותמריצים מוסדיים שמחלישים בלמים, נורמות ואמון ציבורי.",
  "sections": [
    {
