---
{
  ...
  "summaryHe": "המאמר בוחן את סוגיית מסגור מבקשי מקלט ועמדות כלפי פליטים בישראל דרך עדשה של זכויות, שוויון אזרחי והיכולת של קבוצות שונות להשתתף בדמוקרטיה.",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "הממצאים מראים כי מראים כי נשאלים שהוצגו בפני מסגרת \"מסתננים\" היו בעלי סיכוי גבוה יותר להראות עמדות הדרה. הממצאים מראים בנוסף כי אפקט המסגור מתווך את הקשר בין איום סוציו-אקונומי נתפס לבין הדרה."
      ]
    },
    {
