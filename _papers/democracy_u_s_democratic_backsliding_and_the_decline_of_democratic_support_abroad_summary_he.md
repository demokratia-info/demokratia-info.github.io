---
{
  ...
  "titleHe": "נסיגה דמוקרטית בארצות הברית והשפעתה על תמיכה בדמוקרטיה בעולם",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_u_s_democratic_backsliding_and_the_decline_of_democratic_support_abroad_summary_he.jpg",
    "version": "2026-05-23-extra-100-economics-refill",
    "altHe": "תמונה עריכתית: נסיגה דמוקרטית בארצות הברית והשפעתה על תמיכה בדמוקרטיה בעולם",
    "fitness": "standard"
  },
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר ספרות מתפתחת בוחנת את הסיבות וההשלכות המקומיות של חזרה דמוקרטית לאחור על תפיסות הציבור של דמוקרטיה, אך טרם בחנה במלואה את תפקידם של גורמים בינלאומיים בהסבר תפיסות אלו. באופן ספציפי, ההשפעה של נסיגה דמוקרטית בדמוקרטיה אחת על תמיכת הציבור בעקרונות דמוקרטיים במדינות אחרות, הפרה עד כה את החקירה התיאורטית והאמפירית. כדי לבדוק זאת, אנו משתמשים בניסוי סקר מקורי בישראל שבו אנו בודקים את ההשפעה של שני נרטיבים לגבי בחירות 2020 בארה\"ב - אחד מאותת ירידה דמוקרטית ואחד מאותת חוסן דמוקרטי - על תמיכה בממשל אוטוריטרי.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בחוסן דמוקרטי וכללי משחק פוליטיים, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת International Journal of Public Opinion Research בשנת 2024.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "נסיגה דמוקרטית בארצות הברית והשפעתה על תמיכה בדמוקרטיה בעולם",
