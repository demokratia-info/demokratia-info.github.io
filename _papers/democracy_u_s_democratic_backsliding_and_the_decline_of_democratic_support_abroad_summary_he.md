---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "ספרות מתפתחת בוחנת את הסיבות וההשלכות המקומיות של חזרה דמוקרטית לאחור על תפיסות הציבור של דמוקרטיה, אך טרם בחנה במלואה את תפקידם של גורמים בינלאומיים בהסבר תפיסות אלו. באופן ספציפי, ההשפעה של נסיגה דמוקרטית בדמוקרטיה אחת על תמיכת הציבור בעקרונות דמוקרטיים במדינות אחרות, הפרה עד כה את החקירה התיאורטית והאמפירית. כדי לבדוק זאת, המחקר משתמש בניסוי סקר מקורי בישראל שבו המאמר בודק את ההשפעה של שני נרטיבים לגבי בחירות 2020 בארה\"ב - אחד מאותת ירידה דמוקרטית ואחד מאותת חוסן דמוקרטי - על תמיכה בממשל אוטוריטרי."
      ]
    },
    {
