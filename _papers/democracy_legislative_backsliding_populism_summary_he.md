---
{
  ...
  "descriptionHe": "איך תהליך חקיקה מזורז ופופוליזם סמכותני יכולים להחליש דמוקרטיה. החשיבות הציבורית של המאמר היא בכך שהוא עוזר לזהות כיצד נסיגה דמוקרטית מתפתחת לא רק בצעד דרמטי אחד, אלא גם דרך רצף החלטות, שפה פוליטית ותמריצים מוסדיים שמחלישים בלמים, נורמות ואמון ציבורי.",
  "summaryHe": "איך תהליך חקיקה מזורז ופופוליזם סמכותני יכולים להחליש דמוקרטיה. החשיבות הציבורית של המאמר היא בכך שהוא עוזר לזהות כיצד נסיגה דמוקרטית מתפתחת לא רק בצעד דרמטי אחד, אלא גם דרך רצף החלטות, שפה פוליטית ותמריצים מוסדיים שמחלישים בלמים, נורמות ואמון ציבורי.",
  ...
  "oneLinerHtml": "שורה תחתונה: אסנת עקירב מראה שבכנסת ה-25 הופיעו יותר סימנים של נסיגה חקיקתית מאשר בתהליך שנבדק בכנסת ה-20. הממצא המרכזי הוא שתהליך חקיקה יכול להחליש דמוקרטיה לא רק בתוכן החוק, אלא גם בדרך שבה דוחקים דיון, מומחיות, ייעוץ משפטי ונורמות פרלמנטריות. החשיבות הציבורית של המאמר היא בכך שהוא עוזר לזהות כיצד נסיגה דמוקרטית מתפתחת לא רק בצעד דרמטי אחד, אלא גם דרך רצף החלטות, שפה פוליטית ותמריצים מוסדיים שמחלישים בלמים, נורמות ואמון ציבורי.",
  "sections": [
    {
