---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר השאלה העומדת בבסיס פרק זה היא על תפקידה של החברה האזרחית בישראל בקידום או בבלימת הגיבוש הדמוקרטי. התשובה מבוססת על שלושה פרמטרים: (א) גיוס, כלומר היקף ומהות שיתוף הציבור; (ב) אינטגרציה, הנוגעת לתרומת החברה האזרחית לגשר על שסעים חברתיים; וכן (ג) עימות, לגבי תפקידה האנטגוניסטי של החברה האזרחית. השתקפותם של פרמטרים אלו בפוליטיקה הישראלית העכשווית חושפת תרומה צנועה לדמוקרטיה.",
