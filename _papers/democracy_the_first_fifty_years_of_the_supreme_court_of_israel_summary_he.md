---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: חמישים השנים הראשונות לבית המשפט העליון של ישראל חיים ה. זה מעולם לא נחשב לקיים את בית המשפט בשבתו (כמו בארצות הברית המאוחדת 3 4 JOURNAL OF SUPREME COURT HISTORY States): כבר אז עומס העבודה הצפוי - כולל השאריות מבית המשפט המנדטורי - עשה חלוקת עבודה מומלצת. רק בשנת 1957 הוסמכו הנשיא או סגנו להרחיב את הרכב בית המשפט בכל תיק נתון למספר גדול יותר ואי-זוגי של שופטים, סמכות שהפעילו הנשיאים הבאים בשפע, ולנשיא הנוכחי (אהרן ברק) יותר מעשרה מכל קודמיו.",
