---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מחקר זה מפתח תיאוריית צמיחה אבולוציונית הלוכדת את יחסי הגומלין בין האבולוציה של האנושות לצמיחה כלכלית מאז הופעת המין האנושי. תיאוריה מאוחדת זו מקיפה את האבולוציה הנצפית של אוכלוסייה, טכנולוגיה והכנסה לנפש במעבר הארוך מעידן של קיפאון מלתוסיאני לצמיחה כלכלית מתמשכת. התיאוריה מציעה כי סטגנציה כלכלית ממושכת לפני המעבר לצמיחה מתמשכת עוררה את הברירה הטבעית שעיצבה את האבולוציה של המין האנושי, בעוד שהאבולוציה של המין האנושי הייתה המקור ל-take-o¤ מעידן של קיפאון לצמיחה מתמשכת. – צמיחה; התקדמות טכנולוגית; פוריות ; הון אנושי; אבולוציה ; מבחר טבעי; סטגנציה מלתוסיאנית.",
