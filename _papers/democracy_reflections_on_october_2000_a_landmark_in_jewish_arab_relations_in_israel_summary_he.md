---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה נכתב בתגובה לאלימות שהתרחשה בישראל במהלך השבועיים הראשונים של אוקטובר 2000. עיקרו הוא שצעדי ישראל חושפים את חלולות הדמוקרטיה שלה בכל הנוגע לאזרחיה הערבים. בין התוצאות העיקריות של אירועי אוקטובר, לדעת המחבר, ניתן למנות את היפוך מגמת ה\"אינטגרציה\" ואישור הזהות הלאומית הערבית של אזרחי ישראל הערבים, זהות שאמורה להתגבש ככל שישראל נוקטת במדיניות ההפרדה שלה בשטחים הכבושים.",
