---
{
  ...
  "oneLinerHtml": "המחקר בוחן אילו עמדות וזהויות קשורות לנכונות לתמוך בצעדים שמחלישים דמוקרטיה, ומדוע תמיכה כזו אינה מוגבלת לאליטות בלבד. התרומה החשובה היא הורדת הדיון מהאליטה אל הציבור: דמוקרטיה נשחקת לא רק מלמעלה, אלא גם כאשר אזרחים מצדיקים חריגה מן הכללים.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מחקר זה בוחן את היסודות של תמיכה ציבורית בנסיגה דמוקרטית, תוך שהוא משרטט חמישה חשבונות תיאורטיים: מנהיגות פרסונליסטית, קיטוב רגשי, פופוליזם, עיקרון והסתבכות עם החוק. אנו בודקים את כוח ההסבר של חשבונות אלה בהקשר הישראלי, תוך מינוף נתוני סקרי פאנל שנאספו לפני ואחרי שהממשלה הכריזה על תוכניתה לצמצם את בתי המשפט. התוצאות מצביעות על כך שתמיכה בתוכנית קשורה מאוד לסלידה ממתנגדים מפלגתיים ולזיקה לראש הממשלה נתניהו, וביתר שאת עם הבנה עיקרית של דמוקרטיה והתנסויות שליליות עם מערכת המשפט.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: המחקר בוחן אילו עמדות וזהויות קשורות לנכונות לתמוך בצעדים שמחלישים דמוקרטיה, ומדוע תמיכה כזו אינה מוגבלת לאליטות בלבד."
      ]
    },
    {
