---
{
  ...
  "descriptionHe": "המחקר בוחן אילו עמדות וזהויות קשורות לנכונות לתמוך בצעדים שמחלישים דמוקרטיה, ומדוע תמיכה כזו אינה מוגבלת לאליטות בלבד.",
  "summaryHe": "המחקר בוחן אילו עמדות וזהויות קשורות לנכונות לתמוך בצעדים שמחלישים דמוקרטיה, ומדוע תמיכה כזו אינה מוגבלת לאליטות בלבד.",
  ...
  "oneLinerHtml": "שורה תחתונה: המחקר בוחן אילו עמדות וזהויות קשורות לנכונות לתמוך בצעדים שמחלישים דמוקרטיה, ומדוע תמיכה כזו אינה מוגבלת לאליטות בלבד. התרומה החשובה היא הורדת הדיון מהאליטה אל הציבור: דמוקרטיה נשחקת לא רק מלמעלה, אלא גם כאשר אזרחים מצדיקים חריגה מן הכללים.",
  "sections": [
    {
