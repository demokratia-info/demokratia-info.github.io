---
{
  ...
  "oneLinerHtml": "המאמר מסביר כיצד משבר חוקתי ומשבר ביטחוני יכולים להעצים זה את זה, ולמה דווקא בזמן חירום חשוב לשמר בלמים, שקיפות ואחריות. הדגש הוא על הסכנה שבה חירום ביטחוני הופך לנימוק לדחיקת שאלות של שלטון החוק והגבלת כוח. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד כללים משפטיים, ביקורת שיפוטית ועיצוב מוסדי משפיעים בפועל על היכולת להגביל כוח שלטוני, לשמור על אחריות ציבורית ולהבטיח שכללי המשחק הדמוקרטיים לא יישחקו בהדרגה.",
  "sections": [
    {
