---
{
  ...
  "oneLinerHtml": "המאמר מסביר כיצד משבר חוקתי ומשבר ביטחוני יכולים להעצים זה את זה, ולמה דווקא בזמן חירום חשוב לשמר בלמים, שקיפות ואחריות. הדגש הוא על הסכנה שבה חירום ביטחוני הופך לנימוק לדחיקת שאלות של שלטון החוק והגבלת כוח.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: פרק זה מתאר את השיפוץ השיפוטי של ממשלת ישראל לפני ואחרי 7 באוקטובר. לכאורה, אפשר היה לצפות שאחרי ה-7 באוקטובר ותחת מלחמת עזה, השיפוץ השיפוטי יבוטל ויינטש.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: המאמר מסביר כיצד משבר חוקתי ומשבר ביטחוני יכולים להעצים זה את זה, ולמה דווקא בזמן חירום חשוב לשמר בלמים, שקיפות ואחריות."
      ]
    },
    {
