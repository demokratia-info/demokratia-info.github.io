---
{
  ...
  "descriptionHe": "המאמר מסביר כיצד משבר חוקתי ומשבר ביטחוני יכולים להעצים זה את זה, ולמה דווקא בזמן חירום חשוב לשמר בלמים, שקיפות ואחריות.",
  ...
  "oneLinerHtml": "שורה תחתונה: המאמר מסביר כיצד משבר חוקתי ומשבר ביטחוני יכולים להעצים זה את זה, ולמה דווקא בזמן חירום חשוב לשמר בלמים, שקיפות ואחריות. הדגש הוא על הסכנה שבה חירום ביטחוני הופך לנימוק לדחיקת שאלות של שלטון החוק והגבלת כוח.",
  "sections": [
    {
      "headingHe": "מה המאמר בוחן",
      "paragraphsHtml": [
        "יניב רוזנאי בוחנים את המאמר The Judicial Overhaul in Israel Before and After October 7: The Amalgamation of Constitutional Crisis &amp; Security Crisis דרך השאלה הדמוקרטית המרכזית שלו.",
