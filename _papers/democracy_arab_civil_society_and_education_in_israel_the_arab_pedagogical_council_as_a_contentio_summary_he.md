---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "באופן ספציפי, הוא מציג מקרה בוחן של יוזמה לאחרונה להקמת מועצה ערבית פדגוגית עצמאית (APC). המאמר טוען שיוזמה זו, על אף שהיא שנויה במחלוקת ומאתגרת את עצם הגדרתה של ישראל כמדינת לאום יהודית וגם כדמוקרטיה, צריכה להיחשב כאקט של אזרחות, ולא כסימן של רדיקליזציה ובדלנות."
      ]
    },
    {
