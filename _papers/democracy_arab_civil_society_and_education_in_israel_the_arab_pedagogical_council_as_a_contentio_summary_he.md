---
{
  ...
  "order": 40,
  "titleHe": "חברה אזרחית ערבית וחינוך: המועצה הפדגוגית הערבית כמיזם להכרה לאומית",
  "subtitleHe": "",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: באופן ספציפי, הוא מציג מקרה בוחן של יוזמה לאחרונה להקמת מועצה ערבית פדגוגית עצמאית (APC). אני טוען שיוזמה זו, על אף שהיא שנויה במחלוקת ומאתגרת את עצם הגדרתה של ישראל כמדינת לאום יהודית וגם כדמוקרטיה, צריכה להיחשב כאקט של אזרחות, ולא כסימן של רדיקליזציה ובדלנות.",
  ...
  "layout": "paper",
  "title": "חברה אזרחית ערבית וחינוך: המועצה הפדגוגית הערבית כמיזם להכרה לאומית",
