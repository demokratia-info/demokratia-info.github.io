---
{
  ...
  "image": {
    "src": "assets/article-images/real_photo_733_minorities_democracy_the_educators_role_in_democratic_and_multicultural_societies_student_perceptions.jpg",
    "version": "2026-07-05-real-photo-handoff",
    "altHe": "תצלום על תפקיד המחנך בחברה דמוקרטית ורב־תרבותית",
    "fitness": "high",
    "license": "CC BY-SA 4.0",
    "creator": "Sapir-turing",
    "provider": "Wikimedia Commons",
    "sourcePage": "https://commons.wikimedia.org/wiki/File:Abu-Tlul_School.jpg",
    "originalUrl": "https://upload.wikimedia.org/wikipedia/commons/4/4f/Abu-Tlul_School.jpg",
    "fileTitle": "Abu-Tlul School.jpg",
    "sourceDimensions": "4423x2768",
  ...
  "oneLinerHtml": "המאמר מחבר בין דמוקרטיה לבין עבודת בית הספר, ומראה שהחינוך הדמוקרטי תלוי בדמות המורה ובמרחב הכיתה.",
  "sections": [
    {
      "headingHe": "איך סטודנטים להוראה מדמיינים מחנך דמוקרטי?",
      "paragraphsHtml": [
        "המאמר בוחן תפיסות של סטודנטים להוראה לגבי תפקיד המחנך בחברה דמוקרטית ורב-תרבותית.",
        "המאמר מציב את המחנך כדמות שאינה רק מעבירה ידע, אלא גם מתווכת שונות, מטפחת דיאלוג ומסייעת לתלמידים להתמודד עם מחלוקת וזהות מגוונת."
      ]
    },
    {
      "headingHe": "מה משתנה בכיתה רב-תרבותית בישראל?",
      "paragraphsHtml": [
        "נקודת המוצא היא שמורים עתידיים אינם רק בעלי ידע מקצועי, אלא גם מי שיצטרכו לנהל מפגש בין תלמידים שונים.",
        "דרך תפיסות הסטודנטים במכללה להכשרת מורים, הוא מראה שחינוך לדמוקרטיה תלוי בהבנה מקצועית של המורה כמנחה ערכי, חברתי ופדגוגי בתוך כיתה מרובת זהויות."
      ]
    },
    {
      "headingHe": "למה דיאלוג הוא מיומנות מקצועית ולא קישוט ערכי?",
      "paragraphsHtml": [
        "ההקשר הישראלי מוסיף מורכבות: כיתות ובתי ספר פועלים בתוך חברה שבה זהות לאומית, דתית, עדתית ותרבותית משפיעה על יחסים יומיומיים.",
        "המאמר בוחן תפיסות של סטודנטים להוראה לגבי תפקיד המחנך בחברה דמוקרטית ורב-תרבותית."
      ]
    },
    {
      "headingHe": "איך הכשרת מורים נעשית תשתית אזרחית?",
      "paragraphsHtml": [
        "המאמר מדגיש שהמחנך נתפס כדמות שמקדמת דיאלוג, כבוד לאחר, חשיבה ביקורתית ויכולת לחיות עם מחלוקת.",
        "ההקשר הישראלי מוסיף מורכבות: כיתות ובתי ספר פועלים בתוך חברה שבה זהות לאומית, דתית, עדתית ותרבותית משפיעה על יחסים יומיומיים."
      ]
    },
    {
      "headingHe": "מה המחקר אומר על חיים עם מחלוקת?",
      "paragraphsHtml": [
        "זהו תפקיד רחב יותר מהוראת מקצוע או שמירה על משמעת.",
  ...
  "layout": "paper",
  "title": "איך פרחי הוראה מבינים את תפקיד המחנך?",
