---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר מאמר זה מתמקד בקבוצה מסוימת של מהגרי ברית המועצות לשעבר (FSU) בישראל לאחר 1989, אלו המעדיפים לשמור על דתם הנוצרית במדינה בעלת אופי יהודי מפורש. הממצאים שלנו מצביעים על כך שמהגרים נוצרים קוראים תיגר על ההגדרה ההגמונית של מיהו יהודי, מתמודדים בחריפות עם משטר ההתאגדות האתנו-לאומי הישראלי המפלה אזרחים לא-יהודים ומקדמים תביעות לשוויון זכויות.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: Raijman ו־Pinsky עוסקות במהגרים מחבר המדינות לשעבר שאינם יהודים מבחינה דתית, ובוחנות כיצד הם חווים אפליה ומרחק חברתי בישראל. המאמר מציב את שאלת השוויון האזרחי במקום שבו חוק, זהות לאומית ודת יוצרים גבולות עדינים אך ממשיים של הכללה."
      ]
    },
    {
