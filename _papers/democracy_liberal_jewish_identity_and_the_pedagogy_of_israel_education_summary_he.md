---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר מחקרים עדכניים הופיעו שטענו ששיקום הזהות היהודית הסתיר מאמצים יצירתיים לגבי מה צריך להיות חינוך יהודי. בהתבסס על החקירה הפנומנולוגית שלנו על ידע התוכן הפדגוגי של עשרים מחנכים ישראלים למופת מארצות הברית, ישראל, אוסטרליה וקנדה, אנו מתווים פדגוגיה של חינוך ישראלי להעמקת הזהות היהודית הליברלית כשהיא מושגת מנקודת מבט אתית. אנו טוענים כי החינוך הישראלי מייצג צורה נגד תרבותית של חינוך יהודי שכן הוא מסייע ללומדים לאמץ חזונות מובהקים של הטוב היהודי מעבר לפרדיגמה הליברלית-דתית וכי החינוך הישראלי מקבל עדיפות בתוך החינוך היהודי כדי להעצים את התלמידים לפתח זהויות יהודיות אתיות \"עבות\" ממקורות יהודיים.",
