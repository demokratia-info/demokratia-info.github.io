---
{
  ...
  "titleHe": "יכולת מדינתית ופיתוח כלכלי בגישת רשת",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_state_capacity_and_economic_development_a_network_approach_summary_he.jpg",
    "version": "2026-05-23-extra-100-economics-refill",
    "altHe": "תמונה עריכתית: יכולת מדינתית ופיתוח כלכלי בגישת רשת",
    "fitness": "standard"
  },
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אנו מעריכים את המודל הזה תוך ניצול רשת העירייה ואת שורשי הקיבולת המקומית של המדינה הקשורים לנוכחות המדינה הקולוניאלית וכבישי המלוכה. ההערכות שלנו מצביעות על כך שהחלטות קיבולת המדינה המקומיות הן השלמות אסטרטגיות. השפעות הגלישה הן גדולות, והן מהוות כ-50% מההשפעה הכמותית של הרחבת קיבולת המדינה המקומית, אך השפעות הרשת המונעות על ידי תגובות שיווי משקל של עיריות אחרות הן הרבה יותר גדולות.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק במוסדות ציבוריים, ממשל ואמון אזרחי, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת American Economic Review בשנת 2015.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "יכולת מדינתית ופיתוח כלכלי בגישת רשת",
