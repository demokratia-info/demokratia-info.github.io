---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: עיצוב/מתודולוגיה/גישה באמצעות מערך נתונים מקורי של פאנל המכסה ארבע שנים (1991, 2003, 2007 ו-2012), אנו מוצאים שריכוזיות תקציב קשורה ליעילות ממשלתית נמוכה יותר במדינות ה-OECD לאחר שהתייחסו לרשימת משתני בקרה, כגון תוצר מקומי גולמי (תוצר) לנפש, הוצאות ממשלתיות ומדינה קבועות בשנה. ממצאים אנו מראים שמדינות פחות ריכוזיות מציגות ביצועים טובים יותר באופן משמעותי בבריאות ובתשתיות ויעילות דומה בגביית מס. תוצאות אלו שורדות רשימה של בדיקות רגישות.",
