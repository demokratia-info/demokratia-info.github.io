---
{
  ...
  "image": {
    "src": "html_qa/democracy_minorities_in_democracy_and_policing_policy_from_alienation_to_cooperation_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: במחקר זה על רפורמות המשטרה בישראל מול המיעוט הערבי אנו מציעים מחקר מלמטה למעלה על ההשפעה הפוטנציאלית של שלושה סוגי רפורמות: גיוס אזרחים ערבים למשטרה, הכשרה תרבותית של שוטרים ומיסוד יחסי המשטרה-קהילה. הממצאים שלנו מבוססים על שני שלבי מחקר משלימים, ארבע קבוצות מיקוד וסקר מחקרי מקיף של מדגם מייצג של 1006 אזרחים ערבים בוגרים.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בזכויות, שוויון והגנות למיעוטים, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Policing and Society בשנת 2012. הזווית הדמוקרטית היא שהסדרים מוסדיים אינם רק רקע טכני, אלא תנאי לאמון, לשוויון בפני הכללים וליכולת להגביל כוח ציבורי."
      ]
    },
    {
