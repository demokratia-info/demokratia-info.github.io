---
{
  ...
  "subtitleHe": "",
  "descriptionHe": "מבט על זכויות נשים ושוויון מגדרי כסימן אזהרה לשחיקה דמוקרטית. החשיבות הציבורית של המאמר היא בכך שהוא עוזר לזהות כיצד נסיגה דמוקרטית מתפתחת לא רק בצעד דרמטי אחד, אלא גם דרך רצף החלטות, שפה פוליטית ותמריצים מוסדיים שמחלישים בלמים, נורמות ואמון ציבורי.",
  ...
  "oneLinerHtml": "המאמר מציע לראות בפגיעה בצדק מגדרי לא נושא צדדי, אלא אחד המקומות שבהם נסיגה דמוקרטית נעשית מוחשית במיוחד.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה בוחן חזרה דמוקרטית דרך עדשת הצדק המגדרי, תוך התמקדות בהתפתחויות הפוליטיות האחרונות בישראל. ניתוח איכותני של יוזמות חקיקה שלטוניות חושף דפוס מטריד: מאמצים לשחוק את עצמאות השיפוט עוקבים מקרוב אחר חוקים הממסדים את ההפרדה המגדרית ומערערים את הצדק המגדרי. המאמר מגיע למסקנה שנסיגה דמוקרטית בישראל היא מגדרית הן במבנה שלה והן בהשלכותיה, וכל הערכה של השפעתה חייבת להסביר את הפגיעה הבלתי מידתית שלה בנשים ובקהילות שוליות.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: מבט על זכויות נשים ושוויון מגדרי כסימן אזהרה לשחיקה דמוקרטית."
      ]
    },
    {
