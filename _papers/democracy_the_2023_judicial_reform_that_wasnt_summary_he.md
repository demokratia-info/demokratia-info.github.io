---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר מאמר זה מציע שתי פרשנויות לעימות החוקתי שנוצר בעקבות החקיקה המוצעת לתיקון שיפוטי משנת 2023. הוא מציב את הדיון בהקשר של מלחמת תרבות רחבה יותר על תנאי הלגיטימיות של ישראל וכרצף. בקצה אחד של הקשת, ניתן לראות את חקיקת השיפוץ השיפוטי כנוקטת טקטיקה של 'החלטה להחליט', כשהאופוזיציה משתמשת באותה טקטיקה חוקתית בכיוון ההפוך.",
