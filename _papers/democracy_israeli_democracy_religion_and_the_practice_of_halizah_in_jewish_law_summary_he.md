---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: המטרה העיקרית של מאמר זה היא לחקור כמה מההנחות התיאורטיות העומדות בבסיס תגובה ליברלית לאיומים שמציבים קבוצות דתיות שהנורמות שלהן פוגעות באחרים. קיום טקס החליזה על ידי השלטונות בישראל הוא נורמה דתית כל כך, משום שנשים שמוצאות את הנוהג פוגעני וחסר טעם נאלצות לדבוק בו. מאמר זה טוען שאנשים צריכים לשאוף להבטיח שממשלות יעניקו לכל אדם דאגה וכבוד שווה, ולקדם את ההשקפה שכל אדם חשוב וחשוב באותה מידה.",
