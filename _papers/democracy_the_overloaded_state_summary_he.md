---
{
  ...
  "image": {
    "src": "html_qa/democracy_the_overloaded_state_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: חיבור זה בוחן את התנאים בישראל לתנועה במקצוע האקדמי של מינהל ציבורי ששורשיה ומיקודה העיקריים היו בארצות הברית. מספר מאמרים וחלק גדול מהדיון הדגישו את הצורך של מנהלי ציבור לקחת על עצמם את הניסוח של הדרישות ותגובה להן, שלא מצאו ייצוג יעיל בקרב המחוקקים והמנכ\"ל הנבחרים.(1) כאן הדאגה היא לאותם היבטים של נקודת המבט של מינוברוק, המרמזים גם על יותר אחריות וגם יותר כוח לפקידי הממשלה. אף על פי כן, הוא מציע לקחים למי שיחזק את הבירוקרטיות של מדינות אחרות.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק במוסדות ציבוריים, ממשל ואמון אזרחי, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת International Journal of Public Administration בשנת 1997. הזווית הדמוקרטית היא שהסדרים מוסדיים אינם רק רקע טכני, אלא תנאי לאמון, לשוויון בפני הכללים וליכולת להגביל כוח ציבורי."
      ]
    },
    {
