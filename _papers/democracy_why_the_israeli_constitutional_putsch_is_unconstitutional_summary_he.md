---
{
  ...
  "subtitleHe": "",
  "descriptionHe": "הראל טוען שהמהלך החוקתי שקודם לאחר בחירות 1 בנובמבר 2022 אינו רק שנוי במחלוקת פוליטית, אלא בלתי חוקתי משום שהוא מחזק את הרשות המבצעת והמחוקקת ומחליש באופן דרמטי את בתי המשפט.",
  "summaryHe": "המאמר מנתח את ההצעות לשינוי מערכת המשפט בישראל לאחר בחירות 1 בנובמבר 2022, שבהן קיבלו מפלגות ימין רחוק ומפלגות דתיות רוב ובנימין נתניהו הקים ממשלה חדשה. הראל מתאר את ההצעות כניסיון לשנות את יסודותיה החוקתיים של המדינה: שינוי כוח מינוי השופטים, צמצום יכולתו של בית המשפט לפסול חוקים והחלשת הביקורת על החלטות של רשויות ביצוע. טענתו המרכזית היא שהצעות אלה אינן חוקתיות, משום ששלטון החוק מחייב שגם המחוקק יהיה כפוף למגבלות חוקתיות מהותיות ולא רק להליך חקיקה פורמלי.",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר נפתח בבחירות 1 בנובמבר 2022, שבעקבותיהן קיבלו מפלגות ימין רחוק ומפלגות דתיות רוב, ובנימין נתניהו הצליח להקים ממשלה שהמאמר מתאר כימנית ביותר בתולדות ישראל. בהמשך יזמו גורמים פוליטיים הצעה רחבה לשינוי מערכת המשפט והיסודות החוקתיים של המדינה.",
