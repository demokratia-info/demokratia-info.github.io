---
{
  ...
  "oneLinerHtml": "המחקר מראה כיצד מחנות פוליטיים מפרשים את הרפורמה המשפטית דרך אמון מוסדי, זהות ורגשות, וכך מייצרים קיטוב מהיר סביב מושג הדמוקרטיה. המאמר חשוב משום שהוא מסביר למה מחלוקת על מוסדות הופכת במהירות למחלוקת על זהות ועל עצם משמעות הדמוקרטיה.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: עבודה זו חקרה את הקיטוב ביחס לרפורמה השיפוטית של ישראל, שהוצגה בינואר 2023. אנו מוצאים שהרפורמה חילקה אנשים למחנות פרו ואנטי-רפורמיים, שנבדלו במאפיינים כמו אמון מוסדי, פטריוטיות וזהות לאומית. למשל, המחנות חלקו על אמון בממשלה מול מערכת המשפט.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: המחקר מראה כיצד מחנות פוליטיים מפרשים את הרפורמה המשפטית דרך אמון מוסדי, זהות ורגשות, וכך מייצרים קיטוב מהיר סביב מושג הדמוקרטיה."
      ]
    },
    {
