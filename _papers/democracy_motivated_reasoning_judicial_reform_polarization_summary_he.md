---
{
  ...
  "descriptionHe": "המחקר מראה כיצד מחנות פוליטיים מפרשים את הרפורמה המשפטית דרך אמון מוסדי, זהות ורגשות, וכך מייצרים קיטוב מהיר סביב מושג הדמוקרטיה. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד עמדות הציבור, רגשות פוליטיים וקיטוב משפיעים על נכונות לקבל כללי משחק משותפים, לכבד יריבים פוליטיים ולהגן על מוסדות גם כאשר הם פועלים נגד העדפה מחנאית רגעית.",
  "summaryHe": "המחקר מראה כיצד מחנות פוליטיים מפרשים את הרפורמה המשפטית דרך אמון מוסדי, זהות ורגשות, וכך מייצרים קיטוב מהיר סביב מושג הדמוקרטיה. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד עמדות הציבור, רגשות פוליטיים וקיטוב משפיעים על נכונות לקבל כללי משחק משותפים, לכבד יריבים פוליטיים ולהגן על מוסדות גם כאשר הם פועלים נגד העדפה מחנאית רגעית.",
  ...
  "oneLinerHtml": "שורה תחתונה: המחקר מראה כיצד מחנות פוליטיים מפרשים את הרפורמה המשפטית דרך אמון מוסדי, זהות ורגשות, וכך מייצרים קיטוב מהיר סביב מושג הדמוקרטיה. המאמר חשוב משום שהוא מסביר למה מחלוקת על מוסדות הופכת במהירות למחלוקת על זהות ועל עצם משמעות הדמוקרטיה. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד עמדות הציבור, רגשות פוליטיים וקיטוב משפיעים על נכונות לקבל כללי משחק משותפים, לכבד יריבים פוליטיים ולהגן על מוסדות גם כאשר הם פועלים נגד העדפה מחנאית רגעית.",
  "sections": [
    {
      "headingHe": "מה המאמר בוחן",
      "paragraphsHtml": [
        "המאמר ״בחינת חשיבה מונעת בתוך הקיטוב סביב הרפורמה המשפטית המתפתחת בישראל ב-2023״ נבחן כאן דרך השאלה הדמוקרטית המרכזית שלו.",
