---
{
  ...
  "descriptionHe": "יואב דותן מנתח את משבר הרפורמה המשפטית של 2023 דרך היחסים בין משפט חוקתי למשפט מינהלי, וטוען שליבת הביקורת השיפוטית בישראל נשענה בעיקר על נורמות מינהליות.",
  "summaryHe": "המאמר טוען שהמשבר של 2023 חשף חולשה בתיאוריה החוקתית שהתפתחה מאז 1995: בישראל אין שכבה חוקתית קשיחה מעל חקיקה רגילה, וההגנה על ביקורת שיפוטית תלויה בעיקר במשפט מינהלי ובמאבק הציבורי סביבו.",
  ...
  "image": {
    "src": "assets/article-images/real_photo_371_court_democracy_israel_constitutional_moment_admin_law_summary_he.jpg",
    "version": "2026-07-05-real-photo-handoff",
    "altHe": "תצלום על רגע חוקתי, משפט מינהלי ומאבק על ביקורת שיפוטית בישראל",
    "fitness": "high",
    "license": "Public domain",
    "creator": "Unnkown",
    "provider": "Wikimedia Commons",
    "sourcePage": "https://commons.wikimedia.org/wiki/File:PikiWiki_Israel_70603_armenian_ceremony_at_the_church_of_st._james.jpg",
    "originalUrl": "https://upload.wikimedia.org/wikipedia/commons/d/d3/PikiWiki_Israel_70603_armenian_ceremony_at_the_church_of_st._james.jpg",
    "fileTitle": "PikiWiki Israel 70603 armenian ceremony at the church of st. james.jpg",
    "sourceDimensions": "3377x2550",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "דותן מתמקד במשפט מינהלי משום שזהו התחום שבאמצעותו בג״ץ פיקח בפועל על פעולות הממשלה במשך עשורים. כלים כמו סבירות, עמידה וביקורת על שיקול דעת יצרו מנגנון יומיומי של שלטון החוק.",
