---
{
  ...
  "summaryHe": "המשבר החוקתי חשף שההגנה השיפוטית בישראל נשענת בעיקר על משפט מינהלי, מחאה ציבורית ואמון מוסדי ולא על שכבה חוקתית קשיחה. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד כללים משפטיים, ביקורת שיפוטית ועיצוב מוסדי משפיעים בפועל על היכולת להגביל כוח שלטוני, לשמור על אחריות ציבורית ולהבטיח שכללי המשחק הדמוקרטיים לא יישחקו בהדרגה.",
  ...
  "oneLinerHtml": "שורה תחתונה: יואב דותן טוען שהרפורמה המשפטית של 2023 חשפה אמת מוסדית עמוקה: בישראל, הליבה של הביקורת השיפוטית על השלטון לא נבנתה בעיקר על חוקה עליונה ומשוריינת, אלא על משפט מינהלי שהתפתח מאז שנות השמונים ועל תמיכה ציבורית שמאפשרת לבית המשפט לעמוד מול כוח רובני. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד כללים משפטיים, ביקורת שיפוטית ועיצוב מוסדי משפיעים בפועל על היכולת להגביל כוח שלטוני, לשמור על אחריות ציבורית ולהבטיח שכללי המשחק הדמוקרטיים לא יישחקו בהדרגה.",
  "sections": [
    {
