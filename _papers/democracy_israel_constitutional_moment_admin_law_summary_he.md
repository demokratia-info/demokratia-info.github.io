---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "כתוצאה מיוזמת 'הרפורמה השיפוטית' בינואר 2023, וגל המחאה הציבורי האדיר, ישראל עוברת בימים אלה מהומה פוליטית שעלולה להתפתח למשבר חוקתי מלא. המאמר טוען כי ליבת המבנה החוקתי של ישראל היו מאז ומתמיד מוסדות המשפט המנהלי כפי שנוצרו והתפתחו במהלך 'המהפכה המנהלית' של שנות ה-80. בניגוד לחוכמה הרווחת, המאמר טוען ש'המהפכה החוקתית' של אמצע שנות ה-90 לא שינתה את מבנה הליבה הזה, אלא סיפקה חגורה חיצונית של בריקדות נורמטיבית למבנה הליבה הזה.",
        "המשבר החוקתי חשף שההגנה השיפוטית בישראל נשענת בעיקר על משפט מינהלי, מחאה ציבורית ואמון מוסדי ולא על שכבה חוקתית קשיחה."
      ]
    },
    {
