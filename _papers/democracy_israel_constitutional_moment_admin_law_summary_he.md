---
{
  ...
  "oneLinerHtml": "יואב דותן טוען שהרפורמה המשפטית של 2023 חשפה אמת מוסדית עמוקה: בישראל, הליבה של הביקורת השיפוטית על השלטון לא נבנתה בעיקר על חוקה עליונה ומשוריינת, אלא על משפט מינהלי שהתפתח מאז שנות השמונים ועל תמיכה ציבורית שמאפשרת לבית המשפט לעמוד מול כוח רובני.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר כתוצאה מיוזמת 'הרפורמה השיפוטית' בינואר 2023, וגל המחאה הציבורי האדיר, ישראל עוברת בימים אלה מהומה פוליטית שעלולה להתפתח למשבר חוקתי מלא. אני טוען כי ליבת המבנה החוקתי של ישראל היו מאז ומתמיד מוסדות המשפט המנהלי כפי שנוצרו והתפתחו במהלך 'המהפכה המנהלית' של שנות ה-80. בניגוד לחוכמה הרווחת, אני טוען ש'המהפכה החוקתית' של אמצע שנות ה-90 לא שינתה את מבנה הליבה הזה, אלא סיפקה חגורה חיצונית של בריקדות נורמטיבית למבנה הליבה הזה.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: המשבר החוקתי חשף שההגנה השיפוטית בישראל נשענת בעיקר על משפט מינהלי, מחאה ציבורית ואמון מוסדי ולא על שכבה חוקתית קשיחה."
      ]
    },
    {
