...
{
  "version": 1,
  "file": "democracy_high_inequality_high_skilled_immigrants_summary_he.html",
  "slug": "democracy_high_inequality_high_skilled_immigrants_summary_he",
  "titleHe": "האם אי־שוויון מושך מהגרים מיומנים?",
  "subtitleHe": "",
  "descriptionHe": "המאמר בוחן כיצד תשואות שונות לכישורים במדינת מוצא ובמדינת יעד משפיעות על הגירה של עובדים מיומנים, תוך שימוש בנתונים על ישראלים לפני ההגירה.",
  "summaryHe": "המחקר שואל אם אי־שוויון גבוה מושך מהגרים מיומנים משום שהוא משקף תשואה גבוהה לכישורים. המודל מבחין בין כישורים כלליים, שאפשר לתגמל גם בחו״ל, לבין כישורים ייחודיים למדינת המוצא, שעלולים לאבד מערכם לאחר הגירה. בנתוני ישראל, ההסתברות להגר עולה עם השכלה, אך ביחס לשכר השיורי מופיע דפוס של U הפוכה: בעלי שכר שיורי באמצע ההתפלגות נוטים להגר יותר מבעלי השכר הנמוך או הגבוה ביותר.",
  ...
  "dateText": "פורסם: 1.6.2016",
  "doiUrl": "https://doi.org/10.1111/ecoj.12185",
  "doiLabel": "https://doi.org/10.1111/ecoj.12185",
  "authors": [
    {
      "@type": "Person",
      "name": "Eric D. Gould",
      "url": "https://en.economics.huji.ac.il/people/eric-gould"
    },
    {
      "@type": "Person",
      "name": "Omer Moav",
  ...
  "image": {
    "src": "assets/article-images/real_photo_287_economy_democracy_high_inequality_high_skilled_immigrants_summary_he.jpg",
    "version": "2026-07-05-real-photo-handoff",
    "altHe": "תצלום על הגירה מיומנת, שכר ואי־שוויון",
    "fitness": "high",
    "license": "CC BY 2.5",
    "creator": "הרווי ספיר",
    "provider": "Wikimedia Commons",
    "sourcePage": "https://commons.wikimedia.org/wiki/File:PikiWiki_Israel_52833_science_and_technology_in_israel.jpg",
    "originalUrl": "https://upload.wikimedia.org/wikipedia/commons/8/8c/PikiWiki_Israel_52833_science_and_technology_in_israel.jpg",
    "fileTitle": "PikiWiki Israel 52833 science and technology in israel.jpg",
    "sourceDimensions": "4104x1560",
  ...
  "oneLinerHtml": "אי־שוויון יכול למשוך עובדים מיומנים, אך סוג הכישורים קובע מי באמת עוזב ומי נשאר.",
  "sections": [
    {
      "headingHe": "מושגי יסוד בקצרה",
      "paragraphsHtml": [
        "<strong>הגירה סלקטיבית</strong> היא מצב שבו אנשים בעלי כישורים מסוימים מהגרים בשיעור שונה מאחרים. במאמר, הסלקציה תלויה בתשואה לכישורים במדינת היעד ובסוג הכישורים שיש למהגר.",
        "<strong>אי־שוויון בהכנסות</strong> אינו רק פער בין עשירים לעניים; הוא גם אות לגבי התגמול לכישורים בשוק העבודה. לכן הוא יכול להשפיע על החלטות הגירה ועל חלוקת ההון האנושי בין מדינות."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "האם אי־שוויון מושך מהגרים מיומנים?",
  "permalink": "/democracy_high_inequality_high_skilled_immigrants_summary_he.html",
  "paper_url": "democracy_high_inequality_high_skilled_immigrants_summary_he.html",
  "sortKey": 202605240002,
  "sourcePublishedDate": "2016-06-01"
}
---
