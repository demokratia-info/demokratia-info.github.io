---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המחקר בוחן כיצד מקורות ורמות אי השוויון בהכנסה משפיעים על האופן שבו מדינה מושכת ומשמרת עובדים מיומנים גבוהים. עם ערכי פרמטרים שמניבים רמות ריאליות של הגירה, המודל שהמאמר מציע מראה ששיעורי ההגירה עולים עם ההשכלה כאשר התשואות להשכלה גבוהות יותר בחו\"ל. באמצעות נתונים על מהגרים ישראלים לפני שהם מחליטים להגר, המחקר מוצא ראיות אמפיריות חזקות התומכות בתחזיות המודל.",
