---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: האם בבואם להחליט אם לתמוך במבצע צבאי, האם אזרחים במדינות דמוקרטיות שוקלים אם החיילים עצמם תומכים במבצע? באמצעות נתוני סקר חדשניים וניסוי בארבע מדינות דמוקרטיות עם מסורות אזרחות שונות - צרפת, ישראל, בריטניה וארצות הברית - אנו מראים שבכל ארבע המדינות, התמיכה במבצעים צבאיים תלויה במידה ניכרת בשאלה אם אנשים מאמינים שהחיילים עצמם בעד המבצע. אנו מדגישים שתי סיבות: (1) ביצועים בשדה הקרב (המשיבים חושבים שחיילים שמעדיפים את המשימה שלהם נלחמים טוב יותר), ו- (2) הסכמת החיילים (יכולת האמפתיה של בני האדם גורמת להם להיות רגישים לשאלה אם חיילים נשלחים מרצון להיפגע).",
