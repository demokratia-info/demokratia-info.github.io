---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: המאמר בוחן בביקורתיות שלוש ועדות חקירה (COI) שהקימה UNHRC כדי לחקור לכאורה פשעי מלחמה ישראלים במהלך עימותים עם חמאס בעזה. זה מראה שמנדטים מוטים של COI, בחירת יושבי ראש וחברים, שיטות חקירה, בחירת ראיות ודוחות סופיים נועדו כולם במכוון כדי למצוא את ישראל אשמה בפשעי מלחמה ב-UNHRC וב-ICC.",
