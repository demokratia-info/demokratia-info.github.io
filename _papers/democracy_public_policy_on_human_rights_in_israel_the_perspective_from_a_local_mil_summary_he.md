---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אקטיביזם שיפוטי כפי שנטען כאן הוא למעשה שיווי משקל הנובע מפעולה של מספר שחקנים הפועלים על רקע תנאים מבניים ותרבותיים מסוימים, מקומיים ובינלאומיים. הם פועלים בסביבה המאופיינת בחוסר יכולת של הממשלה לתפקד ביעילות (אי-ממשל), סביבה המראה את השפעת החוק על הפוליטיקה ופיתוח תרבות פוליטית חלופית.",
