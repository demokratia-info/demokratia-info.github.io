---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: נמצאו פערים משמעותיים ב-GLS לפי מוצא אתני, כאשר צעירים ערבים יש סיכוי נמוך בהרבה להיות מרוצים או מרוצים מאוד מחייהם. רגרסיה לוגיסטית היררכית הצביעה על כך שגורמים כלכליים, חברתיים-יחסיים וסביבתיים מעצבים את GLS, אך גורמים אלה אינם מבטלים את ההשפעה השלילית של מעמד המיעוט על GLS.",
