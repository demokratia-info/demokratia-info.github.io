---
{
  ...
  "oneLinerHtml": "המאמר מראה כיצד מאבק בטרור יכול להפוך <strong>מצב חירום זמני</strong> למשטר משפטי קבוע, ומדגיש את הצורך בביקורת שיפוטית ופרלמנטרית הדוקה.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר בוחן את ההשלכות הדמוקרטיות של “מצבי חירום קבועים” הקשורים לטרור באמצעות השוואה בין צרפת לישראל. בישראל מצב החירום קיים מאז 1948, ובצרפת הוכרז מצב חירום לאחר פיגועי נובמבר 2015, הוארך כמה פעמים, והסתיים רשמית ב־1 בנובמבר 2017.",
        "המאמר טוען כי הכרזה ראשונית על מצב חירום יכולה להיות מוצדקת מול איום ביטחוני חמור, אך הארכה ממושכת שלה מערערת עקרונות של שלטון החוק. בשני המקרים התעוררו שאלות על הפרדת רשויות, בהירות משפטית והשפעת ההסדרים על מדיניות ציבורית.",
        "הניתוח מצא שבצרפת ובישראל אומצה חקיקת טרור חדשה שנועדה להחליף את צעדי החירום או לצמצם את הצורך בהם, אך בפועל ספגה ביקורת משום שעיגנה אמצעי חריג בחקיקה רגילה. המאמר מסיק שמצבי חירום צריכים להישאר זמניים ותחומים בזמן, ושבמאבק בטרור נדרשות ביקורת שיפוטית ופרלמנטרית מוגברות והגדרות משפטיות ברורות."
      ]
    },
    {
