---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה בוחן את ההשלכות על הדמוקרטיה של \"מצבי חירום קבועים\" הקשורים לטרור, באמצעות דוגמאות והשוואה של מצבי החירום של צרפת וישראל (SoE). ישראל נמצאת ב-SoE מאז הקמתה ב-1948. בשני המקרים אומץ חוק טרור חדש שנועד להחליף את המעבר אל מחוץ ל-SoE אך למעשה עיגן מספר צעדי חירום בחקיקה רגילה.",
