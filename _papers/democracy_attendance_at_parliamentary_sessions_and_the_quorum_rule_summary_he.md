---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "סעיף 22 לתקנות הכנסת קובע כדלקמן: על חברי הכנסת להשתתף בתדירות גבוהה ככל האפשר בישיבות המליאה של הכנסת ובישיבות הוועדות שבהן הם חברים. סעיף 24 לחוק יסוד: הכנסת, לפיו \"הכנסת תקיים דיונים ותחליט החלטות, יהיו מספרים אשר יהיו\". בגוף החוק בו המחקר מוצא פטורים ממניין חובה, ישנם שלושה סעיפים המעוגנים נגד תיקון ברוב רגיל או ברוב מקרי, וניתן לתקן אותם רק ברוב מוחלט או מיוחד בעת ההצבעה."
      ]
    },
    {
