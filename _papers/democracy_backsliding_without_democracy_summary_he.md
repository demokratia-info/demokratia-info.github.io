---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר מאמר זה מנתח את ההשפעות של החזרה הדמוקרטית של ישראל על האוכלוסייה הפלסטינית בשטחים הפלסטיניים הכבושים. המאמר מדגים אפוא כיצד פלסטינים עשויים להיות בין האוכלוסיות הראשונות שסבלו מנסיגה דמוקרטית בעודם נטולי זכויות דמוקרטיות.",
