---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר יעמיד את המטרות וההשלכות של שתי תכניות פדגוגיות המקדמות חינוך להשתייכות לישראל. המייצגת את הידע הרשמי של משרד החינוך, הראשונה היא תכנית הלימודים '100 מושגים במורשת, ציונות ודמוקרטיה'. המאמר טוען כי המושגים הנכללים בתכנית הלימודים שמציבה החברה האזרחית הערבית, גם אם שנויים במחלוקת ומאתגרים את עצם הגדרתה של ישראל כמדינת לאום יהודית וגם כדמוקרטיה, צריכים להיחשב כאקט של אזרחות, ולא כסימן של רדיקליזציה ובדלנות."
      ]
    },
    {
