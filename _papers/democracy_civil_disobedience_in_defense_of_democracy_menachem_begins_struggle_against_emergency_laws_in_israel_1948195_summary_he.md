---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר מחקר זה חושף פרק ששכח בעבר בהיסטוריוגרפיה של אי-ציות אזרחי: התנגדותו של מנחם בגין לחקיקת החירום הישראלית בין 1948 ל-1954, שלטענתו ערערה את העקרונות הדמוקרטיים הבסיסיים. הוא מציג את הניתוח המלומד הראשון של התנגדותו של בגין, בטענה שהיא מהווה מופע ברור של אי ציות אזרחי, המגלם את עיקרי הליבה שלה. בלב מחקר המקרה ההיסטורי הזה עומדת שאלה פרדיגמטית: כיצד ניתן להתנגד ביעילות לחוקים השוחקים עקרונות דמוקרטיים יסודיים – אך מופשטים – כמו הפרדת רשויות, והאם ניתן להכיל התנגדות כזו במסגרות מסורתיות של אי ציות אזרחי?",
