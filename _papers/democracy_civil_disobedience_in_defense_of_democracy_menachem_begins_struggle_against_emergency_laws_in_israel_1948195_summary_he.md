---
{
  ...
  "image": {
    "src": "assets/article-images/real_photo_103_court_democracy_civil_disobedience_in_defense_of_democracy_menachem_begins_struggle_against_emer.jpg",
    ...
    "sourcePage": "https://commons.wikimedia.org/wiki/File:Protest_against_the_legal_reform_in_front_of_the_High_Court_hearing_on_September_12,_2023.jpg",
    "originalUrl": "https://upload.wikimedia.org/wikipedia/commons/5/5c/Protest_against_the_legal_reform_in_front_of_the_High_Court_hearing_on_September_12%2C_2023.jpg",
    "fileTitle": "Protest against the legal reform in front of the High Court hearing on September 12, 2023.jpg",
  ...
  "sections": [
    {
      ...
      "paragraphsHtml": [
        "חוקי חירום הם כללים שמאפשרים למדינה להפעיל סמכויות חריגות בתקופה של איום ביטחוני, משבר או סכנה ציבורית. בהקשר של המאמר, המושג חשוב משום שסמכויות כאלה עשויות להגן על הציבור אך גם לסכן זכויות, ביקורת שיפוטית ופיקוח דמוקרטי."
      ]
    },
    {
      "headingHe": "מה המאמר מצא או טוען בפועל?",
      "paragraphsHtml": [
        "המאמר מנתח את התנגדותו של מנחם בגין לחקיקת החירום הישראלית בין 1948 ל-1954, ובמיוחד לטענה שחוקים שקיבלו צורה משפטית עלולים לערער עקרונות דמוקרטיים בסיסיים. המקרה מוצג כאתגר לתפיסות מצמצמות של אי-ציות אזרחי, משום שהמאבק לא התמקד רק בזכויות מוחשיות של קבוצה מסוימת אלא גם בעקרונות מופשטים כמו הפרדת רשויות.",
        "הניתוח מראה שבגין פנה לאי-ציות אזרחי רק לאחר שמיצה אפיקים חוקיים ומוסדיים: מחאה ציבורית, פרסומים, פניות לציבור ולמקבלי החלטות, ושימוש במנגנונים פרלמנטריים. בהקשר זה המאמר מדגיש את החלטת הכנסת שלפיה תקנות ההגנה לשעת חירום מ-1945, שנותרו בתוקף מתקופת המנדט, סותרות את עקרונותיה של מדינה דמוקרטית.",
        "המאמר ממקם את המקרה בתוך דיון רחב יותר על משפט, פוליטיקה ונסיגה דמוקרטית. הוא מראה כיצד מנהיג ימין מרכזי הציג טיעון דמוקרטי נגד כלים חריגים שלטענתו ריכזו כוח, ובהמשך קושר זאת גם לביקורתו על הממשל הצבאי שהוטל על אזרחי ישראל הערבים."
      ]
    },
    {
