---
{
  ...
  "order": 110,
  "titleHe": "מה הקשר בין שימוש לרעה בסמכות המכוננת בישראל לבין שלטון החוק בישראל?",
  "subtitleHe": "",
  ...
  "oneLinerHtml": "המאמר בוחן את סוגיית שימוש לרעה בסמכות המכוננת בישראל דרך עדשה של חוקתיות, בתי משפט ושלטון החוק.",
  "sections": [
    {
      ...
      "paragraphsHtml": [
        ...
        "סמכות מכוננת היא הסמכות לקבוע או לשנות כללי יסוד חוקתיים, ולא רק לחוקק חוקים רגילים. בהקשר של המאמר, המושג עוזר להבין מתי מוסד פוליטי פועל כמחוקק רגיל ומתי הוא משנה את מסגרת המשחק הדמוקרטית עצמה."
      ]
    },
    {
      "headingHe": "מה המאמר מצא או טוען בפועל?",
      "paragraphsHtml": [
        "מעקרונות על-חוקתיים ועד לשימוש לרעה בכוח המכונן בישראל אין לישראל מסמך רשמי אחד המכונה 'החוקה' ובמשך כמעט חצי מאה התבססה על עקרון הריבונות הפרלמנטרית. ובכל זאת, מאז 'המהפכה החוקתית' של שנות ה-90, הנורמות העליונות של ישראל באות לידי ביטוי בחוקי היסוד שלה והחוקים נתונים לביקורת שיפוטית. מצב זה הוא תוצאה של חקיקת שני חוקי יסוד העוסקים בזכויות אדם בשנת 1992 – שכללו פסקת הגבלה – ושל החלטה שיפוטית בעלת משמעות מונומנטלית בשנת 1995, פרשת בנק המזרחי."
      ]
    },
    {
      "headingHe": "מה המאמר בוחן?",
      "paragraphsHtml": [
        "המאמר בוחן את סוגיית שימוש לרעה בסמכות המכוננת בישראל, וממקם את הסוגיה בתוך הדיון הרחב על חוקתיות, בתי משפט ושלטון החוק.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "התרומה המרכזית היא הפיכת שימוש לרעה בסמכות המכוננת בישראל לשאלה מוסדית ולא רק למחלוקת פוליטית רגעית.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        ...
        "כאשר שימוש לרעה בסמכות המכוננת בישראל משתנה בלי ביקורת מספקת, הפגיעה עשויה להופיע תחילה כשאלה משפטית או מקצועית צרה, אך בפועל להשפיע על תנאי ההשתתפות של אזרחים וקבוצות."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "מה הקשר בין שימוש לרעה בסמכות המכוננת בישראל לבין שלטון החוק בישראל?",
