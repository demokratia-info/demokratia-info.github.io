---
{
  ...
  "titleHe": "מסגרות בחירות: על מה היו הבחירות?",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_voter_election_frames_what_were_the_elections_about_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: בהתבסס על תיאוריה דמוקרטית, פסיכולוגיה פוליטית ותיאוריות תקשורת פוליטית, אנו משיגים כיצד הבוחרים מפרשים בחירות במונחים של מסגרות בחירות, וחוקרים את יחסי הגומלין בינן לבין מסגרות תקשורת. מסגרות הבחירות נגזרות מגוף העבודה האמפירי והנורמטיבי בנושא בחירות ודמוקרטיה, והן עוקבות באופן אמפירי באמצעות ראיונות עומק עם אזרחים, שבוצעו במהלך הבחירות לפרלמנט 2009 בישראל. ראשית, כל מסגרות הבחירות מיוצגות בנימוקים של אנשים לגבי בחירות, אך יש שונות ניכרת בשימוש בהן, והן מיושמות בדרך כלל בצורה בסיסית.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בדעת קהל, בחירות וקיטוב פוליטי, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Political Studies בשנת 2015.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "מסגרות בחירות: על מה היו הבחירות?",
