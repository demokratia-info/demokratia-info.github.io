---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "בהתבסס על תיאוריה דמוקרטית, פסיכולוגיה פוליטית ותיאוריות תקשורת פוליטית, המאמר ממשיג כיצד הבוחרים מפרשים בחירות במונחים של מסגרות בחירות, וחוקר את יחסי הגומלין בינן לבין מסגרות תקשורת. מסגרות הבחירות נגזרות מגוף העבודה האמפירי והנורמטיבי בנושא בחירות ודמוקרטיה, והן עוקבות באופן אמפירי באמצעות ראיונות עומק עם אזרחים, שבוצעו במהלך הבחירות לפרלמנט 2009 בישראל. ראשית, כל מסגרות הבחירות מיוצגות בנימוקים של אנשים לגבי בחירות, אך יש שונות ניכרת בשימוש בהן, והן מיושמות בדרך כלל בצורה בסיסית."
      ]
    },
    {
