---
{
  ...
  "oneLinerHtml": "שורה תחתונה: המאמר עוסק בדעת קהל, בחירות וקיטוב פוליטי, ומראה מדוע הדיון במוסדות אינו טכני בלבד. הוא רלוונטי להבנת דמוקרטיה משום שכללים, אכיפה ואמון ציבורי משפיעים על זכויות, צמיחה, אחריותיות והגבלת כוח.",
  "sections": [
    {
