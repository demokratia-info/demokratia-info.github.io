---
{
  ...
  "titleHe": "קיטוב פוליטי ברשתות חברתיות לאורך זמן",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_political_polarization_on_the_digital_sphere_a_cross_platform_over_time_analysis_of_interactional_positional_a_summary_he.jpg",
    "version": "2026-05-23-extra-100-economics-refill",
    "altHe": "תמונה עריכתית: קיטוב פוליטי ברשתות חברתיות לאורך זמן",
    "fitness": "standard"
  },
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: המחקר הנוכחי משלב גישות אלגוריתמיות שונות לחקר נתוני מדיה חברתית על מנת ללכוד הן את המבנה האינטראקציוני והן את התוכן של דיבור פוליטי דינמי באינטרנט. ביצענו ניתוח של קיטוב פוליטי על פני פלטפורמות מדיה חברתית (בניתוח פייסבוק, טוויטר, וואטסאפ) במשך 16 חודשים, עם קרוב לרבע מיליון תרומות מקוונות לגבי מחלוקת פוליטית בישראל. הממצאים שלנו מצביעים על כך שלא ניתן להמשיג את הקיטוב הפוליטי במדיה החברתית כתופעה מאוחדת, מכיוון שיש הבדלים משמעותיים בין פלטפורמות.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בדעת קהל, בחירות וקיטוב פוליטי, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Political Communication בשנת 2021. הזווית הדמוקרטית היא שהסדרים מוסדיים אינם רק רקע טכני, אלא תנאי לאמון, לשוויון בפני הכללים וליכולת להגביל כוח ציבורי."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "קיטוב פוליטי ברשתות חברתיות לאורך זמן",
