---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "הוא בוחן את המשתתפים, צורות הארגון, הפעילויות, האידאולוגיות והקשרים ההדדיים שלהם, תוך שימת דגש על המעבר. ניתוח נושאי של הראיונות חשף את הופעתה של עלית משרתת חדשה בהתהוות, ליברלית באוריינטציה, והתפתחה במהלך המשברים."
      ]
    },
    {
