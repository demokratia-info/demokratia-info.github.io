---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר משתמש במונח istighāba כדי לתאר מימוש רצונות מיניים במרחב מוסתר שנועד להימנע מסנקציה. זהו ממצא רגיש שמדגיש כיצד פעולה נשית יכולה להתקיים גם כאשר הכרה פומבית בה אינה זמינה."
      ]
    },
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "מן המאמר לא עולה שכל הנשים הדרוזיות פועלות באותה דרך או שכל הקהילה מגיבה באותה צורה. הקריאה הנכונה היא כניתוח של אסטרטגיות בתוך הקשר מורכב, לא כהכללה פשוטה על קבוצה שלמה."
      ]
    },
    {
