---
{
  ...
  "titleHe": "המחיר של התנגדות משפטית פנימית להפרות זכויות",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_the_price_of_internal_legal_opposition_to_human_rights_abuses_summary_he.jpg",
    "version": "2026-05-23-extra-100-economics-refill",
    "altHe": "תמונה עריכתית: המחיר של התנגדות משפטית פנימית להפרות זכויות",
    "fitness": "standard"
  },
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: רבים מהקמפיינים המשפטיים נגד פרקטיקות ומדיניות ממשלתיות במשטרים רחבי היקף של הפרת זכויות אדם מתנהלים \"בפנים\", באמצעות מוסדות המשטר עצמו. התדיינויות מסוג זה מעלות דילמות חמורות עבור עורכי דין לזכויות אדם ועבור ארגוני זכויות אדם. החיבור מנתח 35 שנים של ליטיגציה מתמשכת בנושא זכויות אדם הקשורה לכיבוש בבית המשפט הישראלי כדוגמה גנרית להתנגדות משפטית \"פנימית\" מסיבית.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בזכויות, שוויון והגנות למיעוטים, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Journal of Human Rights Practice בשנת 2009. הזווית הדמוקרטית היא שהסדרים מוסדיים אינם רק רקע טכני, אלא תנאי לאמון, לשוויון בפני הכללים וליכולת להגביל כוח ציבורי."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "המחיר של התנגדות משפטית פנימית להפרות זכויות",
