---
{
  ...
  "titleHe": "דת בצה״ל: מאינטגרציה להפרדה",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_from_integration_to_segregation_the_role_of_religion_in_the_idf_summary_he.jpg",
    "version": "2026-05-23-extra-100-economics-refill",
    "altHe": "תמונה עריכתית: דת בצה״ל: מאינטגרציה להפרדה",
    "fitness": "standard"
  },
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תפקידה של הדת בשירות הצבאי הישראלי הוא כה מורכב מטבעו עד שהוא מתנגד לסיווג בהתאם לפרדיגמות המקובלות. למרות שבהחלט הזרוע הצבאית של מדינה חילונית וליברלית, צבא ההגנה לישראל (צה\"ל) אינו עושה ניסיון להגביל נושאים דתיים לתחום הכומר בצבא. באופן ספציפי, תשומת הלב מתמקדת בראיות המצביעות על כך שהמתחים החברתיים שנוצרו בישראל עקב הבדלי השקפה דתית ושמירה על מצוות עלולים כעת להשפיע גם על צה\"ל.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק ביחסי דת, מדינה ודמוקרטיה, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Armed Forces & Society בשנת 1999.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "דת בצה״ל: מאינטגרציה להפרדה",
