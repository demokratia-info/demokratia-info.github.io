---
{
  ...
  "subtitleHe": "",
  "descriptionHe": "תקציר בעברית של מחקר על האופן שבו סטודנטיות ערביות־בדואיות במכללות להכשרת מורים בדרום ישראל חוות את העברית האקדמית כחסם לשוויון, ליוקרה מקצועית ולהשתלבות.",
  "summaryHe": "המאמר בוחן סטודנטיות ערביות־בדואיות הלומדות במוסדות להכשרת מורים לצד סטודנטים יהודים. הוא מראה שהעברית כשפה שנייה מקשה על הבנת הרצאות, סיכום חומר, כתיבה אקדמית והשתתפות בכיתה, אך גם נתפסת כמפתח מקצועי ואישי.",
  ...
  "oneLinerHtml": "המאמר מראה כיצד עברית אקדמית יכולה להיות גם שער למקצוע יוקרתי וגם חסם בפני <strong>שוויון ממשי באקדמיה</strong> של סטודנטיות ערביות־בדואיות.",
  "sections": [
    {
