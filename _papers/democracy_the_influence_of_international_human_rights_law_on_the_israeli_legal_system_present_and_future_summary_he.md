---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאז עצמאותה של ישראל, בית המשפט העליון פעיל מאוד בהקמת והבטחת מבנה מרשים של זכויות אדם. בהיעדר חוקה כתובה, ביסס בית המשפט את פסיקתו החוקתית על אופייה הדמוקרטי של המדינה. האירוע המרכזי הראשון היה אשרור של אמנות זכויות אדם חשובות על ידי ממשלת ישראל במהלך 1991, בראש ובראשונה אמנת 1966 בדבר זכויות אזרחיות ופוליטיות, אשר זכתה לכינוי \"מגילת הזכויות הבינלאומית\" (להלן: אמנת 1966).",
