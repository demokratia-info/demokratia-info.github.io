---
{
  ...
  "titleHe": "אתניזציה של המדינה ומשבר הנהגה בקרב הדרוזים בישראל",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_state_ethnicization_and_the_crisis_of_leadership_succession_among_israel_s_druze_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מדינות מופשטות מבצעות לעתים קרובות אתניות לקבוצות אתניות למטרותיהן. עם הזמן רפורמים אתניים יאתגרו אתניזציה ממלכתית כזו וינסו לארגן את הקהילה כדי להשיג יותר אוטונומיה, תוך שימוש בחקיקה של המדינה כדי להשיג רפורמות אלו. הוא מנתח באיזה שלב האתניקציה הממלכתית מפנה את מקומה לאוטונומיה אתנית על חשבון כוח המדינה, וחוקר את השלכותיה על התפתחות החברה האזרחית בתוך הקהילה האתנית.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בלאומיות, אזרחות ושוויון דמוקרטי, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Ethnic and Racial Studies בשנת 1997. הזווית הדמוקרטית היא שהסדרים מוסדיים אינם רק רקע טכני, אלא תנאי לאמון, לשוויון בפני הכללים וליכולת להגביל כוח ציבורי."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "אתניזציה של המדינה ומשבר הנהגה בקרב הדרוזים בישראל",
