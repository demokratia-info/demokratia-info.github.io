---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אנו מציעים אסטרטגיה מתודולוגית לבחון איזה מודל התנהגות שיפוטית תואם בצורה הטובה ביותר להתנהגות שיפוטית במשטרים היברידיים. אנו מראים שבג\"ץ הישראלי נוטה להיות אסטרטגי בבחינתו של עתירות הנוגעות לשטחים הכבושים של ישראל.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: איך ביקורת שיפוטית יכולה לשמור על אחריות שלטונית גם כאשר הדמוקרטיה אינה מלאה."
      ]
    },
    {
