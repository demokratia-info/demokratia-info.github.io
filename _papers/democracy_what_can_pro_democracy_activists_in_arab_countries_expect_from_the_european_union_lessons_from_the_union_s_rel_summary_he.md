---
{
  ...
  "titleHe": "מה יכולים פעילי דמוקרטיה במדינות ערב לצפות מהאיחוד האירופי?",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_what_can_pro_democracy_activists_in_arab_countries_expect_from_the_european_union_lessons_from_the_union_s_rel_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: הטענה שלנו היא לא רק שאין עדות להפצת נורמות מהאיחוד האירופי לישראל, אלא שבתוך האיחוד עצמו אין דיפוזיה מהעמדה הפוליטית הנורמטיבית לאינטרסים הכלכליים של האיחוד האירופי. המקרה הישראלי מצביע על כך שהפעילים הפרו-דמוקרטיים של תוניסיה, מצרים וסוריה צריכים להיות מודעים לכך שהאינטרסים המסחריים של המדינות החברות באיחוד האירופי ינצחו בסופו של דבר את ההצהרות הפוליטיות של האיחוד האירופי.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בחוסן דמוקרטי וכללי משחק פוליטיים, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Democracy and Security בשנת 2013. הזווית הדמוקרטית היא שהסדרים מוסדיים אינם רק רקע טכני, אלא תנאי לאמון, לשוויון בפני הכללים וליכולת להגביל כוח ציבורי."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "מה יכולים פעילי דמוקרטיה במדינות ערב לצפות מהאיחוד האירופי?",
