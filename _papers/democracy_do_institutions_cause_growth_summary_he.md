---
{
  ...
  "image": {
    "src": "assets/article-images/191_economy_democracy_do_institutions_cause_growth_summary_he.png",
    "version": "2026-07-05-final-generated-image-set",
    "altHe": "תמונה עריכתית: האם מוסדות גורמים לצמיחה?",
    "fitness": "high",
  ...
  "oneLinerHtml": "המאמר בוחן אם מוסדות גורמים לצמיחה, וטוען שהעדויות מצביעות יותר על קדימות ההון האנושי: חברות משכילות ועשירות יותר נוטות גם לצמוח וגם לשפר את מוסדותיהן.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר טוען שהאסטרטגיה המחקרית ששימשה בספרות כדי להראות שמוסדות גורמים לצמיחה אינה מבססת קשר סיבתי. הבעיה נובעת הן ממדידה רעיונית לא מדויקת של מוסדות והן ממגבלות של טכניקות אקונומטריות, ולכן המחקר הקיים אינו מראה שמוסדות פוליטיים, ולא הון אנושי, הם הגורם הסיבתי המרכזי לצמיחה.",
        "הניתוח מצביע על קשר חזק בין הון אנושי לבין מוסדות פוליטיים. בחלוקה לפי שנות לימוד ב-1960, מדינות בעלות הון אנושי גבוה הופיעו בעיקר כדמוקרטיות יציבות או דמוקרטיות חלקיות, ואילו מדינות בעלות הון אנושי נמוך רוכזו יותר במשטרים אוטוקרטיים או אוטוקרטיים חלקיים.",
        "בבדיקות של שינויים לאורך זמן, שנות לימוד ניבאו שיפור במדדים של מוסדות פוליטיים, בעוד שהמדדים המוסדיים לא הסבירו באותה מידה את העלייה בהשכלה. המאמר מסיק שמוסדות משתפרים כאשר ההזדמנויות המוסדיות של חברה משתפרות עם הצטברות הון אנושי וחברתי, ושלהיסטוריה ולפוליטיקה יש תפקיד בהתמדה של מוסדות קיימים."
      ]
    },
    {
