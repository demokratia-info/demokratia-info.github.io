---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אנו מוצאים שרוב האינדיקטורים של איכות מוסדית ששימשו לבסס את הטענה שמוסדות גורמים לצמיחה בנויים כבלתי מתאימים מבחינה רעיונית למטרה זו. אנו מוצאים גם שחלק מהטכניקות המשתנות האינסטרומנטליות המשמשות בספרות לקויות. תוצאות OLS בסיסיות, כמו גם מגוון של עדויות נוספות, מצביעות על כך ש(א) ההון האנושי הוא מקור צמיחה בסיסי יותר מאשר המוסדות, (ב) מדינות עניות יוצאות מעוני באמצעות מדיניות טובה, שלעתים קרובות נוקטת על ידי דיקטטורים, ו-(ג) לאחר מכן משפרות את המוסדות הפוליטיים שלהן.",
