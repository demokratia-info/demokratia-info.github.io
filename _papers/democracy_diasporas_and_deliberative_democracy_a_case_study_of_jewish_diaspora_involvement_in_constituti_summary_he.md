---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: גבולות האזרחות מתערערים יותר ויותר. המגמה בקרב החוקרים היא לנסות להרחיב את אחריותה וחובותיה של המדינה כך שיכללו לא-אזרחים בפוליטיקה הרלוונטית. אני בוחן את תפקידם של בתי המשפט לחוקה בדמוקרטיה דיונית וטוענת שהם עשויים להיות ממוקמים טוב יותר לנהל דיונים בחברות מפוצלות שבהן מתחים אתניים ודתיים מונעים מגופים דמוקרטיים אחרים לדון ביעילות.",
