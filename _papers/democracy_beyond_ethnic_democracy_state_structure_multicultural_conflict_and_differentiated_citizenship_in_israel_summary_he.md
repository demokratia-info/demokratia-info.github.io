---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: ביקורת שיטתית על מודל זה מדגימה את הניסיונות שעשו סוציולוגים פוליטיים ישראלים להפוך את האופי האתני של הדמוקרטיה הישראלית לאידיאל-טיפוס עומד בתקופה שבה דינמיות משטר ודמוקרטיזציה נחשבות לאידיאל בפוליטיקה העולמית. מאמר זה מסתיים בהצעה לחפש הכרה ממלכתית ביתרונות הפוליטיים של אזרחות מובחנת וזכויות קבוצתיות כדי לצמצם את הסכסוך האתנו-תרבותי הגואה בחברה הישראלית.",
