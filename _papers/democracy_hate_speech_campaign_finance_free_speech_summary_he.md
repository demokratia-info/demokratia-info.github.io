---
{
  ...
  "oneLinerHtml": "שורה תחתונה: המאמר מזהיר שמדיניות שנועדה להגן מפני פגיעה יכולה, בתנאים מסוימים, להחליש את התרבות החוקתית שמגינה על חופש הביטוי. מבחינה דמוקרטית, המאמר מזכיר שהגנה על קבוצות פגיעות ועל טוהר הבחירות חייבת להיות מאוזנת בזהירות מול חופש ביקורת, מחאה ותחרות פוליטית.",
  "sections": [
    {
