---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה מנתח את האינטראקציה בין חלוקת ההון האנושי, קידמה טכנולוגית וצמיחה כלכלית. הוא טוען שהרכב ההון האנושי הוא גורם חשוב בקביעת דפוס הפיתוח הכלכלי. המחקר מדגים כי הדפוס האבולוציוני של חלוקת ההון האנושי, חלוקת ההכנסה והצמיחה הכלכלית נקבעים בו-זמנית על ידי משחק הגומלין בין סביבה טכנולוגית מקומית עולמית חיצונית. בשלבי התפתחות מוקדמים, סביבת הבית המקומית החיצוניות היא הגורם השולט ומכאן שחלוקת ההכנסה הופכת מקוטבת; בעוד שבשלבים בוגרים של התפתחות החיצוניות הטכנולוגית העולמית שולטת וחלוקת ההכנסה בסופו של דבר מתכווצת. קיטוב, בשלבים מוקדמים של פיתוח עשוי להיות מרכיב הכרחי לצמיחה כלכלית עתידית.",
