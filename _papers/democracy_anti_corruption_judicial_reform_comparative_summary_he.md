---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "ישנן דרכים רבות לבחון את המשבר החוקתי הישראלי הנוכחי. מאמר זה משתמש בעדשת האנטי-שחיתות, תנועה עולמית ששינתה פוליטיקה במדינות רבות. ההעצמה הארוכה של מערכת המשפט בישראל מקורה, ככל הנראה, בשחיתות משטרתית, אשר עשויה להוות מניע חזק במיוחד למאמצי הקואליציה הממשלתית הנוכחית לתפוס יותר שליטה בבית המשפט העליון.",
        "המאמר מנתח את הרפורמה המשפטית הישראלית דרך פרספקטיבה השוואתית של מאבק בשחיתות, אחריות שלטונית ותגובת נגד פוליטית."
      ]
    },
    {
