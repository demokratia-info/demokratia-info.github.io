---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר קונפליקטים בין-מדינתיים המעורבים בדת נהוג לטעון כי הם חמורים וממושכים יותר מצורות אחרות של סכסוך. מאמר זה עושה זאת על ידי בחינת האם מדינות בלעדיות מבחינה דתית נוטות לבצע מיליטריזציה של סכסוכים טריטוריאליים בין מדינות (MIDs) על נושאים של חומר אסטרטגי או בולטות זהות. תוצאות אלו מאתגרות את החוכמה המקובלת לגבי השפעת הדת על הסכסוך הבינלאומי ומציעות דרכים חדשות קריטיות למחקר.",
