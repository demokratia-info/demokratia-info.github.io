---
{
  ...
  "summaryHe": "איך שילוב של שיטת מפלגות, חוקה לא משוריינת ובית משפט חזק יצר משבר רובני בתוך דמוקרטיית הסכמה. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד כללים משפטיים, ביקורת שיפוטית ועיצוב מוסדי משפיעים בפועל על היכולת להגביל כוח שלטוני, לשמור על אחריות ציבורית ולהבטיח שכללי המשחק הדמוקרטיים לא יישחקו בהדרגה.",
  ...
  "oneLinerHtml": "שורה תחתונה: יוחנן ד' מוסל ומתיו שוגרט מסבירים שהמשבר סביב הרפורמה המשפטית חשף סתירה עמוקה במבנה החוקתי של ישראל. מצד אחד, שיטת הבחירות היחסית והפוליטיקה הקואליציונית אמורות לעודד הסכמה; מצד אחר, חוקה לא משוריינת וקיטוב גושי מאפשרים לרוב קואליציוני צר לנסות לשנות במהירות את כללי המשחק. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד כללים משפטיים, ביקורת שיפוטית ועיצוב מוסדי משפיעים בפועל על היכולת להגביל כוח שלטוני, לשמור על אחריות ציבורית ולהבטיח שכללי המשחק הדמוקרטיים לא יישחקו בהדרגה.",
  "sections": [
    {
