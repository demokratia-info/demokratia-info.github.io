---
{
  ...
  "oneLinerHtml": "יוחנן ד' מוסל ומתיו שוגרט מסבירים שהמשבר סביב הרפורמה המשפטית חשף סתירה עמוקה במבנה החוקתי של ישראל. מצד אחד, שיטת הבחירות היחסית והפוליטיקה הקואליציונית אמורות לעודד הסכמה; מצד אחר, חוקה לא משוריינת וקיטוב גושי מאפשרים לרוב קואליציוני צר לנסות לשנות במהירות את כללי המשחק.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אנו מראים כיצד התערבות שיפוטית ערערה את המנגנונים של מוסדות הקונצנזוס של ישראל. למרות המשבר, אנו מציעים כי הדמוקרטיה הישראלית עמידה וכי מנגנוני קידום הקונצנזוס שלה צפויים לצוץ מחדש.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: איך שילוב של שיטת מפלגות, חוקה לא משוריינת ובית משפט חזק יצר משבר רובני בתוך דמוקרטיית הסכמה."
      ]
    },
    {
