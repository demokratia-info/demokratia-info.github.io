---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מחקרים קודמים הראו ירידה מתמדת באמון הפוליטי של האזרחים וספקנות גוברת כלפי מוסדות מפתח של דמוקרטיה ייצוגית. מאמר זה בוחן האם תהליכי בחירת מועמדים דמוקרטיים אכן משפיעים על אמון המפלגה בקרב הבוחרים. הניתוח מתבסס על מקרים של בלגיה וישראל, שבהן פוליטיקאים טענו חזק לדמוקרטיה פנים-מפלגתית בהיסטוריה הקרובה.",
