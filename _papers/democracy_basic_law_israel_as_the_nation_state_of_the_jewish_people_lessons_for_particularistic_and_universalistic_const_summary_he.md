---
{
  ...
  "image": {
    "src": "html_qa/democracy_basic_law_israel_as_the_nation_state_of_the_jewish_people_lessons_for_particularistic_and_universalistic_const_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בבתי המשפט, חוקתיות ושלטון החוק, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Studia Iuridica בשנת 2020.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית.",
