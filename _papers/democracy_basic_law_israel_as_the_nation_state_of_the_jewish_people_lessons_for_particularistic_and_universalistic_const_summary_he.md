---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: ליתר דיוק אני טוען שיש שתי דרכים להשיג לגיטימציה חוקתית: ייצוגי ומבוסס סיבות. אני מסכם בטענה כי בהינתן אי השגת תמיכה בהסכמה בחוק היסוד, מדובר בניסיון לא לגיטימי לבסס ערכים פרטיקולריים בחברה מפולגת.",
