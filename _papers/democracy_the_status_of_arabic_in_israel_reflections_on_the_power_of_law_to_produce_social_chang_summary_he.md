---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: במובנים שונים הפוטנציאל הגלום במעמדה המשפטי של הערבית התרוקן מתוכן, וכתוצאה מכך, כמו גם מסיבות אחרות, מעמדה הפוליטי-חברתי של הערבית דומה מאוד למה שהיית מצפה למעמד של שפה של קבוצת מיעוט במדינה המזהה את עצמה כמצבה של קבוצת הרוב. אנו מציגים ניתוח של מעמדה המשפטי של הערבית בישראל ובמקביל אנו ממשיכים לנסות ולענות על השאלות הנוגעות לפער בין מעמדה המשפטי לסוציו-פוליטי של הערבית.",
