---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר מסתמך על ניתוח מעמיק של ספר הלימוד הרשמי המתוקן, תוך השוואה לספר הלימוד הרשמי הקודם שפורסם בשנת 2000. הניתוח מתמקד בשינויים הדיסקורסיבים שחלו לגבי הדרכים שבהן משיג ספר הלימוד המתוקן את האזרחות הישראלית."
      ]
    },
    {
