...
{
  "version": 1,
  "file": "democracy_self_exclusion_strategy_inclusion_shas_summary_he.html",
  "slug": "democracy_self_exclusion_strategy_inclusion_shas_summary_he",
  "permalink": "/democracy_self_exclusion_strategy_inclusion_shas_summary_he.html",
  "paper_url": "democracy_self_exclusion_strategy_inclusion_shas_summary_he.html",
  "titleHe": "ש״ס מדגימה כיצד הסתגרות קהילתית יכולה לשמש אסטרטגיית הכלה פוליטית",
  "subtitleHe": "",
  ...
  "journal": "Citizenship Studies, 12(3), 233-247",
  "dateText": "פורסם: יוני 2008",
  "doiUrl": "https://doi.org/10.1080/13621020802015396",
  "doiLabel": "https://doi.org/10.1080/13621020802015396",
  "authors": [
    {
      "@type": "Person",
      "name": "David Lehmann",
      "url": "https://www.davidlehmann.org/"
    },
    {
      "@type": "Person",
      "name": "Batia Siebzehner",
      "url": "https://truman.huji.ac.il/people/batia-siebzehner"
    }
  ],
  "sourceAuthors": [
    {
  ...
  "sections": [
    {
      ...
      "paragraphsHtml": [
        "<strong>אזרחות</strong> היא לא רק מעמד משפטי אלא גם השתייכות, הכרה ויכולת להשפיע על החלטות ציבוריות. במאמר, ש״ס משמשת מקרה שבו אזרחות פוליטית מתחזקת דווקא דרך הדגשת זהות קהילתית נפרדת."
      ]
    },
    {
      "headingHe": "מה המאמר מצא או טוען בפועל?",
      "paragraphsHtml": [
        "בין הפרדוקסים הרבים של הפוליטיקה הישראלית, ישנן אסטרטגיות של הכללה פוליטית המשמשות ארגונים ומפלגות המייצגות קבוצות השוללות את האוניברסליזם שהדמוקרטיה הישראלית היא יורשת לו. מאמר זה מפתח מודל של 'הכלה פוליטית בסגנון ישראלי', המומחש על ידי מפלגה אחת, ש\"ס, שמאז 1984 מכריזה על הקול של האוכלוסייה הספרדית המודרת מבחינה חברתית ותרבותית של יהודי צפון אפריקה והמזרח התיכון, המייצגת למעלה מ-40% מהאוכלוסייה היהודית. ש\"ס היא גם תנועה של תחייה דתית ואתנית, שבאמצעות אימוץ אסטרטגיה חברתית של הדרה עצמית המבוססת על שמירה על מצוות דתית, ושל עצמאות מול פוליטיקה חרדית אשכנזית מבוססת, זכתה ל-11 מתוך 120 מושבים בכנסת, להכללה בממשלה ושליטה על נתח החינוך והרווחה.",
    ...
    {
      "headingHe": "מה פירוש הביטוי הסתגרות כאסטרטגיית הכלה?",
      "paragraphsHtml": [
    ...
    {
      "headingHe": "למה ש״ס היא מקרה חשוב לדיון בדמוקרטיה?",
      "paragraphsHtml": [
    ...
    {
      "headingHe": "איך המאמר מאתגר תפיסת הכלה רגילה?",
      "paragraphsHtml": [
    ...
    {
      "headingHe": "מה הקשר בין נבדלות לבין כוח פוליטי?",
      "paragraphsHtml": [
    ...
    {
      "headingHe": "האם המאמר רואה בהסתגרות פתרון פשוט?",
      "paragraphsHtml": [
    ...
    {
      "headingHe": "כיצד המקרה קשור לשירותים ציבוריים?",
      "paragraphsHtml": [
    ...
    {
      "headingHe": "מה אפשר ללמוד על פוליטיקה של זהות?",
      "paragraphsHtml": [
    ...
    {
      "headingHe": "מהי המסקנה לדמוקרטיה רב־קבוצתית?",
      "paragraphsHtml": [
  ...
  "layout": "paper",
  "title": "ש״ס מדגימה כיצד הסתגרות קהילתית יכולה לשמש אסטרטגיית הכלה פוליטית",
  "sortKey": 202606040007
}
---
