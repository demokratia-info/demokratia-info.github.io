---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מחקרים על קונפליקטים הכרוכים בשימוש בפונדקאות מתמקדים בעיקר במדינות, ורואים את היחסים בין נותני חסות ובעלי כוח בעיקר ככזה שבו מדינות משתמשות בשחקנים שאינם ממלכתיים בתור פרוקסי. הם הקדישו הרבה פחות תשומת לב להסדרי פרוקסי של ספונסרים שבהם שחקנים לא ממלכתיים ממלאים תפקידים מעולים כספונסרים בפני עצמם. ניתוח של שלושה תיאורי מקרה של נותני חסות לא-מדינתיים הנבדלים זה מזה מבחינת אידיאולוגיה ויכולת – אל-קאעידה בחצי האי ערב, יחידות ההגנה על העם בסוריה וחיזבאללה בלבנון – מאשש את הטיעון הזה, אך גם מצביע על כך שהיכולת והרצון לשלוט בשליחים משתנים בהתאם ליכולתו של נותן החסות.",
