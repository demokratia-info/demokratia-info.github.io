---
{
  ...
  "descriptionHe": "הפרק בוחן את הקיטוב הפוליטי בישראל לאורך שלושה עשורים, על רקע הבחירות לכנסת ה-25 והתחושה הציבורית שהפוליטיקה נעשתה מקוטבת במיוחד.",
  "summaryHe": "הפרק מציב את בחירות 2022 בתוך רצף רחב של קיטוב פוליטי בישראל, ומשווה בין קיטוב אידיאולוגי, זהות קבוצתית וקיטוב רגשי.",
  ...
  "oneLinerHtml": "הפרק משתמש במבט היסטורי כדי להראות שקיטוב פוליטי בישראל אינו רק תופעה של מערכת בחירות אחת, אלא תהליך הקשור לזהויות אידיאולוגיות וליחס רגשי בין מחנות.",
  "sections": [
    {
