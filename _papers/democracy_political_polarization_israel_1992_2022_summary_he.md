---
{
  ...
  "image": {
    "src": "assets/article-images/real_photo_563_protest_democracy_political_polarization_israel_1992_2022_summary_he.jpg",
    "version": "2026-07-05-real-photo-handoff",
    "altHe": "תצלום על ציר זמן פוליטי וקיטוב בישראל לאורך שלושה עשורים",
    "fitness": "high",
    "license": "CC BY-SA 4.0",
    "creator": "Chenspec",
    "provider": "Wikimedia Commons",
    "sourcePage": "https://commons.wikimedia.org/wiki/File:Graffiti_at_a_rally_supporting_hostage_deal,_7_September_2024_04.jpg",
    "originalUrl": "https://upload.wikimedia.org/wikipedia/commons/4/4c/Graffiti_at_a_rally_supporting_hostage_deal%2C_7_September_2024_04.jpg",
    "fileTitle": "Graffiti at a rally supporting hostage deal, 7 September 2024 04.jpg",
  ...
  "oneLinerHtml": "הפרק מספק מבט היסטורי על קיטוב בישראל ומזכיר שמשבר פוליטי עכשווי נשען על תהליכים ארוכי טווח. מבחינה דמוקרטית, ההיסטוריה של הקיטוב עוזרת להבין מדוע פשרות מוסדיות נעשות קשות יותר ככל שהיריב הפוליטי נתפס כאיום על זהות ושלטון.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "אבל האם יש עדויות ברורות לקיטוב מוגבר שכזה בקרב ישראלים רגילים? בפרק זה המאמר מציג עדויות מ-30 שנות סקרי דעת קהל בישראל ובוחן מגמות בקיטוב אידיאולוגי וכן בקיטוב רגשי (כלומר, יחס שלילי מעבר לקווי המפלגה). המאמר מגלה שבסך הכל, הציבור הישראלי אינו מקוטב אידיאולוגית כיום יותר מאשר בשנות ה-90.",
