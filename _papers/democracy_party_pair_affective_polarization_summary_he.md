---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "ניתוח נתוני סקר מעשרים דמוקרטיות מערביות מאז אמצע שנות ה-90, ראשית, המאמר מראה שסלידתם של תומכי מפלגות ממפלגות אחרות קשורה לחילוקי דעות מדיניות עילית בנושאים כלכליים, ויותר ויותר עם הזמן, גם לנושאים תרבותיים. שנית, המאמר טוען ומדגים באופן אמפירי כי שותפי שלטון קואליציוניים בדמוקרטיות פרלמנטריות מגלים רגשות חמים הרבה יותר זה כלפי זה ממה שהיה צפוי על סמך (אי) הסכמות של מדיניות עילית. שלישית, המאמר מראה שמפלגות ימין רדיקלי סולדות בהרבה יותר ממה שהיה צפוי בהתבסס על מחלוקות מדיניות והסדרים קואליציוניים.",
        "המאמר מראה שקיטוב רגשי אינו רק עוצמת השנאה הכללית כלפי ״הצד השני״, אלא רשת של יחסים בין מפלגות ספציפיות."
      ]
    },
    {
