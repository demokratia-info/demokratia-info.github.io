---
{
  ...
  "oneLinerHtml": "שורה תחתונה: המאמר מראה שקיטוב רגשי אינו רק עוצמת השנאה הכללית כלפי ״הצד השני״, אלא רשת של יחסים בין מפלגות ספציפיות. לישראל, שבה קואליציות משתנות ומפלגות רבות מתחרות, גישה כזאת יכולה להסביר מדוע שנאה פוליטית אינה מתחלקת תמיד לפי גוש אחד ברור. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד עמדות הציבור, רגשות פוליטיים וקיטוב משפיעים על נכונות לקבל כללי משחק משותפים, לכבד יריבים פוליטיים ולהגן על מוסדות גם כאשר הם פועלים נגד העדפה מחנאית רגעית.",
  "sections": [
    {
