---
{
  ...
  "oneLinerHtml": "שורה תחתונה: המאמר מראה שקיטוב רגשי אינו רק עוצמת השנאה הכללית כלפי ״הצד השני״, אלא רשת של יחסים בין מפלגות ספציפיות. לישראל, שבה קואליציות משתנות ומפלגות רבות מתחרות, גישה כזאת יכולה להסביר מדוע שנאה פוליטית אינה מתחלקת תמיד לפי גוש אחד ברור.",
  "sections": [
    {
