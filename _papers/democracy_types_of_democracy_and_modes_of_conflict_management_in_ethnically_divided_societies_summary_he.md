---
{
  ...
  "titleHe": "סוגי דמוקרטיה וניהול סכסוכים בחברות מפוצלות",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_types_of_democracy_and_modes_of_conflict_management_in_ethnically_divided_societies_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: שניהם מבוססים על זכויות הפרט בלבד. במערב ישנם גם כמה מקרים של דמוקרטיה קונסוציאציונלית שבהן מוכרות קהילות לאומיות נפרדות וזכויותיהן הקולקטיביות. הוא משמש מסגרת רחבה לניתוח של חמש מדינות בגיליון מיוחד זה: צפון אירלנד, אסטוניה, ישראל, פולין וטורקיה.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בלאומיות, אזרחות ושוויון דמוקרטי, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Nations and Nationalism בשנת 2002.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "סוגי דמוקרטיה וניהול סכסוכים בחברות מפוצלות",
