---
{
  ...
  "titleHe": "משטרי צדק דמוקרטיים בארגוני עבודה",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_democratic_justice_regimes_in_work_organizations_the_case_of_israeli_taxi_cooperatives_summary_he.jpg",
    "version": "2026-05-23-extra-100-economics-refill",
    "altHe": "תמונה עריכתית: משטרי צדק דמוקרטיים בארגוני עבודה",
    "fitness": "standard"
  },
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה טוען שמוסדות דמוקרטיים ליישוב סכסוכים כגון הליך שיפוטי עצמאי הם הרחבה חשובה של הדמוקרטיה במקום העבודה. באמצעות סקר של כל תחנות המוניות בחיפה, ישראל, מחקר זה מנסה לתאר ולהסביר את קיומם של משטרי צדק דמוקרטיים בארגוני עבודה. המחקר מגלה כי כל תחנות המוניות בבעלות העובדים שנחקרו בוחרות הן במנהלים לנהל את התחנות והן בשופטים להפעלת בית משפט פנימי.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בחוסן דמוקרטי וכללי משחק פוליטיים, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Economic and Industrial Democracy בשנת 2001.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "משטרי צדק דמוקרטיים בארגוני עבודה",
