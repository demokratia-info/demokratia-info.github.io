---
{
  ...
  "oneLinerHtml": "המאמר מסביר מדוע פגיעה בעצמאות המשפטית אינה רק מחלוקת בין רשויות אלא איום על תנאי היסוד של דמוקרטיה חוקתית. המאמר ממקם את הרפורמה המשפטית בתוך שאלה רחבה יותר: האם מוסדות המשפט מסוגלים להמשיך לשמש בלם אפקטיבי מול כוח פוליטי מרוכז. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד כללים משפטיים, ביקורת שיפוטית ועיצוב מוסדי משפיעים בפועל על היכולת להגביל כוח שלטוני, לשמור על אחריות ציבורית ולהבטיח שכללי המשחק הדמוקרטיים לא יישחקו בהדרגה.",
  "sections": [
    {
