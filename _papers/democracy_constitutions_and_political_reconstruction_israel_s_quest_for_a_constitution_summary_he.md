---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: הצהרת הקמת המדינה של ישראל מה-14 במאי 1948 קבעה, כנדרש בהחלטה 181 של האו\"ם, כי ישראל היא דמוקרטיה חוקתית. האסיפה המכוננת נבחרה רק ב-1949, לאחר מלחמת 1948, והייתה לכנסת הראשונה, ובכך בלכה בין עשיית חוקה לבין סמכות חקיקה סדירה. מאמר זה טוען שההיסטוריה החוקתית של ישראל משקפת שתי חריגות: ב-1948 חל שינוי חברתי ופוליטי גדול, שיושם ללא חוקה; בשנות השמונים והתשעים התקיים תהליך חוקתי שנועד לעצור - במקום להקל ולשקף - שינויים חברתיים, פוליטיים ודמוגרפיים.",
