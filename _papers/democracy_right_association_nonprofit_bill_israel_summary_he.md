---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: הכלי המשפטי העיקרי המסדיר את זכות ההתאגדות למטרות מלכ\"ר בישראל הוא חוק העמותות, התשמ\"א-1980 (להלן: חוק המל\"ל ולפני קבלתו, הצעת חוק המלכ\"רים). הוא יוצר מסגרת חוקית לעמותות שחותרות למטרה משותפת חברתית או תרבותית בניגוד למטרה עסקית. מאמר זה מתאר את הפרק הראשון של תהליך החקיקה (1948–1954) שהוביל בסופו של דבר לחקיקת החוק מ-1980.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: Bar-Mor ו־Kabalo מראות שהדיון המקצועי והציבורי בהצעת החוק שיקף גישות דמוקרטיות שונות בראשית המדינה. זכות ההתאגדות נבחנת כאן לא כמושג מופשט, אלא כמוסד משפטי שמגדיר כמה חופש יש לחברה אזרחית מול המדינה."
      ]
    },
    {
