---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "אחר מציע שהאם הדמוקרטיה תשרה תלויה בחברה עצמה ובאגודות המרכיבות אותה. במבחן של דעות אלה הונח שאם החברה תשרה האסוציאציות ישתנו לפי סוג. הנתונים נגזרו מסקר שנערך בקרב עמותות התנדבותיות בישראל (n=360)."
      ]
    },
    {
