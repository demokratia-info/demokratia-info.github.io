---
{
  ...
  "summaryHe": "המאמר עוסק בהקשר בין אי־שוויון, חלוקה מחדש וצמיחה, וממקם את הדיון בתוך שאלות של מוסדות, שלטון החוק, אחריותיות ואמון ציבורי.",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה מפתח מודל צמיחה המאופיין במעבר טכנולוגי מוטה יכולות, שבו האבולוציה של הטכנולוגיה, השכלה ואי-שוויון בשכר תואמת את הדפוס שנצפה בארצות הברית ובמדינות מתקדמות אחרות בעשורים האחרונים. היא טוענת כי עלייה בקצב ההתקדמות הטכנולוגית מעלה את החזרה ליכולת ובמקביל מייצרת עלייה באי השוויון בשכר בין ובתוך קבוצות של עובדים מיומנים ובלתי מיומנים, עלייה בשכר הממוצע של עובדים מיומנים, ירידה זמנית בשכר הממוצע של עובדים בלתי מיומנים, עלייה בהשכלה והאטת מעבר בפריון.",
