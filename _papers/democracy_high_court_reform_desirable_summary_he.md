---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "כאשר ציפיות אלו מתאכזבות שוב ושוב, הלגיטימציה של בית המשפט נפגעת והוא נתפס כמוסד מפלגתי. מאמר זה דן בארבע בעיות מבניות בפעילותו של בג\"ץ, אשר תרמו באופן משמעותי למשבר הלגיטימציה הנוכחי של בית המשפט: בירור עובדות, הרכב הרכבות, עמידה ובחירה שופטת. המאמר בוחן את תכנית הרפורמה השלטונית ביחס לבעיות מבניות אלו ומציע פתרונות מעשיים לכל אחת מהבעיות.",
        "רפורמה דמוקרטית בבג״ץ צריכה לטפל בעובדות, בהרכבי שופטים, בזכות עמידה ובמינוי שופטים בלי למסור את בית המשפט לשליטה פוליטית."
      ]
    },
    {
