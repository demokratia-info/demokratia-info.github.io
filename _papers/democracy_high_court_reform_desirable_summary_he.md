---
{
  ...
  "oneLinerHtml": "שורה תחתונה: יהושע שגב טוען שהדיון בבג״ץ צריך להבחין בין ביקורת מוסדית לגיטימית לבין רפורמה שמרכזת כוח פוליטי. מאמרו מזהה ארבע בעיות מבניות בפעולת בית המשפט העליון בשבתו כבג״ץ, ומציע תיקונים שמטרתם לחזק עצמאות, שקיפות ולגיטימציה במקום להחליף איזונים מקצועיים בשליטה קואליציונית. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד כללים משפטיים, ביקורת שיפוטית ועיצוב מוסדי משפיעים בפועל על היכולת להגביל כוח שלטוני, לשמור על אחריות ציבורית ולהבטיח שכללי המשחק הדמוקרטיים לא יישחקו בהדרגה.",
  "sections": [
    {
