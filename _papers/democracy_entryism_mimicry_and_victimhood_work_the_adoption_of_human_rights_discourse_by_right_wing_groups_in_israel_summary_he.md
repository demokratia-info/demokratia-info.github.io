---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: בעוד שבאופן מסורתי זכויות אדם נתפסו בעיקר ככלי המשמש קבוצות מוחלשות או מוחלשות למטרות פרוגרסיביות, הן נפרסות יותר ויותר, ברחבי העולם, על ידי קבוצות שמרניות ולא-ליברליות בחברה האזרחית. באמצעות תיאור המקרה של האימוץ האחרון של שיח זכויות אדם על ידי כמה קבוצות ימין בישראל, ושימוש בספרות של תנועות חברתיות, מאמר זה מבקש לנתח כיצד ולאילו מטרות מאמצות זכויות אדם על ידי שחקנים כאלה. באמצעות טקטיקות אלו הצליחו שחקנים ממחנה הימין הישראלי להוסיף עיסוק בזכויות אדם ל\"רפרטואר המחלוקות\" שלו כדי לקדם מערך אינטרסים, מבלי לשנות, לפחות לעת עתה, את עיקריהם האידיאולוגיים.",
