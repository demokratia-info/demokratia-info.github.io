---
{
  ...
  "subtitleHe": "",
  "descriptionHe": "המאמר מתאר את הבחירות לכנסת במרץ 2020 כמקרה מבחן לניהול הליך דמוקרטי בזמן מגפה. הוא מתמקד בצעדי הבריאות, הלוגיסטיקה והתקשורת הציבורית שאפשרו הצבעה רחבה בלי לדחות את הבחירות. המוקד הוא הבחירות לכנסת במרץ 2020 כמבחן לוגיסטי ובריאותי לשימור השתתפות דמוקרטית בזמן קורונה, ולכן המאמר נקרא כתרומה ממוקדת להבנת היחסים בין מוסדות, קבוצות ותפיסות דמוקרטיות.",
  "summaryHe": "אפק, לשם, קלינר, פאסט, גרוטו וסדצקי בוחנים את חוויית הבחירות בישראל בתחילת מגפת הקורונה. המאמר מתאר כיצד ועדת הבחירות ומערכת הבריאות נערכו להצבעה בטוחה: קלפיות ייעודיות למבודדים, ציוד מגן לצוותים, כללי ריחוק, ניהול זרימת מצביעים והסברה לציבור. שיעור ההצבעה הגיע ל-71.5%, מעט יותר מבחירות ספטמבר 2019, ולכן המאמר מציג את המקרה הישראלי כדוגמה לכך שמוסדות יכולים לשמר השתתפות פוליטית גם תחת סיכון בריאותי חריג. דרך המוקד של הבחירות לכנסת במרץ 2020 כמבחן לוגיסטי ובריאותי לשימור השתתפות דמוקרטית בזמן קורונה, המאמר מעביר את הדיון מן העיקרון הכללי אל מנגנוני הפעולה: מי מנסח את הכללים, מי נהנה מהם, מי נדרש להצטדק, ואילו מוסדות מתווכים בין רעיון דמוקרטי לבין ניסיון חיים ממשי. החשיבות הדמוקרטית שלו היא במפת הדרכים שהוא נותן לקורא: זיהוי השחקנים, המתח המוסדי והמחיר של פתרונות חלקיים. כך נוצרת קריאה פרשנית זהירה הנשענת על הראיות הקיימות, ומדגישה גם את כוחו של הכלי הנבחן וגם את גבולותיו. המאמר מתאר את הבחירות לכנסת במרץ 2020 כמקרה מבחן לניהול הליך דמוקרטי בזמן מגפה. הוא מתמקד בצעדי הבריאות, הלוגיסטיקה והתקשורת הציבורית שאפשרו הצבעה רחבה בלי לדחות את הבחירות. המוקד הוא הבחירות לכנסת במרץ 2020 כמבחן לוגיסטי ובריאותי לשימור השתתפות דמוקרטית בזמן קורונה, ולכן המאמר נקרא כתרומה ממוקדת להבנת היחסים בין מוסדות, קבוצות ותפיסות דמוקרטיות.",
  ...
  "image": {
    "src": "assets/article-images/833_elections_democracy_upholding_democracy_in_a_global_pandemic_the_israeli_elections_experience_summar.png",
