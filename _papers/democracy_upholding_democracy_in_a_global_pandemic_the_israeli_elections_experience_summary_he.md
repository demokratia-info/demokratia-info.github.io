---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מגיפת COVID-19 השפיעה באופן מהותי על הבחירות הדמוקרטיות של מדינות. במרץ 2020 נערכו בישראל בחירות כלליות לפרלמנט. שיעור ההשתתפות עמד על 71.5%, בהשוואה לשיעור של 70% בבחירות הקודמות שהתקיימו בספטמבר 2019.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: המאמר מציג את חוויית הבחירות בישראל בזמן מגפה כמקרה של פעולה מוסדית תחת לחץ. הוא מדגיש שבחירות דמוקרטיות דורשות לא רק עצם הצבעה אלא גם אמון, כללים הוגנים והגנה על תנאי השתתפות."
      ]
    },
    {
