---
{
  ...
  "image": {
    "src": "html_qa/democracy_reconciliation_compromise_israelis_palestinians_summary_he.jpg",
    "version": "2026-06-04-nightly",
    "altHe": "חוקרי דעת קהל ישראלים ופלסטינים בוחנים שאלונים אנונימיים על פיוס ופשרה סביב שולחן משותף",
    "fitness": "high"
  },
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: המחקר מבוסס על סקרים של מדגמים מייצגים של האוכלוסייה הבוגרת בישראל (n=525) ושל האוכלוסייה הבוגרת הפלסטינית בגדה המערבית, ברצועת עזה ובמזרח ירושלים (n=1,259). נמצאו כי הציפיות מסבירות את רגשות הפיוס והפשרה מעבר למשתנים דמוגרפיים ופוליטיים עבור המדגם הישראלי והפלסטיני כאחד.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: המחקר נשען על מדגמים מייצגים של 525 ישראלים ו-1,259 פלסטינים בגדה המערבית, ברצועת עזה ובמזרח ירושלים. הממצא המרכזי הוא שציפיות לעתיד של שלום ודמוקרטיה מסבירות עמדות פיוס ופשרה מעבר למאפיינים דמוגרפיים ולעמדות פוליטיות."
      ]
    },
    {
