---
{
  ...
  "subtitleHe": "",
  "descriptionHe": "המאמר בוחן האם נסיגה דמוקרטית בישראל מגדילה הצדקה ציבורית לאלימות פוליטית נגד עובדי ציבור ונבחרי ציבור, והאם היא גם מגדילה נכונות אישית לפעול באלימות.",
  "summaryHe": "מחקר ישראלי על ההבדל בין הצדקת אלימות פוליטית לבין נכונות אישית לבצע אותה בזמן משבר דמוקרטי.",
  ...
  "image": {
    "src": "assets/article-images/real_photo_572_protest_democracy_political_violence_summary_he.jpg",
    "version": "2026-07-05-real-photo-handoff",
    "altHe": "תצלום הקשור לנסיגה דמוקרטית ואלימות פוליטית: מה קורה לתודעה הציבורית?",
    "fitness": "high",
    "license": "CC BY-SA 4.0",
    "creator": "Oren Rozen",
    "provider": "Wikimedia Commons",
    "sourcePage": "https://commons.wikimedia.org/wiki/File:Demonstrating_against_judicial_reform_250323_15.jpg",
    "originalUrl": "https://upload.wikimedia.org/wikipedia/commons/5/5b/Demonstrating_against_judicial_reform_250323_15.jpg",
    "fileTitle": "Demonstrating against judicial reform 250323 15.jpg",
  ...
  "oneLinerHtml": "המאמר מראה שנסיגה דמוקרטית הרחיבה את גבולות ההצדקה המוסרית לאלימות פוליטית, אך לא הגדילה באותה מידה נכונות אישית לבצע אלימות.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המחקר נשען על שני סקרים ארציים מייצגים בישראל, שנערכו בשתי נקודות זמן: תקופה של יציבות מוסדית יחסית ותקופה של משבר חוקתי חריף. בכל סקר השתתפו כ-1,200 נשאלים, ובחלק המתודולוגי מתוארות גם דגימות רחבות יותר של 2,008 ו-1,957 מבוגרים, שתורגמו ונוהלו בעברית ובערבית לפי קבוצת האוכלוסייה.",
