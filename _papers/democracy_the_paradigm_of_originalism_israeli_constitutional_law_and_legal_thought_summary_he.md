---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אמנם היא מאשרת שמקוריות יכולה להיות חוק מערכת המשפט, אבל תחילה היא מערערת על הרעיון המרכזי לפיו המקוריות האמריקאית היא המקרה הפרדיגמטי בתיאוריה ובפועל. שנית, החיבור מתמודד עם ההצדקה הנורמטיבית לפיה המקוריות מבטיחה דמוקרטיה המבוססת על שלטון החוק. מקרה המקרה המנותח במאמר זה הוא המחשבה והפרקטיקה המשפטית הישראלית לאחר חקיקת חוקי היסוד מ-1992, תוך התמקדות בזכות לשוויון.",
