  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        ...
        "רפורמת הכשרות של 2021 משמשת מקרה מבחן מפני שהיא צמצמה מעורבות ממשלתית בתחום מרכזי של מוסדות דת ומדינה, ונוסחה בשפה כלכלית. המאמר מסיק שמודל הסטטוס־קוו כבר אינו מתאר לבדו את המציאות, ושנדרש מודל היברידי שבו חלק מן ההסדרים נותרו סטטוס־קוו, חלקם מבוססי רגולציה וחלקם מופרטים יותר או לחלוטין."
      ]
    },
    {
