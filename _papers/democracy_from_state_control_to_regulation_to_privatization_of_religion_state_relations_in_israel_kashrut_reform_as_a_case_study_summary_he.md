---
{
  ...
  "subtitleHe": "",
  "descriptionHe": "תקציר בעברית של מאמר על רפורמת הכשרות ושינוי יחסי דת ומדינה בישראל, עם דגש על דמוקרטיה ליברלית, זכויות, מוסדות ושלטון החוק.",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "שינויים כאלה מדגימים דינמיקה של נסיגה ממלכתית, מהספק סטטיסטי ישיר של מוצרי דת, למדינה שנסוגה לחלוטין או ממקמת את עצמה מחדש כאורגן רגולטורי. תוך שימוש ברפורמת הכשרות כמקרה בוחן, המאמר מציע כי מודל הסטטוס-קוו אינו יכול עוד להגדיר כראוי את יחסי דת-מדינה בישראל, והוא מוחלף במודל היברידי, הכולל תכונות ליברטריאניות, מבוססות רגולציה ותכונות הסטטוס-קוו המצוינות. המאמר מסתיים בציון המשמעות של התפתחות זו על אופייה היהודי של ישראל.",
