---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: בהתחשב במציאות הפוליטית של ישראל, וכתוצאה מכך, אופן הפעולה והטיפול של מערכת המשפט הישראלית בילדים פלסטינים, אנו טוענים כי גורמי החברה האזרחית, במיוחד אלו העוסקים בילדים, אינם מסוגלים לערער על הפרות של זכויות ילדים פלסטינים. הניתוחים שלנו של סיקור תקשורתי, ראיונות מפתח ודיונים בקבוצות מיקוד ושולחן עגול חושפים שמערכות חברתיות-משפטיות פורמליות ובלתי פורמליות נכשלות במנדט שלהן להגן על זכויות הילדים, לערער על מערכת המשפט הנוער המוטה של ​​המדינה ולמנוע מהמדינה הגזעית להפר את החוקים המקומיים ואת הסטנדרטים האתיים והבינלאומיים.",
