---
{
  ...
  "descriptionHe": "המאמר בוחן האם מיעוטים מוחלשים משתתפים פחות כאשר יש להם ייצוג תיאורי אך אין להם ייצוג מהותי שמביא לשיפור ממשי בגישה לטובין ציבוריים. דרך המקרה הישראלי הוא משווה בין ערבים־מוסלמים, הרוב היהודי והמיעוט הדרוזי ומראה הבדל בין בחירות מקומיות לבחירות ארציות.",
  "summaryHe": "המאמר מציע הבחנה דמוקרטית חשובה בין עצם נוכחותם של נציגים מקבוצת מיעוט לבין יכולתם לקדם בפועל שירותים, משאבים וטובין ציבוריים עבור אותה קבוצה. לפי התקציר, כאשר הייצוג נשאר תיאורי בלבד, חישוב ההשתתפות של בוחרים עשוי להשתנות והם עשויים להרגיש שהצבעה אינה מתורגמת להשפעה. המקרה הישראלי מדגים זאת דרך ירידה בהשתתפות ערבים־מוסלמים בבחירות ארציות ועלייה בהשתתפות בבחירות מקומיות. התרומה של המאמר היא בהפיכת שיעור ההצבעה מסימן פשוט של אדישות או נאמנות לשאלה מוסדית: האם המוסד מעניק למיעוט דרך ממשית להשפיע על חייו.",
  ...
  "oneLinerHtml": "השתתפות מיעוטים תלויה לא רק בזהות הנציגים, אלא בשאלה אם הייצוג מתורגם להשפעה ממשית על טובין ציבוריים.",
  "sections": [
    {
