  ...
  "sections": [
    {
      ...
      "paragraphsHtml": [
        "המאמר ״חוק הלאום והשפה הערבית בישראל: הנמכה, שכפול או שדרוג?״ מוצג כאן דרך השאלה הדמוקרטית המרכזית שעולה ממנו.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: השאלה היא האם, כיצד ובאיזו מידה הוראות אלה מעכבות את מעמדה המשפטי הנוכחי של השפה הערבית בישראל. בית המשפט העליון בישראל תמיד היה חצוי בעניין זה, במיוחד בין שופטים שתפסו את הערבית כשפה רשמית לבין שופטים שראו בה אך ורק את ה\"מעמד המשפטי המיוחד\" המוכר שלה. בהתחשב בנסיבות אלו, דעתי היא כי המל\"ל מנציח את מעמדה המשפטי של הערבית כפי שנקבע בחוקים ובפסיקה שכבר היו קיימים, וכי סעיף תוקף החוקים, יחד עם המעמד המיוחד שניתן לערבית בחוק יסוד, מצביעים על כך שעדיין פתוחה הדלת בפני בית המשפט לאמץ עוד יותר את מעמדה המשפטי של הערבית בישראל.",
