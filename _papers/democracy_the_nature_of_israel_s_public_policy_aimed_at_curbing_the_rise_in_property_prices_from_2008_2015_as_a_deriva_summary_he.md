---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: ניתוח המדיניות מראה שכדי להבין את ההצדקות לניסוחה יש לראות אותה דרך תפיסת העולם הפוזיטיביסטית המתמקדת בשיקולים סובייקטיביים של מעצבי מדיניות המנטרלים את יעילותה האובייקטיבית-נורמטיבית. המאמר מדגיש את ההשפעה של מבנה הממשל במדינה בכל נקודת זמן על סוג המדיניות שנבחרה וקובע כי מבנה שלטון דמוקרטי אך חלש ובלתי יציב מוביל לגיבוש ויישום של מדיניות פוזיטיביסטית המשקפת את האינטרסים הצרים של פוליטיקאים לבחירה מחדש.",
