---
{
  ...
  "titleHe": "בית המשפט העליון והריסת בתים בשטחים",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_being_unfaithful_to_one_s_own_principles_the_israeli_supreme_court_and_house_demolitions_in_the_occupied_pales_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: חלק מהכתבים הביקורתיים מתמקדים בפרקטיקה של צבא ההגנה לישראל; אחרים מתרכזים בכישלונו של הפרלמנט הישראלי בבלימת הנוהג, בעוד שאחרים בוחנים את הנוהג בהקשרו הרחב יותר, כלומר הסכסוך הישראלי-פלסטיני. נושא זה כבר נבדק על ידי חוקרים רבים ובהם, בפרט, קרצמר וסימון, שמצאו כי פסיקת בית המשפט מנוגדת למשפט הבינלאומי הציבורי והנימוקיה אינם משכנעים. הוא מסתיים בקריאה כי כאשר נושא הריסת הבתים מובא בפני בית המשפט, עליו ליישם את אותה גישה, רוח, טכניקות ואמות מידה שנקטו בתחומי משפט מקבילים.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בבתי המשפט, חוקתיות ושלטון החוק, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Israel Law Review בשנת 2014.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "בית המשפט העליון והריסת בתים בשטחים",
