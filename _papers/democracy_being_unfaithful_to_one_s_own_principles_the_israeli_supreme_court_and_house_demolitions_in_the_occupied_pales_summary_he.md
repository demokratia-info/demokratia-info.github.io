---
{
  ...
  "oneLinerHtml": "שורה תחתונה: המאמר עוסק בבתי המשפט, חוקתיות ושלטון החוק, ומראה מדוע הדיון במוסדות אינו טכני בלבד. הוא רלוונטי להבנת דמוקרטיה משום שכללים, אכיפה ואמון ציבורי משפיעים על זכויות, צמיחה, אחריותיות והגבלת כוח.",
  "sections": [
    {
