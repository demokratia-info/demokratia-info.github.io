---
{
  ...
  "descriptionHe": "המאמר בוחן כיצד ניתן לעגן את חזון המדינה במסגרת חוקתית בלי לוותר על מורכבות היחסים בין זהות לאומית, שוויון וזכויות.",
  "summaryHe": "המאמר בוחן כיצד ניתן לעגן את חזון המדינה במסגרת חוקתית בלי לוותר על מורכבות היחסים בין זהות לאומית, שוויון וזכויות.",
  ...
  "oneLinerHtml": "שורה תחתונה: המאמר בוחן כיצד ניתן לעגן את חזון המדינה במסגרת חוקתית בלי לוותר על מורכבות היחסים בין זהות לאומית, שוויון וזכויות. המאמר חשוב משום שהוא מחפש שפה חוקתית שמאפשרת זהות קולקטיבית בלי למחוק את דרישת השוויון והחירות של כל האזרחים.",
  "sections": [
    {
