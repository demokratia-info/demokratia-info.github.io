---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: בעקבות טיעון החברה האזרחית של מיכאל וולצר, מאמר זה בוחן את מערכת היחסים העיקרית שהתפתחה בין ממשלת ישראל לעמותות אזרחיות במהלך שנות העצמאות הראשונות של ישראל. המחקר מציע גישה שונה להשפעות הדמוקרטיות של עמותות ומראה כי יוזמה להקמת עמותות חדשות, ודיון פתוח במסגרת החוקית שלהן, צריכים להיחשב כחלק מתהליך הדמוקרטיזציה במדינה חדשה.",
