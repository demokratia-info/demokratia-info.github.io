---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מחקרים קודמים מוצאים עדויות מוגבלות לקשר חיובי בין דמוקרטיה פנים-מפלגתית לבין נטייתם של אזרחים להצביע למפלגות דמוקרטיות או להיות מעורבים יותר בפעילויות מפלגתיות. שנית, אנו בוחנים כיצד תהליכי בחירת מועמדים מכילים מקושרים לשלוש צורות של מעורבות: צפייה במודעות של קמפיינים, קריאת עיתונים ודיון בפוליטיקה עם חברים ובני משפחה. הניתוח מבוסס על נתוני סקר דעת קהל במהלך שבעה מחזורי בחירות מסקר הבחירות הלאומי בישראל ונתוני בחירת מועמדים על מפלגות ישראליות.",
