---
{
  ...
  "image": {
    "src": "assets/article-images/real_photo_620_protest_democracy_regime_classification_backsliding_summary_he.jpg",
    "version": "2026-07-05-real-photo-handoff",
    "altHe": "תצלום על סיווג משטר ונסיגה דמוקרטית",
    "fitness": "high",
    "license": "CC BY-SA 3.0",
    "creator": "Gil Levin (גיל לוין)",
    "provider": "Wikimedia Commons",
    "sourcePage": "https://commons.wikimedia.org/wiki/File:Kaplan-116-Gil_Levin.jpg",
    "originalUrl": "https://upload.wikimedia.org/wikipedia/commons/b/bb/Kaplan-116-Gil_Levin.jpg",
    "fileTitle": "Kaplan-116-Gil Levin.jpg",
  ...
  "oneLinerHtml": "המאמר מסביר כיצד הוויכוח על הרפורמה המשפטית קשור לשאלה רחבה יותר: איזה סוג של דמוקרטיה ישראל היא, ומה גבולות המשטר שאותו מסווגים.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "תוך שימוש במחלוקת 2023 על השיפוץ השיפוטי של ישראל כמקרה, מאמר זה מנתח את הוויכוח הרחב יותר, בן עשרות שנים, על אופיו של המשטר הישראלי. הוא מדגים כיצד הנחות סותרות לגבי דמוקרטיה והמשטר הישראלי עומדות בבסיס פרשנויות שונות לשינוי השיפוטי המוצע.",
