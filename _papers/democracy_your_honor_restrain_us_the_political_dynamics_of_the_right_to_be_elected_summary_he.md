---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: הזכות להיבחר היא זכות דמוקרטית בסיסית ואחד מאמצעי ההגנה החשובים ביותר של הדמוקרטיה. הגבלות על זכות זו פוגעות הן בדמוקרטיה הפורמלית והן בדמוקרטיה המהותית, ופוגעות במועמדים המוגבלים וכן בבוחרים שנשללה מהם הזכות להצביע עבורם. בישראל, המוסד הפוליטי של הכנסת מטבעו מחזק את התמיכה בהיבט הפרוצדורלי של הדמוקרטיה בקרב הפוליטיקאים.",
