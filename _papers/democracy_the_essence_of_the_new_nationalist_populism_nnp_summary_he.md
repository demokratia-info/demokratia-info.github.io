---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מחקר זה בוחן את הרטוריקה שנקטה הנהגת המחנה הלאומי (NC) בראשות הליכוד בישראל - הידועה בעמדות הפופוליסטיות שלה - תוך התמקדות בחודשים הראשונים של מלחמת חרבות הברזל/עזה (2023–2024; המלחמה). באמצעות ניתוח איכותני ותמטי של שיח מנהיגים, אנו מראים שבניגוד לסולידריות הדמוקרטית המסורתית של ישראל בתקופת המלחמה, התומכת בדרך כלל בהחלטות מוסכמות למשברים קיומיים, במהלך המלחמה, מנהיגי ה-NC נוקטים באופן שיטתי ברטוריקה פופוליסטית מפצלת קיצונית, כולל דברי שטנה. ממצאים אלה מצביעים על כך שרטוריקה של NNP ו-NMNP היא לא רק טקטיקה פוליטית אלא אסטרטגיה מקיפה או אפילו מסגרת אידיאולוגית מרכזית, המחזקת את התיאוריות לגבי השפעתה הגוברת.",
