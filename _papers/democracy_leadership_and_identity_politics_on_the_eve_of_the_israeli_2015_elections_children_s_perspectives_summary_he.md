---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה עוסק בפוליטיקת זהויות בחברה הישראלית ערב בחירות 2015 כפי שסופר בראיונות עם ילדי ישראל. מחקר זה מראה כי יחסי הכוח בין ארבע הקבוצות בחברה הישראלית קיימים ומופנמים כבר בבית הספר היסודי, ממצא בעל השלכות חשובות כאשר ישראל פועלת למען מטרתה הסופית של דמוקרטיה.",
