---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: כתוצאה מכך, דוקטרינת חירות הדת לא הצליחה לעמוד באתגרים שישראל מתמודדת איתם כעת: ההקצנה הדתית והלאומית הגוברת והסיכון הנובע מפיצול ודיכוי מיעוטים. אני טוען שלצורת הביזור המסוימת של חופש הדת בישראל יש תוצאה מעורבת: היא סייעה להחליש את המונופול של היהדות האורתודוקסית במקומות מסוימים ואפשרה לקהילות מגוונות לפרוח ולבטא את החזון הדתי הייחודי שלהן; אבל היא גם הקצינה כמה מנהגים דתיים, החריפה את המתחים בין דתות ועדות מתחרות, הגבירה את ההפרדה הדתית במגורים וסיכנה מיעוטים.",
