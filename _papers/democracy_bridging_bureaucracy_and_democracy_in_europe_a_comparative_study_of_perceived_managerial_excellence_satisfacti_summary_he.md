---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מטרת מחקר זה היא לבחון כמה היבטים של בירוקרטיה ודמוקרטיה כפי שהם נתפסים על ידי אזרחים בעלי ידע בשש מדינות (אירלנד, ישראל, ליטא, נורבגיה, סלובקיה וספרד). ממצאי המחקר מצביעים על כך שהיבטים שונים של בירוקרטיה ודמוקרטיה שונים בין מדינות ושאורך חיים דמוקרטי עשוי להיות הסבר טוב להבדלים הללו.",
