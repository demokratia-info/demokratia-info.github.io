---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מדוע סכסוכים בין מדינות ותנועות לאומיות ממשיכים להיות \"לאומיים\", עוסקים כמעט אך ורק בהגדרה עצמית ובשליטה בשטח, ולא במסעות צלב מטעם אמונה? הטענה הבסיסית שלנו היא שטבעה של המערכת הבינלאומית הנוכחית מחזק את העמדה הדומיננטית של לאומנים בסכסוך נתון עם ישות פוליטית מנוגדת, כמו גם בתוך אזור הבחירה שלהם. מסיבה זו, ההנהגה הפלסטינית מעולם לא נכנסה להסדר חלוקת כוח עם האיסלאמיסטים, ובישראל, ההסדר הקונסוציאציוני עם המחנה הדתי לאומי התקלקל כאשר הסדר פנימי זה איים על יחסי ישראל עם בעלת בריתה המרכזית, ארה\"ב, וסיכן את מעמדה בקהילה הבינלאומית.",
