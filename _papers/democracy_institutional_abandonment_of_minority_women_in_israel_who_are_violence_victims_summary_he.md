---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: חובתו של הממסד להגן על נשים מפני אלימות אינה קונצנזוס ולעתים נתפסת כמאבק למען זכויות נשים. המאמר הנוכחי עוסק באלימות במשפחה נגד נשים מקבוצות המיעוט של נשים פלסטיניות ואתיופיות בישראל, שתיהן חלק מחברות פטריארכליות, קולקטיביסטיות, הסובלות ממעמד אזרחי ירוד. נערכו ראיונות מובנים למחצה עם נשים פלסטיניות ואתיופיות, וכן עם אנשי מקצוע בשירותים החברתיים בנושא אלימות נגד נשים, לרבות אלימות פיזית וכלכלית, ונגישות למשאבים להגנה מפני אלימות.",
