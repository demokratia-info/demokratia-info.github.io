---
{
  ...
  "summaryHe": "איך פגיעה במוסדות המדינה יכולה להפוך לנסיגה דמוקרטית עמוקה. החשיבות הציבורית של המאמר היא בכך שהוא עוזר לזהות כיצד נסיגה דמוקרטית מתפתחת לא רק בצעד דרמטי אחד, אלא גם דרך רצף החלטות, שפה פוליטית ותמריצים מוסדיים שמחלישים בלמים, נורמות ואמון ציבורי.",
  ...
  "oneLinerHtml": "שורה תחתונה: דורון נבות ויאיר גולדשמידט טוענים שהמשבר הישראלי אינו רק מחלוקת על בית המשפט, אלא תהליך רחב של החלשת יכולת המדינה ומוסדותיה. המאמר מזהיר שכאשר שלטון החוק, המקצועיות הציבורית וההגנות על זכויות נשחקים יחד, הדמוקרטיה הליברלית מאבדת את התשתית שמאפשרת לה לפעול. החשיבות הציבורית של המאמר היא בכך שהוא עוזר לזהות כיצד נסיגה דמוקרטית מתפתחת לא רק בצעד דרמטי אחד, אלא גם דרך רצף החלטות, שפה פוליטית ותמריצים מוסדיים שמחלישים בלמים, נורמות ואמון ציבורי.",
  "sections": [
    {
