---
{
  ...
  "image": {
    "src": "assets/article-images/675_court_democracy_state_deconstruction_summary_he.png",
  ...
  "oneLinerHtml": "דורון נבות ויאיר גולדשמידט טוענים שהמשבר הישראלי אינו רק ויכוח משפטי, אלא תהליך רחב של <strong>פירוק המדינה</strong>: החלשת מוסדות, שומרי סף ונורמות שמאפשרים דמוקרטיה ליברלית.",
  "sections": [
    {
