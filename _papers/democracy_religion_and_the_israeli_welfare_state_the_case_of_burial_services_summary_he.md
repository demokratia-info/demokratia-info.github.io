---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר בשנים האחרונות, ספרות מדינת הרווחה עדה ל\"תפנית דתית\", המזכירה לנו (מחדש) את תפקידה המרכזי של הדת בעיצוב מדינת הרווחה המודרנית. על אף חשיבותו התיאורטית, תפנית זו הוגבלה במידה רבה להגדרות אירופיות, צפון אמריקה ואנטי-פודיות. בהסתמך על המקרה ההיסטורי של שירותי הקבורה בישראל, מחקר זה מבקש לעשות צעד צנוע בסגירת פער תיאורטי ואמפירי זה.",
