---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המחקר נערך באביב 1998 בקרב 529 תלמידי תיכון בדואים בנגב, בכיתות י' וי\"א. הנתונים מראים שרק 6% מהמשיבים בחרו בזהות \"ישראלי\" בלבד, בעוד ש-94% בחרו בזהויות שכללו מרכיב ערבי, פלסטיני או שניהם.",
        "המאמר מצא תמונה מורכבת של זהות ושייכות פוליטית: 56% מהצעירים אמרו שהמונח \"ישראלי\" מתאים לזהותם, אך 61% אמרו שגם המונח \"פלסטיני\" מתאים לזהותם. בבחירה בין שש זהויות, הקבוצה הגדולה ביותר בחרה \"ערבי פלסטיני\" בשיעור 33%, ואחריה \"ערבי ישראלי\" בשיעור 26%.",
        "המאמר טוען שהממצאים ממחישים את כישלון המדיניות שניסתה לדה-ערביזציה של הבדואים. לפי הניתוח, הכישלון נובע מכך שהזהות הלאומית בישראל נבנית באופן שאינו משלב תרבות ומורשת ערביות, ומעניק לגיטימציה למדיניות מפלה כלפי בדואים וקבוצות ערביות אחרות; לכן התחזקות הזהות הפלסטינית בקרב צעירים בדואים מוסברת גם כתגובה למודעות גוברת למציאות זו."
      ]
    },
    {
