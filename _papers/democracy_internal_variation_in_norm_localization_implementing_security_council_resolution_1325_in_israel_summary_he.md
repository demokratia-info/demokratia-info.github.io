---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: המאמר בוחן את תהליך הלוקליזציה של החלטת מועצת הביטחון (SCR) 1325 (נשים, שלום וביטחון) בישראל לאחר האינתיפאדה השנייה. ניתוח של ארבע צורות פרשנות שפותחו בשנים 2000–2010 על ידי שחקנים מקומיים ובינלאומיים: מחאה, דיאלוג פוליטי, רפורמות משפטיות ופעולות טרנספורמטיביות, חושף דפוס לוקליזציה סלקטיבי החורג הרבה מעבר לזכויות נשים הקשורות לקונפליקט. אני טוען שהשפה הנורמטיבית של SCR 1325 הוכיחה את עצמה כמועילה במיוחד ברמת החברה האזרחית, ואיפשרה לארגוני נשים לשרוד את מבנה ההזדמנויות הביתי הבלתי חיובי בדרך כלל במהלך האינתיפאדה השנייה.",
