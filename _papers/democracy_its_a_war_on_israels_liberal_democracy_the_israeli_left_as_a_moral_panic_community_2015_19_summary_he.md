---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה בוחן את השיח של השמאל הישראלי בשנים שקדמו לרצף הבחירות הכלליות בשנים 2019–2021, תוך התמקדות בטענות על האיומים לכאורה על הדמוקרטיה שהציגה ממשלת הימין. ניתוח רטורי של מאמרי דעה ופרשנות פוליטית בעיתונות בנושאים הנוגעים לחינוך, מדע ותרבות מראה שימוש חוזר בפניות לפחד - כמו השוואה עם משטרים טוטליטריים וקריאת רוחות דיסטופיות אחרות הנובעות מאינדוקטרינציה לאומנית ותהליכי \"דתיות\".",
