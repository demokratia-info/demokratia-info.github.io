---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אחד המאפיינים הייחודיים של השליטה המשפטית, הצבאית והפוליטית של ישראל על השטחים הפלסטיניים הכבושים (OPT) היה הביקורת על ידי בית המשפט העליון של ישראל על פעולות והחלטות הרשויות באותם שטחים. בשבתו כבית משפט גבוה לצדק בעל סמכות לבחון את פעולותיהם של כל מי שממלא תפקידים ציבוריים על פי חוק, קיבל בית המשפט אלפי עתירות הנוגעות לחוקיותן של פעולות מגוונות כגון הריסת בתים, גירוש, תפיסת קרקע, היתרי כניסה והקמת התנחלויות. אין ספק כי לעצם קיומה של ביקורת שיפוטית הייתה השפעה מרסנת על הרשויות.",
