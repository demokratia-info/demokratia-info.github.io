---
{
  ...
  "oneLinerHtml": "בית המשפט של אהרן ברק, מהפכות חוקתיות ונסיגה דמוקרטית מדגים כיצד סוגיה אקדמית ממוקדת הופכת לשאלה על <strong>דמוקרטיה ליברלית</strong>, אחריות ציבורית, שוויון והגבלת כוח.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "ישראל היא מקרה בוחן חשוב לשתי האג'נדות. המאמר מסתיים בהסברים לתגובת הגב הפוליטית שחווה בית המשפט העליון הישראלי הנוכחי, שחלקם אפיינו כנסיגה דמוקרטית. לטענתה, בית המשפט תורם לפיתוח המשפט כחלק מדיאלוג ואינטראקציה בין רשויות השלטון השונות."
      ]
    },
    {
