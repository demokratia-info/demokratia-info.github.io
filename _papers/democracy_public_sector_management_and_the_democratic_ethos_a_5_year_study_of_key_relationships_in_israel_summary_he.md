---
{
  ...
  "summaryHe": "המאמר בוחן את ממשל, שירות ציבורי ואתוס דמוקרטי בישראל דרך עדשה של מוסדות ציבור, חברה אזרחית, שירות ציבורי, ממשל ואחריותיות.",
  ...
  "oneLinerHtml": "המאמר בוחן את ממשל, שירות ציבורי ואתוס דמוקרטי בישראל ומראה מדוע הדיון קשור למוסדות ציבור, חברה אזרחית, שירות ציבורי, ממשל ואחריותיות. הקריאה בו חשובה משום שהיא מחברת בין מקור אקדמי לבין השאלה כיצד דמוקרטיה מגבילה כוח, מגינה על זכויות ושומרת על כללי משחק הוגנים.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מוצע מודל תיאורטי לבחון את הקשר בין תפיסות האזרחים לגבי מעורבות והשתתפות בקבלת החלטות מנהלית, איכות ניהולית נתפסת, ביצועים נתפסים במגזר הציבורי והתנהגות דמוקרטית השתתפותית (כלומר, אמון בסוכנויות מנהליות, השתתפות פוליטית ומעורבות קהילתית). ממצאים חושפים שתפיסות האזרחים לגבי מעורבות והשתתפות בקבלת החלטות מינהליות קשורות באופן חיובי לאיכות הניהולית הנתפסת, אך אינה קשורה לביצועים הנתפסים במגזר הציבורי.",
