---
{
  ...
  "summaryHe": "המאמר מבוסס על 25 ראיונות עומק חצי־מובנים עם נשים וגברים בדואים בכפרים לא מוכרים. הוא טוען שגישת היכולות מסבירה טוב יותר מן הגישה הטכנית לפער הדיגיטלי כיצד סמארטפונים מאפשרים מימוש צרכים, וכיצד תשתיות חסרות, הדרה ודת מעצבים את השימוש בפועל.",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המחקר נערך בקרב בדואים בכפרים לא מוכרים, יישובים שאינם מוכרים כישויות מוניציפליות ולכן חסרות בהם תשתיות בסיסיות. הראיונות נערכו בשנים 2017-2019 עם 25 נשים וגברים, בגילאי 19-43, וכללו שאלות על בעלות, גישה, צרכים, שימוש, פתרון בעיות ושביעות רצון מטכנולוגיות מידע ותקשורת.",
