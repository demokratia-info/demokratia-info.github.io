---
{
  ...
  "image": {
    "src": "assets/article-images/512_education_democracy_neo_zionist_right_wing_populist_discourse_and_activism_in_the_israel_education_s.png",
  ...
  "oneLinerHtml": "מערכת החינוך מוצגת כזירה שבה פופוליזם ימני נאבק על גבולות נאמנות, ידע וביקורת.",
  "sections": [
    {
      "headingHe": "איך פופוליזם ניאו-ציוני נכנס אל מערכת החינוך?",
      "paragraphsHtml": [
        "המאמר מציב את שיח ניאו-ציוני פופוליסטי במערכת החינוך בתוך בתי ספר, אוניברסיטאות ותוכניות חינוכיות בישראל. במקום להציג את הנושא כמחלוקת עקרונית בלבד, הוא עוקב אחר האופן שבו מוסדות, שחקנים וכללים יומיומיים מייצרים את הבעיה המחקרית.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "הראיות שהמאמר נשען עליהן מדגישות את שיח, פעילות פוליטית, גבולות ידע ונאמנות לאומית. זהו בסיס שמחייב קריאה זהירה של מנגנונים, תהליכים ותוצאות ביניים, ולא רק של הצהרות רשמיות.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לב המאמר הוא המתח בין חינוך לביקורת אזרחית מול סימון ביקורת כחתרנות או אליטה מנותקת. המתח הזה אינו רק רקע; הוא המנוע שמסביר מדוע ההכרעות בתחום מורכבות, חלקיות ולעיתים סותרות.",
