---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: יש התמקדות גוברת במדעי המדינה על מפלגות ימין פופוליסטיות. מאמר זה מאמץ הגדרה של פופוליזם עם שני ממדים שונים: האנכי (הכולל), המתייחס לאליטות, והאופקי (בלעדי), הפונה ל\"זרים\". מאמר זה בוחן במיוחד את הפוליטיקה של ערכי המשפחה בהקשר של מדיניות הנוגעת לשוויון מגדרי, תכנון משפחה וזכויות להט\"ב בשלוש מדינות: ישראל, איטליה וטורקיה.",
  ...
  "layout": "paper",
  "title": "פופוליזם, דת ומדיניות ערכי משפחה בישראל, איטליה וטורקיה",
