---
{
  ...
  "summaryHe": "המאמר של Sharon Eshel, Oren Yiftachel ו-Talia Margalit מנתח את הסכמי הגג שהפעילה ממשלת ישראל בעשרות רשויות מקומיות. ההסכמים מציעים מימון תשתיות בתמורה להסכמה מוניציפלית לפיתוח מגורים רחב, ובכך מרחיבים את ההיגיון של עסקאות תכנון מן העיר אל קנה המידה הלאומי ומשנים את משטר התכנון הישראלי.",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        ...
        "המאמר של Sharon Eshel, Oren Yiftachel ו-Talia Margalit מנתח את הסכמי הגג שהפעילה ממשלת ישראל בעשרות רשויות מקומיות. ההסכמים מציעים מימון תשתיות בתמורה להסכמה מוניציפלית לפיתוח מגורים רחב, ובכך מרחיבים את ההיגיון של עסקאות תכנון מן העיר אל קנה המידה הלאומי ומשנים את משטר התכנון הישראלי."
      ]
    },
    {
