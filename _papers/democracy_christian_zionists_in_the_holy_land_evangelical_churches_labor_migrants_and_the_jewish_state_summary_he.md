---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוקב אחר יצירת כנסיות אוונגליסטיות שנוצרו על ידי ולמען מהגרים חסרי תיעוד מאמריקה הלטינית בישראל. ראשית, המאמר מתייחס למשמעות החברתית של מנהגים ואמונות דתיות עבור הזהות האישית והקולקטיבית של המהגרים בחברה המארחת ולדרכים שבהן מהגרי עבודה לא-יהודים בישראל יוצרים מרחבים חלופיים הפועלים בו-זמנית כקהילה חדשה של שייכות. המאמר רואה באפשרויות הסמויות בכנסיות \"מרחבים פנויים\" לזרים במדינת היהודים, יחד עם המגבלות שהשתתפות בכנסייה כזו טומנת בחובה עבור קהילת המהגרים."
      ]
    },
    {
