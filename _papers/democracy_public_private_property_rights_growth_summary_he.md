---
{
  ...
  "oneLinerHtml": "המאמר מציע מודל צמיחה אנדוגנית שבו הגנה על זכויות קניין נוצרת גם על ידי המגזר הציבורי וגם על ידי המגזר הפרטי. המחקר שואל מהו החלק המיטבי של מגזר ציבורי ומגזר פרטי בהגנה על זכויות קניין, כאשר ההגנה עצמה משפיעה על תמריצים, השקעה וצמיחה.",
  "sections": [
    {
