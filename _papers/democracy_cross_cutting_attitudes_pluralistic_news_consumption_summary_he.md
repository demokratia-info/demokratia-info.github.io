---
{
  ...
  "descriptionHe": "המאמר מבחין בין עמדות פוליטיות חוצות־מחנות בפועל לבין תפיסה עצמית של מורכבות אידיאולוגית, ובוחן את הקשר שלהן לצריכת חדשות מן המחנה היריב.",
  "summaryHe": "המחקר משתמש בסקרים בארצות הברית ובישראל כדי להשוות בין עמדות חוצות־מחנות בפועל לבין האופן שבו משתתפים תופסים את מבנה העמדות שלהם. הממצא המרכזי הוא שרבים טעו בהערכת מבנה עמדותיהם, ושהתפיסה העצמית של עמדות חוצות־מחנות, ולא המבנה בפועל, נקשרה לצריכה רבה יותר של חדשות המזוהות עם המחנה האידיאולוגי היריב. הקשר נותר גם מעבר למתינות אידיאולוגית ששימשה מדד מקורב למרכזיות.",
  ...
  "oneLinerHtml": "פתיחות לחדשות מן המחנה היריב קשורה פחות למורכבות אידיאולוגית בפועל ויותר לשאלה אם אדם תופס את עצמו כבעל עמדות חוצות־מחנות.",
  "sections": [
    {
