---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: נראה כי תכונות בולטות של ישראל המודרנית פועלות נגד משטר דמוקרטי. רוב האוכלוסייה הגיעה מחברות של מרכז ומזרח אירופה או המזרח התיכון שבהן הדמוקרטיה התבססה בצורה חלשה, אם היא הייתה קיימת בכלל. השנים הראשונות לקיומה של המדינה התאפיינו במלחמה קשה ובעלייה המונית.",
