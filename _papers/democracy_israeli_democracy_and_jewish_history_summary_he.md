---
{
  ...
  "image": {
    "src": "html_qa/democracy_israeli_democracy_and_jewish_history_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בחוסן דמוקרטי וכללי משחק פוליטיים, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Journal of Church and State בשנת 1995. הזווית הדמוקרטית היא שהסדרים מוסדיים אינם רק רקע טכני, אלא תנאי לאמון, לשוויון בפני הכללים וליכולת להגביל כוח ציבורי.",
