---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אבל המחקר הנוגע ליחסים בין יורשיו של ז'בוטינסקי, במיוחד בתקופת כהונתו של ויצמן כנשיא ישראל, מועט. מערכת היחסים של ויצמן עם הרוויזיוניסטים והמתח של תנועת החרות במהלך ימיה הראשונים של מדינת ישראל היא נושא מרתק. עולות שאלות כמו כיצד סתירה זו מהדהדת עם חרות וויצמן והשפעת תפיסה זו על תפיסת המפלגה את הנשיאות.",
