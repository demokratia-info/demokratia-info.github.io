---
{
  ...
  "oneLinerHtml": "המאמר מציב את ישראל בתוך הדיון הבינלאומי על נסיגה דמוקרטית ומראה כיצד שחיקה מוסדית יכולה להצטבר גם בלי ביטול פורמלי של בחירות. התרומה היא ראייה מצטברת: דמוקרטיה נחלשת לעיתים באמצעות רצף צעדים שמצמצמים אמון, ביקורת ושוויון פוליטי.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: משפט בזמן משבר חוקתי אינו ספר חגיגי טיפוסי המוצע לחנך לרגל יובל אקדמי. המחקרים המוצעים לפרופסור מירוסלב וירזיקובסקי מציגים בפני הקוראים חיבורים המנתחים את הבעיות הדוחקות ביותר של החוקתיות המודרנית בממד האירופי שלה. הנושאים העיקריים של הספר הם נושאים היקרים לווירז'יקובסקי: שלטון החוק, זכויות אדם, הדרכים העקומות של החוקתיות האירופית, ואחרון, חביב, אחד המחייב את כולם: עצמאות שיפוטית וביקורת שיפוטית, כמו גם תפקידם של בתי המשפט בשמירה על שלטון החוק.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: המאמר מציב את ישראל בתוך הדיון הבינלאומי על נסיגה דמוקרטית ומראה כיצד שחיקה מוסדית יכולה להצטבר גם בלי ביטול פורמלי של בחירות."
      ]
    },
    {
