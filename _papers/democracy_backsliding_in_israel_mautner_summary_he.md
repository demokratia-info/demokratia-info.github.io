---
{
  ...
  "descriptionHe": "המאמר מציב את ישראל בתוך הדיון הבינלאומי על נסיגה דמוקרטית ומראה כיצד שחיקה מוסדית יכולה להצטבר גם בלי ביטול פורמלי של בחירות.",
  ...
  "oneLinerHtml": "שורה תחתונה: המאמר מציב את ישראל בתוך הדיון הבינלאומי על נסיגה דמוקרטית ומראה כיצד שחיקה מוסדית יכולה להצטבר גם בלי ביטול פורמלי של בחירות. התרומה היא ראייה מצטברת: דמוקרטיה נחלשת לעיתים באמצעות רצף צעדים שמצמצמים אמון, ביקורת ושוויון פוליטי.",
  "sections": [
    {
      "headingHe": "מה המאמר בוחן",
      "paragraphsHtml": [
        "מנחם מאוטנר בוחנים את המאמר Democratic Backsliding in Israel דרך השאלה הדמוקרטית המרכזית שלו.",
