---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: בגל ההפגנות שהתרחש בישראל בשנת 2023 בתגובה להצעת התיקון השיפוטי של הממשלה, מאפיין בולט היה השימוש בדגל ישראל כסמל בולט. המפגינים, המזוהים בעיקר עם המרכז-שמאל הליברלי, החזירו לעצמם את הדגל, שעד אז היה מזוהה במידה רבה עם הימין הפוליטי של ישראל, והשתמשו בו כדי להעביר את מחויבותם לערכי ה\"ישראליות\", שלדעתם מאוימים מהשיפוץ השיפוטי. המחקר מבקש לחקור את הנרטיבים והמסרים הסמליים שמעבירות מוטציות אלו מנקודת מבט של תורת הנוף הסמיוטית וגישות מגוונות לניתוח שיח מולטי-מודאלי, לפיהן משמעות נובעת ממנגנונים בין-סמיוטים המאפשרים את הרחבת המשמעות.",
