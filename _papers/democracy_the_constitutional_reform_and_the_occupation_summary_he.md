---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "'הרפורמה החוקתית' שתכננה הממשלה שקיבלה את השלטון בישראל בדצמבר 2022 אינה מטרה בפני עצמה. מאמר זה דן בקשר בין חלקים שונים ברפורמה לבין התוכניות לשינוי קיצוני במדיניות ישראל בגדה המערבית הכבושה. הוא בוחן את ההסכם הקואליציוני בין מפלגת הליכוד של ראש הממשלה נתניהו למפלגת הציונות הדתית, וחושף את הקשר בין המחויבות בהסכם זה למדיניות בעניין הכיבוש לבין ה'רפורמה' המתוכננת."
      ]
    },
    {
