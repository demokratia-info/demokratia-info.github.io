---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אף על פי כן, אנו טוענים שהיא אינה מאפשרת תהליך ריפוי ומטפחת פרספקטיבה מופחתת על העקרונות המהותיים של הדמוקרטיה. עוד אנו טוענים כי נקודת מבט נרחבת יותר על השואה, הכוללת הבנת הנאציזם בתוך פסיפס אידיאולוגי השולל עקרונות דמוקרטיים ואנושיות, עשויה לחזק את ההזדהות של הישראלים עם עקרונות דמוקרטיים וזכויות אדם אוניברסליות. אנו מנתחים את הגישות השונות להוראת השואה בהקשר של הטראומה הקולקטיבית וחוקרים את השפעתן על תחושת הקורבנות והפגיעה המוסרית של החברה.",
