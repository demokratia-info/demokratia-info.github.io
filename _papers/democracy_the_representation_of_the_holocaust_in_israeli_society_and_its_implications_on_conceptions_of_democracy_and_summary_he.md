---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "אף על פי כן, המאמר טוען שהיא אינה מאפשרת תהליך ריפוי ומטפחת פרספקטיבה מופחתת על העקרונות המהותיים של הדמוקרטיה. עוד המאמר טוען כי נקודת מבט נרחבת יותר על השואה, הכוללת הבנת הנאציזם בתוך פסיפס אידיאולוגי השולל עקרונות דמוקרטיים ואנושיות, עשויה לחזק את ההזדהות של הישראלים עם עקרונות דמוקרטיים וזכויות אדם אוניברסליות. המאמר מנתח את הגישות השונות להוראת השואה בהקשר של הטראומה הקולקטיבית וחוקר את השפעתן על תחושת הקורבנות והפגיעה המוסרית של החברה."
      ]
    },
    {
