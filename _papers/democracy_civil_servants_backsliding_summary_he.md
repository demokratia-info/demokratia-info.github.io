---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אנו בוחנים זאת בהקשר של הניסיון של ממשלת הימין הקיצוני הפופוליסטי בישראל לצמצם את סמכויות ועצמאותו של בית המשפט העליון הישראלי ולהחליף את היועצים המשפטיים במינויים פוליטיים (להלן \"השיפוץ המשפטי\"). אנו משתמשים בעיצוב של שיטות מעורבות, המשלבים סקר, ראיונות וקבוצת מיקוד עם עובדי מדינה בקריירה, ומראה כי אלו שתופסים את השינוי המשפטי כאיום על הדמוקרטיה נוטים יותר לצאת מהממשלה ופחות להשמיע ולהפעיל מאמץ בעבודה.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: איך עובדי מדינה מגיבים כשהם מזהים איום על מוסדות הדמוקרטיה."
      ]
    },
    {
