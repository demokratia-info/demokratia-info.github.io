---
{
  ...
  "image": {
    "src": "assets/article-images/real_photo_106_protest_democracy_civil_servants_backsliding_summary_he.jpg",
    "version": "2026-07-05-real-photo-handoff",
    "altHe": "תצלום על שירות ציבורי ונסיגה דמוקרטית",
    "fitness": "high",
    "license": "CC BY-SA 2.0",
    "creator": "Alisdare Hickson",
    "provider": "Wikimedia Commons",
    "sourcePage": "https://commons.wikimedia.org/wiki/File:Boycott_Israeli_Apartheid_UK.jpg",
    "originalUrl": "https://upload.wikimedia.org/wikipedia/commons/f/fa/Boycott_Israeli_Apartheid_UK.jpg",
    "fileTitle": "Boycott Israeli Apartheid UK.jpg",
    "sourceDimensions": "3688x2381",
  ...
  "oneLinerHtml": "המחקר מראה שכאשר עובדי מדינה תופסים רפורמה מוסדית כאיום על הדמוקרטיה, תגובתם עשויה להיות עזיבה או נסיגה ממעורבות פנימית.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר בוחן את תגובותיהם של עובדי מדינה מקצועיים בישראל על רקע הדיונים בכנסת בהצעות השינוי המשפטי והמחאות הציבוריות סביבן. הסקר נערך בין 16 בפברואר ל-7 במרץ 2023, ובחן כיצד תפיסת נסיגה דמוקרטית קשורה לכוונות עזיבה, להשמעת קול בתוך הארגון ולמאמץ בעבודה.",
        "המחקר משלב סקר, ראיונות חצי-מובנים וקבוצת מיקוד עם עובדי מדינה. מתוך 954 מי שפתחו את קישור הסקר, 684 ציינו שהם עובדים בממשל המרכזי, ו-465 השיבו לפחות על אחת משאלות התוצאה המרכזיות. נוסף לכך נערכו ראיונות במרץ-אפריל 2023 וקבוצת מיקוד במאי 2023.",
        "הניתוח מצא שעובדי מדינה שתפסו את השינוי המשפטי כאיום על הדמוקרטיה נטו יותר לבטא כוונה לעזוב את השירות הציבורי, ופחות נטו להשמיע קול ולהשקיע מאמץ בעבודה. בסקר המשך, שבעה מתוך עשרה משיבים שהביעו בתחילה כוונת עזיבה גבוהה או גבוהה מאוד דיווחו על עזיבה בפועל, לעומת חמישה מתוך 21 בקרב מי שלא הביעו כוונה כזו."
      ]
    },
    {
