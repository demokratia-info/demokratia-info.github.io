---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר בוחן זאת בהקשר של הניסיון של ממשלת הימין הקיצוני הפופוליסטי בישראל לצמצם את סמכויות ועצמאותו של בית המשפט העליון הישראלי ולהחליף את היועצים המשפטיים במינויים פוליטיים (להלן \"השיפוץ המשפטי\"). המחקר משתמש בעיצוב של שיטות מעורבות, המשלבים סקר, ראיונות וקבוצת מיקוד עם עובדי מדינה בקריירה, ומראה כי אלו שתופסים את השינוי המשפטי כאיום על הדמוקרטיה נוטים יותר לצאת מהממשלה ופחות להשמיע ולהפעיל מאמץ בעבודה.",
        "איך עובדי מדינה מגיבים כשהם מזהים איום על מוסדות הדמוקרטיה."
      ]
    },
    {
