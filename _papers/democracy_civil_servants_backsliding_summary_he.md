  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        ...
        "המחקר משלב סקר, ראיונות חצי-מובנים וקבוצת מיקוד עם עובדי מדינה. מתוך 954 שפתחו את קישור הסקר, 684 ציינו שהם עובדים בממשל המרכזי, ו-465 השיבו לפחות על אחת משאלות התוצאה המרכזיות. נוסף לכך נערכו ראיונות במרץ-אפריל 2023 וקבוצת מיקוד במאי 2023.",
