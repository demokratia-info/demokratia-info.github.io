---
{
  ...
  "image": {
    "src": "html_qa/democracy_unbundling_institutions_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: באמצעות גישת משתנים אינסטרומנטליים זו, אנו מוצאים שלמוסדות זכויות קניין יש השפעה ממדרגה ראשונה על צמיחה כלכלית ארוכת טווח, השקעות ופיתוח פיננסי. הסבר אפשרי לדפוס זה הוא שלעתים קרובות אנשים מוצאים דרכים לשנות את תנאי החוזים הפורמליים והבלתי פורמליים שלהם כדי להימנע מהשפעות שליליות של מוסדות קבלניים חלשים, אך מתקשים יותר להפחית את הסיכון להפקעה בדרך זו.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק במוסדות דמוקרטיים ואחריות ציבורית, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Journal of Political Economy בשנת 2005. הזווית הדמוקרטית היא שהסדרים מוסדיים אינם רק רקע טכני, אלא תנאי לאמון, לשוויון בפני הכללים וליכולת להגביל כוח ציבורי."
      ]
    },
    {
