---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר הדמוקרטיה הישראלית מסדירה את פעולת הרשות השופטת באמצעות אילוצים של כללים פורמליים הבודקים את הגורמים הפוליטיים, את השופטים הבודדים ואת הרשות השופטת. בישראל, לחלק מהמוסדות הבלתי פורמליים הללו יש חשיבות מכרעת לשגשוג הדמוקרטיה ושלטון החוק, באמצעות הגנתם על עצמאות שיפוטית מהתערבות פוליטית חיצונית. מאמר זה דן במוסדות בלתי פורמליים החשובים בפעולת מערכת המשפט הישראלית, תוך הפרדה בין הסוג החיצוני הקודם התורם לשלטון החוק - כמו חוסר לגיטימיות של שיקולים פוליטיים ומפלגתיים במינויים שופטים - ושהתעלמותם עלולה להעיד על דעיכה דמוקרטית מהסוג הפנימי השני שעלול להזיק למינהל שאחראי לממשל כאחראי על בית המשפט.",
