---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המחקרים נערכו במקביל והתבססו על נתונים איכותיים וכמותיים שנאספו בזירה הפנים-ארגונית והחוץ-ארגונית. הנתונים נותחו בטכניקת מודל משוואות מבניות (SEM). יתרה מכך, התמיכה החזקה ביותר נמצאה במודל מתווך שבו ביצועים נתפסים תיווכו את היחסים הבירוקרטיים-דמוקרטיים."
      ]
    },
    {
