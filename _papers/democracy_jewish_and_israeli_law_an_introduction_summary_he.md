---
{
  ...
  "oneLinerHtml": "המאמר בוחן את סוגיית הקשרים בין משפט יהודי למשפט ישראלי דרך עדשה של חוקתיות, בתי משפט ושלטון החוק.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "הוא נותן ניתוח מפורט של המשפט הציבורי והפרטי העכשווי במדינת ישראל, כמו גם התרבות המשפטית של ישראל, שיטת הממשל שלה ותפקידי המוסדות הדמוקרטיים שלה: הרשות המבצעת, הפרלמנט והרשות השופטת. הספר בוחן סוגיות של שואה, משפט ודת, חוקה ושוויון."
      ]
    },
    {
