---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה חוקר את האינטראקציות הדינמיות בין מעבר דמוגרפי, חלוקת הכנסה וצמיחה כלכלית. בהתאם לראיות אמפיריות, אנו מראים כי פריון וחלוקת הכנסה עוקבים אחר דינמיקה הפוכה בצורת U בתהליך הפיתוח הכלכלי. בשלב הראשון הפריון עולה ואי השוויון בהכנסות מתרחב, בעוד שבשלב השני הפריון יורד, ההכנסה מתחלקת בצורה שווה יותר, ההון האנושי שופע, והצמיחה בהכנסה לנפש ממריאה.",
