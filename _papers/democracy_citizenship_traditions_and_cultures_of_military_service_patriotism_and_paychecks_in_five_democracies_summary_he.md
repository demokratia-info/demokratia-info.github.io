---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר מדווח ומסבירים תוצאות סקר ייחודיות של אוכלוסיות מייצגות ארצית בחמש דמוקרטיות - צרפת, גרמניה, ישראל, בריטניה וארצות הברית. המאמר טוען שההסבר הסביר ביותר נעוץ בשיח האזרחות הלאומי הרווח, בשילוב עם הקצב המבצעי של הצבא."
      ]
    },
    {
