---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: במחקר הנוכחי מיושמת שיטת 'ניסוי סקר גורמי' כדי לבחון ולהשוות את ההשפעה הדיפרנציאלית של מאפיינים של מהגרים על הסנטימנט נגד מהגרים בקרב אוכלוסיות הרוב והמיעוט בישראל. הניתוח מגלה כי ערבים תומכים במהגרים יותר מאשר יהודים, וכי המאפיין המשפיע ביותר על גיבוש עמדות הוא מוצאם הדתי של המהגרים, כאשר יהודים מעדיפים מהגרים יהודים אך מתנגדים לא-יהודים (בעיקר מוסלמים) וערבים מעדיפים מהגרים לא-יהודים (בעיקר מוסלמים).",
