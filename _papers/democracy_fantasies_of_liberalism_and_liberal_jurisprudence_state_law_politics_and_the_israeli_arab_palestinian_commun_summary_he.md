---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: כשלושים שנה לאחר החלטת ברגמן, המבנה החוקתי והתרבות המשפטית של ישראל עדיין אינם מגיבים לצרכי מיעוטים או, באופן רחב יותר, לצרכים החברתיים של קהילות מוחלשות. פסק הדין של ברגמן סימן את תחילתו של עידן חדש בפסיקה הישראלית - עידן הליברליזם, בכך שהוליד את הרעיון של ריבונות נגדית שיפוטית כמרכז, בעייתי ככל שיהיה, של הדמוקרטיה. מאוחר יותר, לאחר 1992, ומונע מרוח האקטיביזם השיפוטי, אימץ בית המשפט העליון מדיניות שיפוטית מרחיבה יותר.",
