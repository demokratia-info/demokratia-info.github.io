---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "השורה התחתונה היא שחוסן דמוקרטי וכללי משחק פוליטיים הם נושא בעל משמעות דמוקרטית רחבה. הוא משפיע על האופן שבו כללים נוצרים, נאכפים ומצדיקים את עצמם מול אזרחים וקבוצות שונות.",
