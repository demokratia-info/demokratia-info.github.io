  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        ...
        "Manosevitch, Friedman ו-Sprain בוחנים כיצד משתתפים בפורומים דיוניים בישראל מתייחסים לדיבור עצמו, למסגור האינטראקציה ולמתחים בין תרבות מקומית לבין עקרונות דיוניים. לפי התקציר, מטא־שיח מאפשר להם להכיר בקושי, לשאת ולתת על נורמות ולשלב יצירתית בין שיח ישראלי לבין דליברציה."
      ]
    },
    {
