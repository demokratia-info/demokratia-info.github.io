...
{
  "version": 1,
  "file": "democracy_practicing_deliberation_challenging_speech_cultures_metadiscourse_summary_he.html",
  "slug": "democracy_practicing_deliberation_challenging_speech_cultures_metadiscourse_summary_he",
  "titleHe": "מטא־שיח מאפשר דיון דמוקרטי גם בתרבות דיבור מאתגרת",
  "subtitleHe": "",
  ...
  "summaryHe": "Manosevitch, Friedman ו-Sprain בוחנים כיצד משתתפים בפורומים דיוניים בישראל מתייחסים לדיבור עצמו, למסגור האינטראקציה ולמתחים בין תרבות מקומית לבין עקרונות דיוניים. לפי התקציר, מטא־שיח מאפשר להם להכיר בקושי, לשאת ולתת על נורמות ולשלב יצירתית בין שיח ישראלי לבין דליברציה.",
  ...
  "journal": "Journal of Communication, 74(4), 322-332",
  "dateText": "פורסם אונליין: 30.05.2024",
  "sourcePublishedDate": "2024-05-30",
  "doiUrl": "https://doi.org/10.1093/joc/jqae020",
  "doiLabel": "https://doi.org/10.1093/joc/jqae020",
  "authors": [
    {
      "@type": "Person",
      "name": "Idit Manosevitch",
      "url": "https://orcid.org/0000-0001-5195-2106"
    },
    {
      "@type": "Person",
      "name": "Elie Friedman",
    ...
    },
    {
      "@type": "Person",
      "name": "Leah Sprain",
      "url": "https://www.colorado.edu/cmdi/people/communication/leah-sprain"
    }
  ],
  "sourceAuthors": [
    {
  ...
  "sections": [
    {
      ...
      "paragraphsHtml": [
        "<strong>מטא־שיח</strong> הוא דיבור על הדיבור עצמו: על כללי השיחה, על האופן שבו משתתפים מפרשים זה את זה ועל גבולות ההתנהגות בדיון. במאמר הוא מנגנון שמאפשר להפוך תרבות דיבור מאתגרת לזירה של למידה דמוקרטית."
      ]
    },
    {
      "headingHe": "מה המאמר מצא או טוען בפועל?",
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: הניתוח שלנו בוחן פורומים דיוניים מובנים שנערכים על ידי סטודנטים לתקשורת בישראל, כדי להדגים כיצד המשתתפים מתייחסים, משתמשים ומתכוונים הן לשיח הדמוקרטי הדיוני והן לתרבות הדיבור הישראלית בדרכים המאפשרות להם להתגבר על אתגרים תרבותיים לעשיית דיון. מצאנו שהמשתתפים משתמשים במטא-דיסקורס כדי לנקוט עמדות הממסגרות אתגרים תרבותיים של התלבטות, לנהל משא ומתן על המתחים בין עקרונות דיבור ותרבות דיבור מקומית, ולשלב באופן יצירתי נורמות דיבור מקומיות עם התלבטות.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: Manosevitch, Friedman ו-Sprain בוחנים כיצד משתתפים בפורומים דיוניים בישראל מתייחסים לדיבור עצמו, למסגור האינטראקציה ולמתחים בין תרבות מקומית לבין עקרונות דיוניים. לפי התקציר, מטא־שיח מאפשר להם להכיר בקושי, לשאת ולתת על נורמות ולשלב יצירתית בין שיח ישראלי לבין דליברציה."
      ]
    },
    {
    ...
    {
      "headingHe": "איזו זירה אמפירית נבחנת?",
      "paragraphsHtml": [
        "לפי התקציר, המחקר בוחן פורומים דיוניים מובנים שערכו סטודנטים לתקשורת בישראל. הזירה הזאת מאפשרת לראות אינטראקציה ממשית ולא רק עמדות מופשטות על דמוקרטיה או תרבות דיבור."
      ]
    },
    {
      "headingHe": "איך משתתפים משתמשים במטא־שיח?",
      "paragraphsHtml": [
    ...
    {
      "headingHe": "מה החידוש ביחס לדמוקרטיה דיונית?",
      "paragraphsHtml": [
    ...
    {
      "headingHe": "למה זה חשוב בחברה מקוטבת?",
      "paragraphsHtml": [
    ...
    {
      "headingHe": "איך זה קשור למוסדות דמוקרטיים?",
      "paragraphsHtml": [
    ...
    {
      "headingHe": "מה אפשר ללמוד ממנו על ישראל?",
      "paragraphsHtml": [
  ...
  "layout": "paper",
  "title": "מטא־שיח מאפשר דיון דמוקרטי גם בתרבות דיבור מאתגרת",
  "permalink": "/democracy_practicing_deliberation_challenging_speech_cultures_metadiscourse_summary_he.html",
  "paper_url": "democracy_practicing_deliberation_challenging_speech_cultures_metadiscourse_summary_he.html",
  "sortKey": 202606070007
}
---
