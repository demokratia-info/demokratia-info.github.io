---
{
  ...
  "summaryHe": "המאמר בוחן את סוגיית פוליטיקאים, מומחים ותמיכה ציבורית במדיניות קורונה דרך עדשה של מוסדות ציבוריים, חברה אזרחית ואחריותיות דמוקרטית.",
  ...
  "oneLinerHtml": "פוליטיקאים, מומחים ותמיכה ציבורית במדיניות קורונה מדגים כיצד סוגיה אקדמית ממוקדת הופכת לשאלה על <strong>דמוקרטיה ליברלית</strong>, אחריות ציבורית, שוויון והגבלת כוח.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "= 12,955): ברזיל, ישראל, איטליה, דרום קוריאה, שוודיה, בריטניה וארצות הברית. ברחבי מדינות, רמזים מאליטות פוליטיות קוטבו את עמדות הציבור כלפי מדיניות COVID-19. במקום זאת, תוצאות אלו מצביעות על כך שתהליכי קיטוב נוצרו פשוט מסיווג אנשים לקבוצות פנים וחוץ פוליטיות."
      ]
    },
    {
