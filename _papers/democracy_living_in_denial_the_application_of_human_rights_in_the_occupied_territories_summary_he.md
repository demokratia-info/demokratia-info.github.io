---
{
  ...
  "titleHe": "יישום זכויות אדם בשטחים: חיים בהכחשה",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_living_in_denial_the_application_of_human_rights_in_the_occupied_territories_summary_he.jpg",
    "version": "2026-05-23-extra-100-economics-refill",
    "altHe": "תמונה עריכתית: יישום זכויות אדם בשטחים: חיים בהכחשה",
    "fitness": "standard"
  },
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר האם נורמות זכויות האדם חלות על שטחים כבושים בכלל, ועל הגדה המערבית ורצועת עזה בפרט? המאמר קובע כי המטרה והתכלית האוניברסלית של אמנות זכויות אדם, המודיעות על הפרשנות הנכונה של סעיפי השיפוט שלהן, מחייבות את תחולתן בכל הטריטוריות הכפופות לשליטה אפקטיבית של המדינות החברות, כמו גם לתרגילים חוץ-טריטוריאליים אחרים של כוח ממשלתי המשפיעים ישירות על יחידים. כתוצאה מכך, דיני זכויות האדם הבינלאומיים והמשפט ההומניטרי הבינלאומי חלים בשטחים כבושים במקביל ולא בהדרה אחד של השני.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בזכויות, שוויון והגנות למיעוטים, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Israel Law Review בשנת 2003.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "יישום זכויות אדם בשטחים: חיים בהכחשה",
