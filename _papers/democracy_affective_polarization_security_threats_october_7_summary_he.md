---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: בעוד ששורת מחקר אחת מציעה כי איומים חיצוניים מגבירים את האחדות הביתית, עבודה אחרונה הדגישה את עמידות ההשפעה הפרטיזנית גם בעקבות אירועים אלימים. אנו בוחנים שאלה זו במקרה הישראלי, ובודקים האם האיבה המפלגתית פחתה בעקבות הפיגוע ב-7 באוקטובר 2023, והמלחמה שבעזה בעקבותיה. ניתוחים של נתוני פאנל וחתך רוחב מראים כי הקיטוב הרגשי היה מתמשך מאוד במהלך איומי הביטחון הקיצוניים הללו: נמדד הן באמצעות מדי חום תחושה והן בפריטי מרחק חברתי, הקיטוב הרגשי לא ירד לאורך התקופה הנבדקת.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: המאמר מציב מבחן חשוב להנחה שאסון ביטחוני מאחד את החברה ומראה שקיטוב רגשי עשוי להישאר יציב גם מול איום קיצוני."
      ]
    },
    {
