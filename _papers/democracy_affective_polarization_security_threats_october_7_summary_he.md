---
{
  ...
  "descriptionHe": "עומר יאיר, יאיר אמיטל, אמנון כוורי, אסיף אפרת ונעם גדרון מנתחים קיטוב רגשי בישראל לאחר מתקפת 7 באוקטובר 2023.",
  ...
  "oneLinerHtml": "שורה תחתונה: המאמר מציב מבחן חשוב להנחה שאסון ביטחוני מאחד את החברה ומראה שקיטוב רגשי עשוי להישאר יציב גם מול איום קיצוני. מבחינה דמוקרטית, הממצא מחייב להבחין בין סולידריות מול איום לבין שיקום אמון פוליטי פנימי; הראשון אינו מבטיח את השני.",
  "sections": [
    {
