---
{
  ...
  "descriptionHe": "המאמר בוחן אם מתקפת 7 באוקטובר 2023 והמלחמה בעזה הפחיתו קיטוב רגשי בין מחנות פוליטיים בישראל.",
  "summaryHe": "המחקר מצא שקיטוב רגשי בישראל נשאר יציב מאוד גם לאחר איום ביטחוני חריף, הן במדדי רגשות והן במדדי מרחק חברתי.",
  ...
  "oneLinerHtml": "המאמר מערער על ההנחה שאיום ביטחוני חיצוני בהכרח מאחד את הציבור, ומראה שבישראל לאחר 7 באוקטובר הקיטוב הרגשי כמעט לא פחת.",
  "sections": [
    {
