---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: למרות היותה מדינה קטנה ומבודדת יחסית, ניהול מגיפת COVID-19 היה עד כה אתגר לא קטן עבור ישראל. תרומה זו מבקשת להסביר כיצד ישראל ניהלה את ההגירה ואת המגיפה בתוך משבר חוקתי בין פברואר ליולי 2020.",
