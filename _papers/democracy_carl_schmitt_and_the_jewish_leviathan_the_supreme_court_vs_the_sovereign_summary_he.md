---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: סכסוכים בין בתי משפט ומוסדות שנבחרו באופן דמוקרטי משותפים למדינות מערביות רבות, במיוחד כאשר גופים שיפוטיים מבצעים ביקורת על חוקים. 1 על אף שהביקורת השיפוטית מוצדקת ככזו שהיא אכיפה של נורמה על-משפטית, 2 בדרך כלל חוקה, שכוחה המחייב גבוה מהחקיקה העיקרית ותפקידה ליצור גבולות לשימוש בריבונות עממית.",
