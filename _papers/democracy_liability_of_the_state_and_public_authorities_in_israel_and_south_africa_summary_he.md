---
{
  ...
  "titleHe": "אחריות המדינה ורשויות ציבוריות בישראל ובדרום אפריקה",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_liability_of_the_state_and_public_authorities_in_israel_and_south_africa_summary_he.jpg",
    "version": "2026-05-23-extra-100-economics-refill",
    "altHe": "תמונה עריכתית: אחריות המדינה ורשויות ציבוריות בישראל ובדרום אפריקה",
    "fitness": "standard"
  },
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: הן מערכות המשפט הישראליות והן בדרום אפריקה מסווגות כמערכות משפטיות מעורבות, או תחומי שיפוט מעורבים. גורמים ספציפיים שהשפיעו על התפתחות חבות המדינה והרשות הציבוריים הם: (1) ערכים חוקתיים, (2) הכרה של בתי המשפט בצורך בהגנה מורחבת על זכויות אדם בסיסיות ואקטיביזם לקראת השגת הגנה כזו, (3) האופי הרב-תרבותי של החברות, (4) בעיות של פשע וביטחון, ו- (5) קשר בין המגמה הצרכנית והרחבת של המדינה העולמית. רשויות ציבוריות. למרות הבדלים חשובים, המשפט בשני תחומי השיפוט התפתח מרקע מעורב דומה במידה רבה; בתי המשפט אימצו שיטות ונימוקים דומים במידה רבה; והתוצאות מראות מגמות דומות.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק במוסדות ציבוריים, ממשל ואמון אזרחי, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת European Journal of Comparative Law and Governance בשנת 2013.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "אחריות המדינה ורשויות ציבוריות בישראל ובדרום אפריקה",
