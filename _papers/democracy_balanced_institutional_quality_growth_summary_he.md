---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המחקר מוצא כי הכללת מדד פשוט של סטיית התקן בתוך המדינה בין ציוני אזורים דו-קיימים מביאה לשיפור משמעותי באופן משמעותי במפרטי הצמיחה האמפיריים. המחקר בוחן גם אינטראקציות בין תחומים ומוצא קשרים כאלה במיוחד עם מערכת משפטית וזכויות קניין. ממצאים אלו מצביעים על צורך לשקול מחדש את ההנחה הסמויה של עצמאות בין ציוני האזור, כמו גם גישה מאוזנת לרפורמה מוסדית בפועל.",
