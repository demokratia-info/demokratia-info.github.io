---
{
  ...
  "subtitleHe": "",
  "descriptionHe": "המאמר משתמש בנתוני אוכלוסייה שוודיים המקשרים ארבעה דורות כדי לבחון כיצד הון אנושי עובר במשפחה המורחבת. הוא מראה שמדידת ניידות רק דרך קשר הורה-ילד מביאה להערכת חסר של ההתמדה הבין-דורית של יתרון והשכלה.",
  ...
  "image": {
    "src": "assets/article-images/real_photo_201_economy_democracy_dynastic_human_capital_inequality_intergenerational_mobility_summary_he.jpg",
    "version": "2026-07-05-real-photo-handoff",
    "altHe": "תצלום על משפחות, חינוך וניידות בין־דורית",
    "fitness": "high",
    "license": "CC BY 4.0",
    "creator": "Nizzan Cohen",
    "provider": "Wikimedia Commons",
    "sourcePage": "https://commons.wikimedia.org/wiki/File:Solomon_Souza_in_Mahane_Yehuda_Market_08.jpg",
    "originalUrl": "https://upload.wikimedia.org/wikipedia/commons/8/85/Solomon_Souza_in_Mahane_Yehuda_Market_08.jpg",
    "fileTitle": "Solomon Souza in Mahane Yehuda Market 08.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "אומדני הורה-ילד מעריכים בחסר את ההתמדה ארוכת הטווח בלפחות שליש. משמעות הדבר היא שהשפעת המשפחה על הזדמנות עשויה להיות גדולה יותר מכפי שמדדים פשוטים מראים."
      ]
    },
    {
