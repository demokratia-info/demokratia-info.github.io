---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מחקר השוואתי מגלה כי מערכת המשפט היא לעתים קרובות מעוז מפתח נגד התנשאות ביצועית. אני מדגים את התיאוריה הזו בישראל בין השנים 2009 ל-2023 על ידי ניתוח נתונים כמותיים על למעלה מ-16,000 החלטות פאנל של בית המשפט העליון בישראל וראיונות איכותניים עם שופטים, עורכי דין ופוליטיקאים בכירים. לבסוף, אני בודק את התיאוריה בין-לאומית באמצעות מערך נתונים מקורי של מוסדות בחירה שופטים ב-139 מדינות.",
