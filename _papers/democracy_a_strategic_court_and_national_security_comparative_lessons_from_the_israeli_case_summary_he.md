---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה מנתח את קבלת ההחלטות בתיקי ביטחון לאומי בבית המשפט העליון בישראל ומסיק מסקנות השוואתיות רחבות יותר. בעידן שלאחר ה-11 בספטמבר, הביטחון עמד בראש סדר היום הלאומי במספר דמוקרטיות מבוססות, עם ההשלכות של בתי המשפט שלהן. הממצאים מצביעים על כך שהעיצוב החוקתי, הנהגת בית המשפט, האידיאולוגיה של הקואליציה השלטת ופעילות קבוצות האינטרס השפיעו על החלטות בית המשפט הישראלי בעניין ההגנה הלאומית.",
