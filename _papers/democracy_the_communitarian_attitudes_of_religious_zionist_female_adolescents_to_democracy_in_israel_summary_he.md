---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מחקר זה מצא כי בוגרות מבתי הספר הדתיים לאומיים הושפעו מתיאולוגיה פוליטית שקודמה באמצעות תהליכי החינוך והסוציאליזציה של בתי הספר שלהן. הממצאים הדגישו את אמונתם של הבוגרים בגישה הקהילתית היעקוביני לדמוקרטיה; התמקדותם בתפיסת ההרחבה של ליבמן; והאתגרים שגישות אלו מציבות לחינוך אזרחי מירבי בישראל.",
