---
{
  ...
  "image": {
    "src": "html_qa/democracy_democracy_does_cause_growth_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אנו מספקים ראיות לכך שלדמוקרטיה יש השפעה חיובית על התמ\"ג לנפש. אסטרטגיית הפאנל הדינמי שלנו שולטת בהשפעות קבועות במדינה ובדינמיקה העשירה של התמ\"ג, שאחרת מבלבלת את השפעת הדמוקרטיה. תוצאות הבסיס שלנו מראות שדמוקרטיזציות מגדילות את התמ\"ג לנפש בכ-20% בטווח הארוך.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בהקשר בין דמוקרטיה, מוסדות וצמיחה כלכלית, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Journal of Political Economy בשנת 2019. הזווית הדמוקרטית היא שהסדרים מוסדיים אינם רק רקע טכני, אלא תנאי לאמון, לשוויון בפני הכללים וליכולת להגביל כוח ציבורי."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "האם דמוקרטיה גורמת לצמיחה כלכלית?",
