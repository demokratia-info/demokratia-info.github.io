---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המחקר מספק ראיות לכך שלדמוקרטיה יש השפעה חיובית על התמ\"ג לנפש. אסטרטגיית הפאנל הדינמי במחקר שולטת בהשפעות קבועות במדינה ובדינמיקה העשירה של התמ\"ג, שאחרת מבלבלת את השפעת הדמוקרטיה. תוצאות הבסיס במחקר מראות שדמוקרטיזציות מגדילות את התמ\"ג לנפש בכ-20% בטווח הארוך."
      ]
    },
    {
