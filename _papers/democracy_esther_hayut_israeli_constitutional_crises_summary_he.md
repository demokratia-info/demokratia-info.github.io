  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        ...
        "המורשת המרכזית שמזהה המאמר היא היישום התקדים והנועז של ביקורת שיפוטית על נורמות חוקתיות. בעיני המחברים, מהלך זה סייע לבית המשפט לשמור על שלטון החוק ועל אופייה הדמוקרטי של ישראל בתקופה שבה המשברים החוקתיים הצטברו."
      ]
    },
    {
