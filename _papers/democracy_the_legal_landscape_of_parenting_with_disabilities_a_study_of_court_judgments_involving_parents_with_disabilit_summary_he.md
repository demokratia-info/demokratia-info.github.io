---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר במאמר זה, אנו מציגים מחקר החוקר את התנהלות בתי המשפט בישראל כלפי הורים עם מוגבלות על ידי ניתוח של 78 פסקי דין של בתי המשפט. זה משמעותי במיוחד בהתחשב בגידול משמעותי בפסקי הדין לאורך זמן, כאשר עתירות אימוץ קלות (32.9%) וביטול צווי אימוץ (25.3%) הן התביעות הנפוצות ביותר. בתי המשפט התייחסו במפורש לנכות של ההורה ב-84.6% מהמקרים ושקלו התאמות תמיכה ב-28.6%.",
