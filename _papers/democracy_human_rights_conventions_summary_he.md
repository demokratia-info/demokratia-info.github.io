---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מחקר זה מגלה כי אמנות זכויות האדם חסרות כמעט לחלוטין מעמד משפטי פנימי פורמלי. שינוי זה עשוי להיות תוצאה של סיבות אחרות, למשל, \"קרינה\" של השימוש הנרחב יחסית של בית המשפט במשפט ההומניטארי הבינלאומי בבדיקת פעולות המדינה שננקטו בשטחים הכבושים.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: למה אמנות זכויות אדם צריכות לשמש אמת מידה גם בדין הישראלי."
      ]
    },
    {
