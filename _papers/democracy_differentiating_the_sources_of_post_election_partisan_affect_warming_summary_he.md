---
{
  ...
  "subtitleHe": "",
  "descriptionHe": "המאמר בוחן מדוע רגשות בין תומכי מפלגות מתחממים לאחר בחירות, ומפריד בין תחושת ניצחון לבין השפעת ישיבה משותפת בקואליציה.",
  "summaryHe": "המאמר משתמש בנתוני Israel Polarization Panel סביב בחירות מרץ 2021 בישראל, תקופה שבה תוצאות הבחירות לא תורגמו מיד להרכב ממשלה ברור. הממצאים תומכים בשני מנגנונים שמפחיתים רגש מפלגתי שלילי: נדיבות של מי שתופסים עצמם כמנצחים, והתחממות בין תומכי מפלגות שנכנסות יחד לקואליציה. עם זאת, שותפות בשלטון גם הגבירה רגשות שליליים בקרב תומכי האופוזיציה כלפי מפלגות הקואליציה.",
  ...
  "oneLinerHtml": "בישראל 2021, שותפות קואליציונית חיממה יחסים בין תומכי מפלגות השלטון, אך החריפה יחס שלילי מצד תומכי האופוזיציה.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "<p>המאמר יוצא מן התצפית שרגש מפלגתי שלילי נוטה לעלות בזמן מערכת בחירות ולרדת לאחריה. הקושי המחקרי הוא שבדרך כלל תפיסת המנצחים והרכב הממשלה מתבהרים סמוך לפרסום התוצאות, ולכן קשה לדעת אם השינוי הרגשי נובע מתחושת ניצחון או מן הידיעה מי ישלוט בפועל.</p>",
        "<p>המחקר מנצל את חוסר הוודאות שלאחר בחירות מרץ 2021 בישראל, הבחירות הרביעיות מאז 2019. המשא ומתן הקואליציוני נמשך עד הקמת הממשלה ביוני 2021 וכלל מפלגות מכל קשת הכנסת, ולכן נוצרה הפרדה מעשית בין תפיסות מוקדמות של מנצחים ומפסידים לבין ההרכב הקואליציוני הסופי.</p>",
        "<p>באמצעות נתוני פאנל, הניתוח מראה ששני המנגנונים פועלים כמעין שסתומי לחץ לרגש מפלגתי שלילי. תפיסת ניצחון קשורה להתחממות מסוימת כלפי מפלגות אחרות, ושותפות בקואליציה מפחיתה יחס שלילי בין תומכי מפלגות השלטון. במקביל, אותה שותפות בשלטון הגבירה יחס שלילי בקרב תומכי מפלגות אופוזיציה כלפי מפלגות הקואליציה.</p>"
      ]
    },
    {
