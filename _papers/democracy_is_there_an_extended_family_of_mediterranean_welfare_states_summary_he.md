---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מטרת מאמר זה היא להציע שקיימת משפחה מורחבת של מדינות רווחה ים תיכוניות ושהיא מורכבת משמונה אומות שונות, שחלקן זכו להתעלמות בשיח המתמשך על מדינות רווחה ים תיכוניות. ליתר דיוק, נטען כי המשפחה המורחבת של מדינות הרווחה הים תיכוניות כוללת את קפריסין, יוון, ישראל, איטליה, מלטה, ספרד, פורטוגל וטורקיה. המאמר מדגיש מספר תכונות משותפות לבני המשפחה המורחבת הזו של מדינות רווחה.",
