---
{
  ...
  "image": {
    "src": "assets/article-images/real_photo_091_media_democracy_china_sharp_power_israel_discourse_summary_he.jpg",
    "version": "2026-07-05-real-photo-handoff",
    "altHe": "תצלום הקשור להעוצמה החדה של סין נבלמת בישראל בידי ספקנות ציבורית ושיח ביקורתי",
    "fitness": "high",
    "license": "CC BY 2.5",
    "creator": "ליזי שאנן",
    "provider": "Wikimedia Commons",
    "sourcePage": "https://commons.wikimedia.org/wiki/File:94553_protest_against_the_judicial_reform_tel_aviv_PikiWiki_Israel.jpg",
    "originalUrl": "https://upload.wikimedia.org/wikipedia/commons/4/41/94553_protest_against_the_judicial_reform_tel_aviv_PikiWiki_Israel.jpg",
    "fileTitle": "94553 protest against the judicial reform tel aviv PikiWiki Israel.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המונח \"כוח חד\" הפך למושג בשימוש נרחב ביחסים בינלאומיים לתיאור השפעה חיצונית המכוונת לדמוקרטיות. מחקר זה בוחן את אופיו ואת השפעתו של הכוח החד של סין על החוסן הדמוקרטי של החברה הישראלית, במיוחד בשיח האקדמי והתקשורתי. הטענה המרכזית היא שסין ניסתה, אם כי בהצלחה מוגבלת, לבסס השפעה ולעצב את דעת הקהל בישראל באמצעות מניפולציות וצנזורה.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המאמר, ניסיונות ההשפעה של סין בישראל לא נחלו הצלחה רחבה. הסיבות כוללות ספקנות ציבורית, מודעות גוברת לשאיפות גיאופוליטיות של סין והקשר אזורי שהקשה עליה לזכות באמון."
      ]
    },
    {
