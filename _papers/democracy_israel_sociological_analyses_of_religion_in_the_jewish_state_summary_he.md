---
{
  ...
  "titleHe": "דת במדינה היהודית: מבט סוציולוגי על ישראל",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_israel_sociological_analyses_of_religion_in_the_jewish_state_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אבל מחקרים מראים שההבדלים האתניים והדוריים מחלקים את הישראלים לקטגוריות רבות, ובמקום להיות מופרט יותר, היהדות זוכה לאחרונה לגדולה יותר בחיים הציבוריים. כתוצאה מכך, היהדות בישראל מתחלקת לשלושה זרמים עיקריים: התבנית האשכנזית השלטת; דפוס אסיאתי וצפון אפריקאי אופייני; ודפוס אשכנז מיעוט הנוטה להיות אדיש לציונות ולמשמעות הדתית של המדינה.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק ביחסי דת, מדינה ודמוקרטיה, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Sociological Analysis בשנת 1990. הזווית הדמוקרטית היא שהסדרים מוסדיים אינם רק רקע טכני, אלא תנאי לאמון, לשוויון בפני הכללים וליכולת להגביל כוח ציבורי."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "דת במדינה היהודית: מבט סוציולוגי על ישראל",
