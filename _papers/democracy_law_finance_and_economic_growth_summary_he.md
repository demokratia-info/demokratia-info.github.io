---
{
  ...
  "titleHe": "משפט, מימון וצמיחה כלכלית",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_law_finance_and_economic_growth_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בהקשר בין שלטון החוק, מוסדות כלכליים וצמיחה, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Journal of Financial Intermediation בשנת 1999. הזווית הדמוקרטית היא שהסדרים מוסדיים אינם רק רקע טכני, אלא תנאי לאמון, לשוויון בפני הכללים וליכולת להגביל כוח ציבורי."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "משפט, מימון וצמיחה כלכלית",
