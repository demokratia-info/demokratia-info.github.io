---
{
  ...
  "descriptionHe": "המאמר מראה כיצד היחס למשפט הבינלאומי בפסיקת בית המשפט העליון על השטחים נעשה מצומצם יותר, ומה המשמעות הדמוקרטית של שינוי זה.",
  ...
  "oneLinerHtml": "שורה תחתונה: המאמר מראה כיצד היחס למשפט הבינלאומי בפסיקת בית המשפט העליון על השטחים נעשה מצומצם יותר, ומה המשמעות הדמוקרטית של שינוי זה. התרומה המרכזית היא הצבעה על שינוי מוסדי עדין: לא ביטול גלוי של המשפט הבינלאומי, אלא החלשה הדרגתית של תפקידו בביקורת שיפוטית.",
  "sections": [
    {
      "headingHe": "מה המאמר בוחן",
      "paragraphsHtml": [
        "תמר הוסטובסקי ברנדס בוחנים את המאמר The diminishing status of international law in the decisions of the Israeli Supreme Court concerning the Occupied Territories דרך השאלה הדמוקרטית המרכזית שלו.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק ב־<strong>מה קורה כשמשפט בינלאומי מאבד משקל בפסיקת בית המשפט?</strong> דרך ניתוח אקדמי של The diminishing status of international law in the decisions of the Israeli Supreme Court concerning the Occupied Territories.",
