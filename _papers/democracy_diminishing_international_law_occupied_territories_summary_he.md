---
{
  ...
  "image": {
    "src": "assets/article-images/185_court_democracy_diminishing_international_law_occupied_territories_summary_he.png",
  ...
  "oneLinerHtml": "המאמר מראה כיצד דחיקת המשפט הבינלאומי מפסיקת השטחים משנה את שפת האחריות והזכויות בבג״ץ.",
  "sections": [
    {
      "headingHe": "איזה דין אמור להגביל כוח בשטחים?",
      "paragraphsHtml": [
    ...
    {
      "headingHe": "איך שינוי בשפת ההנמקה משנה את הזכויות?",
      "paragraphsHtml": [
    ...
    {
      "headingHe": "מה מגלה ההשוואה בין תקופות הפסיקה?",
      "paragraphsHtml": [
    ...
    {
      "headingHe": "למה דיני הכיבוש חשובים במיוחד לפלסטינים?",
      "paragraphsHtml": [
    ...
    {
      "headingHe": "מה המאמר מלמד על בג״ץ כמוסד דמוקרטי?",
      "paragraphsHtml": [
    ...
    {
      "headingHe": "מה משתנה בדיון על שלטון החוק?",
      "paragraphsHtml": [
  ...
  "layout": "paper",
  "title": "כשהמשפט הבינלאומי מאבד משקל בבג״ץ",
