---
{
  ...
  "image": {
    "src": "html_qa/democracy_macrolevel_factors_encouraging_bureaucratic_policy_entrepreneurship_the_case_of_religion_and_state_in_israel_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אנו טוענים כי: (1) חוסר יעילות בירוקרטי, המוביל ל(2) לחץ חברתי כפי שמתבטא על ידי דעת הקהל, וכתוצאה מכך ל(3) לחץ מצד ספקים חדשים פוטנציאליים המציעים תחרות מלמטה למעלה, יעודד את הפקידים לפנות לאסטרטגיות של יזמות מדיניות. אנו בודקים את הטענות הללו על ידי ניתוח הדינמיקה הממלכתית-דתית בישראל, ובמיוחד את המקרה של רפורמת פיקוח הכשרות לשנת 2021.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק ביחסי דת, מדינה ודמוקרטיה, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת European Policy Analysis בשנת 2024.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית."
      ]
    },
    {
