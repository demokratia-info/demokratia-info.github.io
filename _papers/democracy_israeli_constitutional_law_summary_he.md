---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "פרק זה בוחן את המידה שבה היה מוכן בית המשפט להכיר בתחולת המשפט החוקתי של ישראל על פעולות הרשויות בשטחים הכבושים. עוד הוא בוחן את ההיררכיה בפסיקת בית המשפט בין המשפט החוקתי הישראלי ודיני הכיבוש, ואת השקפת בית המשפט לגבי האפשרות שמשטרים משפטיים שונים עשויים לחול בתוך השטחים הכבושים על אזרחים ישראלים ועל פלסטינים. פרק זה מקדיש תשומת לב רבה לפרשת חוק הסדרת ההתנחלויות מיוני 2020, שבה הכריז בית המשפט כבלתי חוקתי כי חוק הכנסת המחייב הפקעת קרקע פרטית שעליה בנו מתנחלים באופן בלתי חוקי."
      ]
    },
    {
