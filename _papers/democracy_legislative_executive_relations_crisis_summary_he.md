---
{
  ...
  "summaryHe": "איך שינוי ביחסי הכנסת והממשלה יכול להעמיק משבר חוקתי ולשחוק בלמים דמוקרטיים. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד כללים משפטיים, ביקורת שיפוטית ועיצוב מוסדי משפיעים בפועל על היכולת להגביל כוח שלטוני, לשמור על אחריות ציבורית ולהבטיח שכללי המשחק הדמוקרטיים לא יישחקו בהדרגה.",
  ...
  "oneLinerHtml": "שורה תחתונה: המאמר מראה שבין 2019 ל-2024 עבר בישראל כוח פוליטי מן הכנסת אל הממשלה, במיוחד סביב משברים אישיים, ביטחוניים וקואליציוניים. לפי אסנת עקירב מהמכללה האקדמית גליל מערבי, היחלשות הכנסת הפכה את בית המשפט העליון לאחד המוסדות היחידים שיכולים עדיין להגביל באופן משמעותי את הכוח הביצועי. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד כללים משפטיים, ביקורת שיפוטית ועיצוב מוסדי משפיעים בפועל על היכולת להגביל כוח שלטוני, לשמור על אחריות ציבורית ולהבטיח שכללי המשחק הדמוקרטיים לא יישחקו בהדרגה.",
  "sections": [
    {
