---
{
  ...
  "oneLinerHtml": "המאמר מראה שבין 2019 ל-2024 עבר בישראל כוח פוליטי מן הכנסת אל הממשלה, במיוחד סביב משברים אישיים, ביטחוניים וקואליציוניים. לפי אסנת עקירב מהמכללה האקדמית גליל מערבי, היחלשות הכנסת הפכה את בית המשפט העליון לאחד המוסדות היחידים שיכולים עדיין להגביל באופן משמעותי את הכוח הביצועי.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: בין שני השותפים הקואליציוניים הקטנים יותר (כלומר, הירוקים וה-FDP). התגובות למלחמתה של רוסיה באוקראינה הובילו לעימות גלוי, כאשר חברי פרלמנט בודדים מתוך הרוב התמקמו בפומבי נגד עמדות ה-PPG שלהם והקנצלר. החום כך התגבר עוד יותר. אנו רואים את ה\"פוליטיקה החמה\" הנוכחית במערכת שמעריכה \"פוליטיקה קרה\".",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: איך שינוי ביחסי הכנסת והממשלה יכול להעמיק משבר חוקתי ולשחוק בלמים דמוקרטיים."
      ]
    },
    {
