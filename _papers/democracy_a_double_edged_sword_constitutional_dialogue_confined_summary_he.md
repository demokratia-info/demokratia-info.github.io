---
{
  ...
  "titleHe": "דיאלוג חוקתי מוגבל כחרב פיפיות",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_a_double_edged_sword_constitutional_dialogue_confined_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: תקציר ביקורת שיפוטית דיאלוגית היא אינטראקציה דיאלקטית בין בתי משפט עליונים ובתי מחוקקים לגבי חוקתיות החקיקה, שבה כל מוסד שומר על סמכותו החוקתית, ועם זאת מבצע אותה תוך התחשבות בעמדת המוסד האחר וביכולתו להגיב. אינטראקציה זו מבוססת על הדדיות ועל תרומתם של שני המוסדות לעיצוב ולפרשנות החוקתית של חקיקה. מאמר זה טוען שניתן (ולפעמים חייב) להגביל דיאלוג חוקתי כדי למנוע הפרעה של זכויות אדם במהלך האינטראקציה המוסדית החוקתית.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בבתי המשפט, חוקתיות ושלטון החוק, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת International Journal of Constitutional Law בשנת 2022.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "דיאלוג חוקתי מוגבל כחרב פיפיות",
