---
{
  ...
  "oneLinerHtml": "המאמר מסביר מדוע גם דמוקרטיה הנשענת על ריבונות העם זקוקה לכללים שמונעים מהכרעה רגעית להרוס את תנאי הדמוקרטיה עצמה. השאלה המרכזית היא איך לאפשר שינוי חוקתי עמוק בלי להפוך את הדמוקרטיה לכלי שמבטל את עצמו. החשיבות הציבורית של המאמר היא בכך שהוא מראה כיצד כללים משפטיים, ביקורת שיפוטית ועיצוב מוסדי משפיעים בפועל על היכולת להגביל כוח שלטוני, לשמור על אחריות ציבורית ולהבטיח שכללי המשחק הדמוקרטיים לא יישחקו בהדרגה.",
  "sections": [
    {
