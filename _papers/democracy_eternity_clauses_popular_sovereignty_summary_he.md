---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: הכללת סעיפי נצח בחוקה בהחלט מהווה אתגר לכל דמוקרטיה, דהיינו זה של פתרון המתח בין השפעתם המקפיאה על מערכת המשפט לבין התפיסה הדמוקרטית של ריבונות עממית. כתוצאה מכך, ישראל כמדינה יהודית דמוקרטית עומדת בפני אותו אתגר של פתרון המתח בין אפקט ההקפאה לריבונות עממית. מאמר זה טוען שניתן לעמוד באתגר הזה בהצלחה ברגע שסעיפי הנצח משולבים בתוך דמוקרטיה תלת-מסלולית - מערכת ותאוריה חוקתית הוליסטית.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: המאמר מסביר מדוע גם דמוקרטיה הנשענת על ריבונות העם זקוקה לכללים שמונעים מהכרעה רגעית להרוס את תנאי הדמוקרטיה עצמה."
      ]
    },
    {
