---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מחקר איכותני זה בוחן את תפיסות הדמוקרטיה והאזרחות בקרב 14 מורים לחינוך דתי אסלאמי בבתי הספר הערביים ובתי הספר התיכוניים בישראל. הוא מרחיב את הידע על האופן שבו מורים דתיים (מוסלמים) משיגים את המשמעות של חינוך לדמוקרטיה ואזרחות. הנושא הראשון מתייחס לשלוש ביקורות על הדמוקרטיה: האתנו-פוליטית (כישלונם של משטרים דמוקרטיים, כולל ישראל, להגן על זכויות המיעוטים הדתיים); אפיסטמולוגי (החסרון של שלטון הרוב בהבטחת חיים הגונים וצודקים לכל האזרחים); ותיאולוגי (מוסרי).",
