---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: ברגע שמשתנים מסוג זה והרמה הראשונית של התמ\"ג הריאלי לנפש נשמרים קבועים, ההשפעה הכוללת של הדמוקרטיה על הצמיחה היא שלילית חלשה. תוצאות אלו מאפשרות תחזיות לגבי אילו מדינות יהפכו עם הזמן לדמוקרטיות פחות או יותר.",
