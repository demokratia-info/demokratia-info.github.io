---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: טיעון זה מבוסס על ניתוח השוואתי של מקרה בוחן המתמקד בישראל, יחד עם המקרה הנוסף של פולין. ניתוח זה תורם לגוף ההולך וגדל של ספרות על נסיגה דמוקרטית וחוסן על ידי הדגשת התפקיד המתעלם לעתים קרובות של אינטרסים מעמדיים מאורגנים מול אתגרים למוסדות דמוקרטיים.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: איך כוח עבודה מאורגן יכול להשפיע על מאבקים נגד נסיגה דמוקרטית."
      ]
    },
    {
