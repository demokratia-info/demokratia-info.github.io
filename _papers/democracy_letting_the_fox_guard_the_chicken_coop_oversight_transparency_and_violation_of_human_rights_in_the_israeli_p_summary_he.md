---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: בתי סוהר וזכויות אזרחיות ובריאות של אסירים הם מדד אחד בסיסי ליחס בין החקיקה של הדמוקרטיה הליברלית לאכיפתה וזכויות וחירויות אישיות. לאור קשר זה, מאמר זה בוחן את החקיקה הישראלית בנושא זכויות אזרח של אסירים ושירותי בריאות, בוחן את המנגנונים ליישום זכויות אלו ומנתח את הגורמים העיקריים לפער בין חקיקה זו ליישומה בפועל.",
