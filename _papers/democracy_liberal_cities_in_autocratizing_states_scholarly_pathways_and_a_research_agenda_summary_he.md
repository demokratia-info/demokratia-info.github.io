---
{
  ...
  "titleHe": "ערים ליברליות במדינות בתהליך אוטוקרטיזציה",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_liberal_cities_in_autocratizing_states_scholarly_pathways_and_a_research_agenda_summary_he.jpg",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה בוחן את התופעה ההולכת וגוברת של ערים ליברליות הפועלות בתוך משטרים לאומיים שהולכים ואוטוקרטים. מחקרים אלה חושפים דפוסים והגדרות ייחודיות שעוצבו על ידי התפנית האוטוקרטית העולמית, אשר חורגים מחיכוכים מבוססים יותר בין ערים ומדינות. באמצעות מלגה זו, המאמר בוחן כיצד עיריות הנשלטות על ידי שחקנים פרוגרסיביים מגיבות ללחצים של המדינה המרכזית, תוך מינוף כלים משפטיים, פיננסיים, סמליים ודיפלומטיים כדי לעמוד על אוטונומיה ולקיים ערכים ליברליים-דמוקרטיים.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק במוסדות ציבוריים, ממשל ואמון אזרחי, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Urban Studies בשנת 2025.  תקציר המקור מצביע על כך שהדיון אינו מסתפק בתיאור כללי, אלא מציב קשר אנליטי בין משתנים מוסדיים לבין תוצאה חברתית, משפטית או כלכלית."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "ערים ליברליות במדינות בתהליך אוטוקרטיזציה",
