---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "באמצעות ניתוח ביקורתי של המסמכים המעצבים את תעשיית התקשורת בישראל ואת התפתחותם ההיסטורית, מאמר זה חושף את ההנחות שבבסיס מדיניות התקשורת הישראלית. העיתון טוען שמדיניות זו נובעת מפרשנות צרה של 'דמוקרטיה' הדוחה הזדהות עם המזרח ומחבקת את הניאו-ליברליזם."
      ]
    },
    {
