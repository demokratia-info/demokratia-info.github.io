---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: הפרק יבחן באופן ביקורתי הצעה זו בהקשר הישראלי, אך יספק גם כמה תובנות כלליות. כדי להדגים את טענותיי, אני בוחן שלושה תחומים במבנה החוקתי של ישראל: בניית חוקה, הגנת זכויות ותדמית מוסדית. לגבי יצירת חוקה, אני מראה כיצד ההסדר החוקתי של היום נראה שונה מאוד מזה שחזו על ידי מעצבי מגילת העצמאות של ישראל.",
