---
{
  ...
  "image": {
    "src": "assets/article-images/real_photo_318_minorities_democracy_ideology_meets_pragmatism_examining_governance_dynamics_in_israeli_politics_summ.jpg",
    ...
    "sourcePage": "https://commons.wikimedia.org/wiki/File:Rahat_Comm.jpg",
    "originalUrl": "https://upload.wikimedia.org/wikipedia/commons/6/69/Rahat_Comm.jpg",
    "fileTitle": "Rahat Comm.jpg",
    "sourceDimensions": "4129x2746",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר מתמקד ביחסים הדינמיים בין עקרונות אידיאולוגיים לבין המציאות המעשית של ממשל בישראל. הוא טוען שהמפגש בין דת, פוליטיקה וחברה יוצר אי־יציבות פוליטית משמעותית, בין היתר בשל השפעתן החזקה של מפלגות דתיות על קביעת מדיניות ציבורית.",
        "הניתוח מציג את הדת כגורם מרכזי בעיצוב נורמות חברתיות וממשל בישראל. הדגש על ערכים דתיים במדיניות ציבורית, והקשר המתמשך בין הזירה הדתית לזירה הפוליטית, מקשים על איזון בין אורתודוקסיה דתית לבין עקרונות דמוקרטיים חילוניים ופוגעים ביציבות ובלכידות החברתית.",
        "המאמר דן גם במעמדם של אזרחי ישראל הערבים בתוך דמוקרטיה אתנית. הוא מציין כי האזרחות מאפשרת להם לנהל מאבקים פוליטיים במסגרת החוק, אך גם מדגיש מגבלות על השתתפות מלאה בפעולות המוגדרות כתורמות לאינטרס הציבורי הרחב. בהקשר זה הוא מתייחס לחוק הלאום מ־2018, המעגן הגדרה של מימוש עצמי לאומי יהודי."
      ]
    },
    {
