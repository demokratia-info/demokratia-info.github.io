---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר בוחן את המקרה של פרויקט המצלמה של בצלם, ארגון זכויות אדם ישראלי הפועל בשטחים הפלסטיניים הכבושים. המאמר מנתחת חומר חזותי מהפרויקט ומשלבת בחינה זו עם ראיונות עם נשים צלמים פלסטיניות, כל אלה מוכיחים כי זהותם המגדרית אינה מכרעת למסר שהסרטונים מנסים להעביר על הכיבוש הישראלי. בהסתמך על מלגה פמיניסטית ביקורתית בנושא מגדר של לוחמה ומשפט בינלאומי, המאמר טוען שרעיונות תרבותיים קיימים לגבי מגדר משפיעים על תהליך המיסגור האסטרטגי של הארגון."
      ]
    },
    {
