---
{
  ...
  "titleHe": "מצלמה, מגדר וזכויות אדם בישראל/פלסטין",
  "subtitleHe": "",
  ...
  "image": {
    "src": "html_qa/democracy_armed_with_a_camera_gender_human_rights_and_visual_documentation_in_israel_palestine_summary_he.jpg",
    "version": "2026-05-23-extra-100-economics-refill",
    "altHe": "תמונה עריכתית: מצלמה, מגדר וזכויות אדם בישראל/פלסטין",
    "fitness": "standard"
  },
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אני בוחן את המקרה של פרויקט המצלמה של בצלם, ארגון זכויות אדם ישראלי הפועל בשטחים הפלסטיניים הכבושים. אני מנתחת חומר חזותי מהפרויקט ומשלבת בחינה זו עם ראיונות עם נשים צלמים פלסטיניות, כל אלה מוכיחים כי זהותם המגדרית אינה מכרעת למסר שהסרטונים מנסים להעביר על הכיבוש הישראלי. בהסתמך על מלגה פמיניסטית ביקורתית בנושא מגדר של לוחמה ומשפט בינלאומי, אני טוענת שרעיונות תרבותיים קיימים לגבי מגדר משפיעים על תהליך המיסגור האסטרטגי של הארגון.",
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר עוסק בזכויות, שוויון והגנות למיעוטים, כפי שעולה מכותרת המקור ומן המסגרת הביבליוגרפית שלו בכתב העת Signs: Journal of Women in Culture and Society בשנת 2021. הזווית הדמוקרטית היא שהסדרים מוסדיים אינם רק רקע טכני, אלא תנאי לאמון, לשוויון בפני הכללים וליכולת להגביל כוח ציבורי."
      ]
    },
    {
  ...
  "layout": "paper",
  "title": "מצלמה, מגדר וזכויות אדם בישראל/פלסטין",
