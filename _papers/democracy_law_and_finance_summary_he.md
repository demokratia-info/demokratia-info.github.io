---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: מאמר זה בוחן כללים משפטיים המכסים הגנה על בעלי מניות ונושים בתאגידים, מקורם של כללים אלו ואיכות אכיפתם ב-49 מדינות. התוצאות מראות שלמדינות המשפט המקובל יש בדרך כלל את ההגנות המשפטיות החזקות ביותר, ומדינות האזרחיות הצרפתיות החלשות ביותר, של משקיעים, כאשר מדינות המשפט האזרחי הגרמני והסקנדינביני ממוקמות באמצע. כמו כן, אנו מוצאים כי ריכוז הבעלות על מניות בחברות הציבוריות הגדולות קשור באופן שלילי להגנת המשקיעים, בהתאם להשערה כי בעלי מניות קטנים ומגוונים אינם צפויים להיות חשובים במדינות שאינן מצליחות להגן על זכויותיהם.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: המאמר בוחן את הקשר בין מסורות משפטיות, הגנת משקיעים, אכיפה וריכוז בעלות בחברות ציבוריות. לפי תקציר המקור, מדינות המשפט המקובל מציעות בדרך כלל הגנות חזקות יותר למשקיעים, בעוד שמערכות שמקורן במשפט אזרחי צרפתי מציעות הגנות חלשות יותר, ומדינות אחרות נמצאות בין הקצוות. הממצא הציבורי החשוב הוא שהמשפט הכלכלי אינו נפרד מדמוקרטיה: כשהכללים מגינים רק על בעלי כוח או אינם נאכפים, שוקי ההון נעשים ריכוזיים יותר והציבור הרחב מתקשה להשתתף בצמיחה."
      ]
    },
    {
