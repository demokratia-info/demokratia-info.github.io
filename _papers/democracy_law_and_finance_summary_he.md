---
{
  ...
  "subtitleHe": "",
  "descriptionHe": "המאמר משווה דיני הגנת משקיעים ואיכות אכיפה ב־49 מדינות, ומראה כיצד מסורת משפטית קשורה לזכויות בעלי מניות ונושים ולריכוז בעלות בחברות ציבוריות.",
  "summaryHe": "המאמר בוחן את הקשר בין מקור משפטי, הגנת משקיעים, אכיפת זכויות וריכוז בעלות. במדינות המשפט המקובל ההגנות על משקיעים חזקות בדרך כלל יותר, במערכות שמקורן במשפט אזרחי צרפתי הן חלשות יותר, והמסורות הגרמנית והסקנדינבית נמצאות בעמדת ביניים. הממצא המרכזי הוא שכאשר בעלי מניות קטנים ונושים מוגנים פחות, בעלות בחברות ציבוריות נוטה להיות ריכוזית יותר.",
  ...
  "oneLinerHtml": "דיני חברות ואכיפתם משפיעים על השאלה אם שוק ההון פתוח למשקיעים רבים או נשלט בידי בעלי כוח מעטים.",
  "sections": [
    {
