---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "פרק זה מציע ניתוח מעמיק של בחירות 2013 מנקודות מבט שונות, תוך הצגת תמונה עדכנית ומורכבת של הדמוקרטיה הישראלית, לרבות אתגריה, הישגיה וכישלונותיה. השלכות הבחירות משקפות דעיכה של הליכוד והימין, תוצאה שלא צפויה בתקופת הקמפיין, כשנדמה היה שאג'נדה של הימין מתחזקת. תהליך הקמת הקואליציה היה כולו \"פוליטיקה ישנה\", וכל מי שעוקב אחרי הפוליטיקה הישראלית מאז הבחירות יכול למצוא אינספור ביטויים לפוליטיקה הישנה."
      ]
    },
    {
