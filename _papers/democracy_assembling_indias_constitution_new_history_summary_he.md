---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: הוא בוחן את החוקה כפי שצמחה מעבר לאסיפה המכוננת באמצעות מעורבות ביצירתה בקרב ציבורים מגוונים. בכך, זה מראה שהחוקה ההודית לא פשוט נוסדה וניתנה מלמעלה, אלא נוצרה באמצעות פעולות אסיפה קטנות רבות יותר הרחק מאולם החוקה.",
        "בהקשר הדמוקרטי של האתר, המשמעות היא: De ו-Shani מסיטים את המחקר מן האליטה הפוליטית אל מסמכים שלא נחקרו דיים ואל מעורבות ציבורית רחבה. לפי התקציר, החוקה לא רק ניתנה מלמעלה, אלא התגבשה דרך פעולות רבות של התכנסות, פנייה וחינוך פוליטי מחוץ לאולם החוקתי."
      ]
    },
    {
