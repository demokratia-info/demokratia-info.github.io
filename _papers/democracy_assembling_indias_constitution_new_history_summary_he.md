---
{
  ...
  "summaryHe": "De ו-Shani מסיטים את המחקר מן האליטה הפוליטית אל מסמכים שלא נחקרו דיים ואל מעורבות ציבורית רחבה. לפי התקציר, החוקה לא רק ניתנה מלמעלה, אלא התגבשה דרך פעולות רבות של התכנסות, פנייה וחינוך פוליטי מחוץ לאולם החוקתי.",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר טוען שחוקת הודו לא נוצרה רק מתוך חזון והסכמה של אליטות פוליטיות. לפי התקציר, היא התגבשה גם דרך מעורבות של ציבור מגוון, שפנה, הציע, דרש וניסה לחנך את נציגי האספה."
      ]
    },
    {
