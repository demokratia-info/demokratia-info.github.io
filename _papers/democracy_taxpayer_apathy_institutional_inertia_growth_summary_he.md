---
{
  ...
  "summaryHe": "המאמר משווה בין תקופת מרד משלמי המסים בשנות השבעים ותחילת שנות השמונים לבין האדישות היחסית שנראתה בסוף שנות התשעים. לפי תקציר המקור, אזרחים התקוממו כאשר הכנסותיהם הריאליות נשחקו בתקופה של סטגנציה ואינפלציה, אך נותרו שקטים יותר כאשר המסים נגבו בתקופה של צמיחה ריאלית ואינפלציה נמוכה. לכן המאמר חשוב לדיון דמוקרטי מפני שהוא מראה כיצד תגובת הציבור למיסוי תלויה גם בהקשר כלכלי, לא רק בעקרונות אידאולוגיים.",
