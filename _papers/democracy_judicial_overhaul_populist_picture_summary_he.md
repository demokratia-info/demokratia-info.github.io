---
{
  ...
  "subtitleHe": "",
  "descriptionHe": "המאמר מנתח את הרפורמה המשפטית בישראל כחלק מתהליך רחב של שחיקה דמוקרטית, שבו סדרה מצטברת של צעדים משפטיים עלולה לפגוע בהפרדת הרשויות, בזכויות אדם ובדמוקרטיה ליברלית.",
  "summaryHe": "המאמר טוען שאת הרפורמה המשפטית בישראל יש להבין כתמונה מצטברת של מהלכים משפטיים, ולא רק כתיקון יחיד, משום שהשילוב ביניהם עלול לשנות את מבנה המשטר.",
  ...
  "image": {
    "src": "assets/article-images/real_photo_420_court_democracy_judicial_overhaul_populist_picture_summary_he.jpg",
    ...
    "sourcePage": "https://commons.wikimedia.org/wiki/File:Supreme_Court_(44125836).jpg",
    "originalUrl": "https://upload.wikimedia.org/wikipedia/commons/5/52/Supreme_Court_%2844125836%29.jpg",
    "fileTitle": "Supreme Court (44125836).jpg",
  ...
  "oneLinerHtml": "המאמר טוען שהרפורמה המשפטית אינה מובנת דרך תיקון יחיד, אלא דרך <strong>התמונה המצטברת</strong>: סדרה של מהלכים שעלולה לפגוע בהפרדת הרשויות, בזכויות אדם ובדמוקרטיה ליברלית.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר טוען שבדמוקרטיות נסוגות הסכנה אינה חייבת להופיע כקריסה חוקתית אחת וברורה. כל חוק או תיקון עשוי להיראות מוגבל בפני עצמו, אך כאשר בוחנים את המהלכים יחד נוצרת תמונה רחבה יותר של שינוי משטרי.",
        "הניתוח ממקם את הרפורמה המשפטית בישראל בתוך מסגרת פופוליסטית, שבה סדרת צעדים משפטיים עלולה לרכז כוח שלטוני ולפגוע בעקרון הפרדת הרשויות. לפי המאמר, המשמעות העיקרית אינה רק בפרט מוסדי אחד אלא בהשפעה המצטברת של המהלך כולו.",
        "המאמר מדגיש שהגבלת כוח הממשלה היא תנאי מרכזי להגנה על זכויות אדם ועל כללי המשחק הדמוקרטיים. לכן הרפורמה, כפי שהיא מוצגת בניתוח, עלולה ליצור סכנה ממשית לדמוקרטיה הליברלית בישראל."
      ]
    },
    {
