---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: אני מוצא שבעוד שבעבר, פעילות זכויות האדם וזכויות בעלי החיים היו קשורות קשר הדוק, היום הם הפכו מנותקים, מסיבות שאני חוקר במאמר זה. אני מחשיב את הפוליטיקה המשתנה של אקטיביזם לזכויות אדם ובעלי חיים, ומדגים כיצד הם מערבים ומסתבכים זה את זה בהקשר של הסכסוך הישראלי-פלסטיני המתמשך. אני עוד שוקל מה עשוי להציע ניתוק ההצמדה של תנועות זכויות האדם לבעלי חיים בנוגע לביקורת האקדמית המתמשכת על זכויות אדם והומניזם.",
