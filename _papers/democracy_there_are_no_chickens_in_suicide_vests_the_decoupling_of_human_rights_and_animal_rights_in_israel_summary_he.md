---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר מוצא שבעוד שבעבר, פעילות זכויות האדם וזכויות בעלי החיים היו קשורות קשר הדוק, היום הם הפכו מנותקים, מסיבות שהמאמר חוקר. המאמר מחשיב את הפוליטיקה המשתנה של אקטיביזם לזכויות אדם ובעלי חיים, ומדגים כיצד הם מערבים ומסתבכים זה את זה בהקשר של הסכסוך הישראלי-פלסטיני המתמשך. המאמר עוד שוקל מה עשוי להציע ניתוק ההצמדה של תנועות זכויות האדם לבעלי חיים בנוגע לביקורת האקדמית המתמשכת על זכויות אדם והומניזם."
      ]
    },
    {
