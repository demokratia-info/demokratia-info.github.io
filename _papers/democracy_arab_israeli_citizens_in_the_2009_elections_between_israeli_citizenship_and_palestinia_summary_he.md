---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: בכנסת ה-18 יושבים כיום 13 חברי כנסת ערבים ודרוזים. מדובר בח\"כ אחד פחות בהשוואה לנתון המקביל בכנסת ה-17 ומספר הח\"כים המייצגים מפלגות ערביות ברובן כמעט ולא השתנה (עלייה מ-10 ל-11). שינויים קלים אלו מפתיעים בהתחשב באופי המעצב של האירועים בזירה היהודית-ערבית בשלוש השנים שחלפו מאז הבחירות האחרונות.",
