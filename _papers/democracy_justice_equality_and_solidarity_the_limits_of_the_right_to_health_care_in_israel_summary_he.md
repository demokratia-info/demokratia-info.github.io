---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: הם יכולים לפנות לבית המשפט ולבקש ביקורת שיפוטית. מטרת המאמר הנוכחי היא לבחון את יחסם של בתי המשפט בישראל לתביעות המטופלים בגין שירותים שלא ניתנו על ידי המדינה.4 המאמר בוחן האם צדק, שוויון וסולידריות, אשר נקבעו במפורש על ידי המחוקק הישראלי כעקרונות המובילים בתחום זה. מטרה נוספת של מאמר זה היא לראות האם עקרונות אתיים אחרים כגון אוטונומיה, חסד ואי-רשע זוכים להכרה משפטית.",
