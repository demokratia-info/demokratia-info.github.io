---
{
  ...
  "descriptionHe": "המאמר מנתח את תיקון 2025 לחוק-יסוד: השפיטה, ומסביר מדוע העברת כוח רב יותר לשחקנים פוליטיים בבחירת שופטים מסוכנת במיוחד במשטר הישראלי.",
  "summaryHe": "גיא לוריא מציב את תיקון 2025 בתוך ההקשר הרחב של המאבק סביב מערכת המשפט מאז תוכנית ינואר 2023. המאמר טוען שהגרסה שאושרה במרץ 2025 אינה מעניקה לקואליציה שליטה בלעדית כפי שתוכנן בתחילה, אך עדיין מעבירה כוח משמעותי לשחקנים פוליטיים מן הקואליציה והאופוזיציה. הסיכון המרכזי נובע מכך שבישראל אין חוקה משוריינת, מגילת זכויות מלאה או מערך בלמים חזק, ולכן עצמאות בית המשפט היא אחד האיזונים המרכזיים מול הרוב הפוליטי.",
  ...
  "image": {
    "src": "assets/article-images/real_photo_786_knesset_democracy_the_politicization_of_judicial_selection_in_israel_summary_he.jpg",
    "version": "2026-07-05-real-photo-handoff",
    "altHe": "תצלום הקשור לרפורמת בחירת השופטים בישראל מעלה את משקל השיקול הפוליטי",
    "fitness": "high",
    "license": "CC BY-SA 3.0",
    "creator": "Mark Neyman",
    "provider": "Wikimedia Commons",
    "sourcePage": "https://commons.wikimedia.org/wiki/File:Reuven_Rivlin_visit_the_Knesset_and_the_Central_Elections_Committee,_March_2021_(GPOMN1_6038).jpg",
    "originalUrl": "https://upload.wikimedia.org/wikipedia/commons/e/e6/Reuven_Rivlin_visit_the_Knesset_and_the_Central_Elections_Committee%2C_March_2021_%28GPOMN1_6038%29.jpg",
    "fileTitle": "Reuven Rivlin visit the Knesset and the Central Elections Committee, March 2021 (GPOMN1 6038).jpg",
    "sourceDimensions": "3780x2541",
  ...
  "oneLinerHtml": "המאמר טוען שפוליטיזציה של בחירת שופטים מסוכנת במיוחד בישראל משום שבית המשפט הוא אחד הבלמים המוסדיים החזקים היחידים מול כוח הרוב.",
  "sections": [
    {
