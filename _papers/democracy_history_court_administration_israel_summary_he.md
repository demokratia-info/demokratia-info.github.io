---
{
  ...
  "oneLinerHtml": "שורה תחתונה: ההיסטוריה של הנהלת בתי המשפט בישראל אינה רק סיפור ניהולי. היא חושפת כיצד עצמאות שיפוטית נבנית בתוך מתחים מתמשכים בין שר המשפטים, נשיא בית המשפט העליון, מנהל בתי המשפט, נשיאי ערכאות ושופטים מן השורה.",
  "sections": [
    {
