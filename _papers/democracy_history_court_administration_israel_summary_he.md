---
{
  ...
  "image": {
    "src": "assets/article-images/real_photo_289_court_democracy_history_court_administration_israel_summary_he.jpg",
    "version": "2026-07-05-real-photo-handoff",
    "altHe": "תצלום על היסטוריה מוסדית של הנהלת בתי המשפט ושלטון החוק",
    "fitness": "high",
    "license": "Public domain",
    "creator": "Sarah Haslip",
    "provider": "Wikimedia Commons",
    "sourcePage": "https://commons.wikimedia.org/wiki/File:Seat_of_the_House_of_Justice.jpg",
    "originalUrl": "https://upload.wikimedia.org/wikipedia/commons/1/1a/Seat_of_the_House_of_Justice.jpg",
    "fileTitle": "Seat of the House of Justice.jpg",
  ...
  "oneLinerHtml": "ההיסטוריה של הנהלת בתי המשפט בישראל אינה רק סיפור ניהולי. היא חושפת כיצד עצמאות שיפוטית נבנית בתוך מתחים מתמשכים בין שר המשפטים, נשיא בית המשפט העליון, מנהל בתי המשפט, נשיאי ערכאות ושופטים מן השורה.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "המאמר מציג את ההיסטוריה של ניהול בתי המשפט בישראל, משנת 1948 ועד 1995 בקירוב, חושף שורה של מתחים שעמדו בבסיס ניהול בתי המשפט בישראל לאורך תולדותיהם. הוא ממחיש שמתחים בין רשות השופטת לביצוע, כמו גם מתחים פנים-שופטים וחוץ-שופטים אחרים, השפיעו על מסלול הנהלת בתי המשפט בישראל. יתרה מכך, המאמר מייחד שני אישים בולטים בתולדות מערכת המשפט בישראל, השופטים העליון יצחק אולשן ומאיר שמגר, שעיסוקם הפחות מוכר בניהול בתי המשפט – לצד עבודתם של משפטנים ישראלים פחות מוכרים ש\"ניהלו\" את בתי המשפט בישראל במשך עשרות שנים – נחשף במאמר.",
