---
{
  ...
  "sections": [
    ...
    {
      "headingHe": "באילו שנים המאמר מתמקד?",
      "paragraphsHtml": [
        "המאמר עוסק בעיקר בתקופה שמתחילה בהקמת המדינה בשנת 1948 ונמשכת עד אמצע שנות התשעים, סביב תקופותיהם של יצחק אולשן ומאיר שמגר.",
        "כדי לשמור על נאמנות למקור, יש לקרוא את התשובה לצד הטענה המרכזית של התמצית: המאמר מראה שההיסטוריה של הנהלת בתי המשפט היא מפתח להבנת עצמאות הרשות השופטת והיחסים בין רשויות בישראל."
      ]
    },
    {
      "headingHe": "למה יצחק אולשן ומאיר שמגר חשובים כאן?",
      "paragraphsHtml": [
        "המאמר מציג את עיסוקם הפחות מוכר בניהול בתי המשפט, לצד תפקידם השיפוטי, ומראה כיצד חזונותיהם השפיעו על המבנה המוסדי.",
    ...
    {
      "headingHe": "מה החידוש במחקר ההיסטורי?",
      "paragraphsHtml": [
        "החידוש הוא חשיפת שכבה מנהלית שכמעט אינה מופיעה בדיון הציבורי: מי מנהל את בתי המשפט, איך נוצרו הסמכויות, ומדוע המודל הישראלי שרד.",
        "כדי לשמור על נאמנות למקור, יש לקרוא את התשובה לצד הטענה המרכזית של התמצית: ההיסטוריה של הנהלת בתי המשפט בישראל אינה רק סיפור ניהולי."
      ]
    },
    {
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "חוקרי משפט והיסטוריה, שופטים, מנהלי בתי משפט וקוראים המעורבים בדיון על רפורמות במערכת המשפט ימצאו בו בסיס עובדתי חשוב.",
