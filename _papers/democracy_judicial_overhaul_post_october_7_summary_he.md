---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "בטווח של שנה אחת, חוותה ישראל שני משברים היסטוריים: משבר חוקתי שנוצר בעקבות השיפוץ המשפטי ב-2023 ומצב חירום ביטחוני לאומי בעקבות התקפת חמאס ב-7 באוקטובר. כל אירוע לבדו יכול היה לערער את המוסדות הדמוקרטיים, אך התכנסותם העמיקה את האיומים על הדמוקרטיה הליברלית של ישראל. במקום זאת, הוא שימש מסך עשן שאיפשר את המשך החתירה של הממשלה לשינוי חוקתי פופוליסט.",
        "המאמר בוחן את הרפורמה המשפטית אחרי 7 באוקטובר ומדגיש שהקשר בין ביטחון, חירום ושלטון החוק נעשה מרכזי עוד יותר."
      ]
    },
    {
