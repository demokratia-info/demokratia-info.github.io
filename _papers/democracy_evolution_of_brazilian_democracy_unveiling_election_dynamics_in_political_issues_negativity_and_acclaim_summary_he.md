---
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphsHtml": [
        "לפי תקציר המקור, המאמר מציג כמה טענות קונקרטיות: בהסתמך על מדגם של הודעות שפורסמו בטוויטר (n = 1,191) במהלך הבחירות לנשיאות של 2018 ו-2022, המחקר שלנו חושף קשרים בין נושאים פוליטיים מהותיים, כגון חינוך ובריאות, ואסטרטגיות קמפיין לשבחים, בעוד שהסוגיות המפלגות של קוביד-19 ושחיתות קשורות לאסטרטגיות שליליות של קמפיין. יתרה מכך, התוצאות מצביעות על כך שמדיניות מגדר קשורה הן לשבחים והן למסרים שליליים, שכן מדובר בסוגיה מקטבת בפוליטיקה הברזילאית. המחקר שלנו מראה גם מגמת שליליות מוגברת, כאשר מערכת הבחירות לנשיאות ב-2022 תהיה שלילית יותר מאשר ב-2018.",
