---
{
  ...
  "subtitleHe": "",
  "descriptionHe": "תקציר בעברית של תגובה משפטית על התפתחות הביקורת השיפוטית על הליך החקיקה בישראל בעקבות פסק דין קוונטינסקי וחוק ההסדרים.",
  "summaryHe": "המאמר מציג את פסק דין קוונטינסקי משנת 2017 כנקודת מפנה בביקורת השיפוטית על הליך החקיקה בישראל, משום שבג״ץ פסל בו לראשונה חוק בשל פגמים בהליך החקיקה. התגובה מדגישה את מאפייני חוק ההסדרים, הכולל מאות הסדרים תקציביים ועובר במסלול חקיקה מהיר, כמקרה שבו הליך מואץ עלול ליצור פגמים מהותיים.",
  ...
  "oneLinerHtml": "המאמר מדגיש את <strong>קוונטינסקי</strong> כתקדים נדיר שבו בג״ץ פסל חוק בשל פגם בהליך החקיקה.",
  "sections": [
    {
