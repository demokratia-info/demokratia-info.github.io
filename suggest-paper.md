...
<form class="suggestion-form"
  ...
  <p class="form-note">Up to five paper suggestions may be submitted from the same source each calendar day. Email verification will be added when a mail server is available.</p>
